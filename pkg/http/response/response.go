...
func SuccessWithMeta(w http.ResponseWriter, code int, data any, meta *Meta) {
	writeJSON(w, code, Response{
		Code:      code,
		Message:   "success",
		Data:      data,
...
func SuccessWithTraceID(w http.ResponseWriter, code int, data any, traceID string) {
	writeJSON(w, code, Response{
		Code:      code,
		Message:   "success",
		Data:      data,
...
// Paginated 分页响应
func Paginated(w http.ResponseWriter, code int, data any, page, pageSize int, total int64) {
