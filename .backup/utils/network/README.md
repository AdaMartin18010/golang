...
- [网络工具](#网络工具)
  ...
  - [1. 概述](#1-概述)
  - [2. 功能特性](#2-功能特性)
    - [2.1 IP地址验证](#21-ip地址验证)
    - [2.2 IP地址操作](#22-ip地址操作)
    - [2.3 本地网络信息](#23-本地网络信息)
    - [2.4 主机名解析](#24-主机名解析)
    - [2.5 端口操作](#25-端口操作)
    - [2.6 CIDR操作](#26-cidr操作)
    - [2.7 主机验证](#27-主机验证)
    - [2.8 MAC地址](#28-mac地址)
    - [2.9 网络连接](#29-网络连接)
  - [3. 使用示例](#3-使用示例)
    - [3.1 IP地址验证](#31-ip地址验证)
    - [3.2 IP地址操作](#32-ip地址操作)
    - [3.3 本地网络信息](#33-本地网络信息)
    - [3.4 主机名解析](#34-主机名解析)
    - [3.5 端口操作](#35-端口操作)
    - [3.6 CIDR操作](#36-cidr操作)
    - [3.7 主机验证](#37-主机验证)
    - [3.8 MAC地址](#38-mac地址)
    - [3.9 网络连接](#39-网络连接)
    - [3.10 完整示例](#310-完整示例)
