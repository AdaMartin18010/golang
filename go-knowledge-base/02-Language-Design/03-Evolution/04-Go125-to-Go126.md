...
> **前置概念**: [03 Go1.21~1.24](03-Go121-to-Go124.md) | **后置概念**: [07 Go1.26→1.27](07-Go126-to-Go127.md) · [LD-026](../LD-026-Go-126-New-Features.md)
> **定理链**: Go 1.25 基线 → 1.26 语言/运行时/标准库增量 → 迁移影响面
---
