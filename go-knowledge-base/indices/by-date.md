...
| ---------- | ----------- | ------- |
| [FT-010: Operational Semantics\n\n> **维度**: Formal Theory / **级别**: S (15+ KB)\n> **标签**: #operational-semantics\n\n## 1. 主题 1\n\n### 1.1 定义\n**定义 1.1**\n形式化定义。\n\nE_1 = mc^2\n\n**定理 1.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 1.2 实现\n`go\nfunc Example1() {\n    x := 1\n    fmt.Println(x)\n}\n`\n\n## 2. 主题 2\n\n### 2.1 定义\n**定义 2.1**\n形式化定义。\n\nE_2 = mc^2\n\n**定理 2.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 2.2 实现\n`go\nfunc Example2() {\n    x := 2\n    fmt.Println(x)\n}\n`\n\n## 3. 主题 3\n\n### 3.1 定义\n**定义 3.1**\n形式化定义。\n\nE_3 = mc^2\n\n**定理 3.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 3.2 实现\n`go\nfunc Example3() {\n    x := 3\n    fmt.Println(x)\n}\n`\n\n## 4. 主题 4\n\n### 4.1 定义\n**定义 4.1**\n形式化定义。\n\nE_4 = mc^2\n\n**定理 4.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 4.2 实现\n`go\nfunc Example4() {\n    x := 4\n    fmt.Println(x)\n}\n`\n\n## 5. 主题 5\n\n### 5.1 定义\n**定义 5.1**\n形式化定义。\n\nE_5 = mc^2\n\n**定理 5.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 5.2 实现\n`go\nfunc Example5() {\n    x := 5\n    fmt.Println(x)\n}\n`\n\n## 6. 主题 6\n\n### 6.1 定义\n**定义 6.1**\n形式化定义。\n\nE_6 = mc^2\n\n**定理 6.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 6.2 实现\n`go\nfunc Example6() {\n    x := 6\n    fmt.Println(x)\n}\n`\n\n## 7. 主题 7\n\n### 7.1 定义\n**定义 7.1**\n形式化定义。\n\nE_7 = mc^2\n\n**定理 7.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 7.2 实现\n`go\nfunc Example7() {\n    x := 7\n    fmt.Println(x)\n}\n`\n\n## 8. 主题 8\n\n### 8.1 定义\n**定义 8.1**\n形式化定义。\n\nE_8 = mc^2\n\n**定理 8.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 8.2 实现\n`go\nfunc Example8() {\n    x := 8\n    fmt.Println(x)\n}\n`\n\n## 9. 主题 9\n\n### 9.1 定义\n**定义 9.1**\n形式化定义。\n\nE_9 = mc^2\n\n**定理 9.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 9.2 实现\n`go\nfunc Example9() {\n    x := 9\n    fmt.Println(x)\n}\n`\n\n## 10. 主题 10\n\n### 10.1 定义\n**定义 10.1**\n形式化定义。\n\nE_10 = mc^2\n\n**定理 10.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 10.2 实现\n`go\nfunc Example10() {\n    x := 10\n    fmt.Println(x)\n}\n`\n\n## 11. 主题 11\n\n### 11.1 定义\n**定义 11.1**\n形式化定义。\n\nE_11 = mc^2\n\n**定理 11.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 11.2 实现\n`go\nfunc Example11() {\n    x := 11\n    fmt.Println(x)\n}\n`\n\n## 12. 主题 12\n\n### 12.1 定义\n**定义 12.1**\n形式化定义。\n\nE_12 = mc^2\n\n**定理 12.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 12.2 实现\n`go\nfunc Example12() {\n    x := 12\n    fmt.Println(x)\n}\n`\n\n## 13. 主题 13\n\n### 13.1 定义\n**定义 13.1**\n形式化定义。\n\nE_13 = mc^2\n\n**定理 13.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 13.2 实现\n`go\nfunc Example13() {\n    x := 13\n    fmt.Println(x)\n}\n`\n\n## 14. 主题 14\n\n### 14.1 定义\n**定义 14.1**\n形式化定义。\n\nE_14 = mc^2\n\n**定理 14.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 14.2 实现\n`go\nfunc Example14() {\n    x := 14\n    fmt.Println(x)\n}\n`\n\n## 15. 主题 15\n\n### 15.1 定义\n**定义 15.1**\n形式化定义。\n\nE_15 = mc^2\n\n**定理 15.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 15.2 实现\n`go\nfunc Example15() {\n    x := 15\n    fmt.Println(x)\n}\n`\n\n## 16. 主题 16\n\n### 16.1 定义\n**定义 16.1**\n形式化定义。\n\nE_16 = mc^2\n\n**定理 16.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 16.2 实现\n`go\nfunc Example16() {\n    x := 16\n    fmt.Println(x)\n}\n`\n\n## 17. 主题 17\n\n### 17.1 定义\n**定义 17.1**\n形式化定义。\n\nE_17 = mc^2\n\n**定理 17.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 17.2 实现\n`go\nfunc Example17() {\n    x := 17\n    fmt.Println(x)\n}\n`\n\n## 18. 主题 18\n\n### 18.1 定义\n**定义 18.1**\n形式化定义。\n\nE_18 = mc^2\n\n**定理 18.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 18.2 实现\n`go\nfunc Example18() {\n    x := 18\n    fmt.Println(x)\n}\n`\n\n## 19. 主题 19\n\n### 19.1 定义\n**定义 19.1**\n形式化定义。\n\nE_19 = mc^2\n\n**定理 19.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 19.2 实现\n`go\nfunc Example19() {\n    x := 19\n    fmt.Println(x)\n}\n`\n\n## 20. 主题 20\n\n### 20.1 定义\n**定义 20.1**\n形式化定义。\n\nE_20 = mc^2\n\n**定理 20.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 20.2 实现\n`go\nfunc Example20() {\n    x := 20\n    fmt.Println(x)\n}\n`\n\n## 21. 主题 21\n\n### 21.1 定义\n**定义 21.1**\n形式化定义。\n\nE_21 = mc^2\n\n**定理 21.1**\n性质成立。\n*证明*: 归纳法。$\square$\n\n### 21.2 实现\n`go\nfunc Example21() {\n    x := 21\n    fmt.Println(x)\n}\n](../01-Formal-Theory/01-Semantics/01-Operational-Semantics.md) | Formal Theory | S |
| [FT-011: Denotational Semantics](../01-Formal-Theory/01-Semantics/02-Denotational-Semantics.md) | Formal Theory | S |
| [FT-012: Axiomatic Semantics](../01-Formal-Theory/01-Semantics/03-Axiomatic-Semantics.md) | Formal Theory | S |
| [FT-013: Featherweight Go](../01-Formal-Theory/01-Semantics/04-Featherweight-Go.md) | Formal Theory | S |
| [FT-021: Structural Typing](../01-Formal-Theory/02-Type-Theory/01-Structural-Typing.md) | Formal Theory | S |
| [FT-022: Interface Types](../01-Formal-Theory/02-Type-Theory/02-Interface-Types.md) | Formal Theory | S |
| [FT-023-1: F-Bounded Polymorphism](../01-Formal-Theory/02-Type-Theory/03-Generics-Theory/01-F-Bounded-Polymorphism.md) | Formal Theory | S |
| [FT-023-2: Type Sets](../01-Formal-Theory/02-Type-Theory/03-Generics-Theory/02-Type-Sets.md) | Formal Theory | S |
| [FT-024: Subtyping](../01-Formal-Theory/02-Type-Theory/04-Subtyping.md) | Formal Theory | S |
| [FT-031: CSP Theory](../01-Formal-Theory/03-Concurrency-Models/01-CSP-Theory.md) | Formal Theory | S |
| [FT-032: Go Concurrency Semantics](../01-Formal-Theory/03-Concurrency-Models/02-Go-Concurrency-Semantics.md) | Formal Theory | S |
| [FT-042: Verification Frameworks](../01-Formal-Theory/03-Program-Verification/02-Verification-Frameworks.md) | Formal Theory | S |
| [FT-043: Model Checking](../01-Formal-Theory/03-Program-Verification/03-Model-Checking.md) | Formal Theory | S |
| [FT-051: Happens-Before](../01-Formal-Theory/04-Memory-Models/01-Happens-Before.md) | Formal Theory | S |
| [FT-052: DRF-SC Guarantee](../01-Formal-Theory/04-Memory-Models/02-DRF-SC.md) | Formal Theory | S |
| [FT-061: Functors](../01-Formal-Theory/05-Category-Theory/01-Functors.md) | Formal Theory | S |
| [FT-018: Go Generics Type System Theory](../01-Formal-Theory/18-Go-Generics-Type-System-Theory.md) | Formal Theory | S |
| [FT-019: Go Memory Model Happens-Before](../01-Formal-Theory/19-Go-Memory-Model-Happens-Before.md) | Formal Theory | S |
| [FT-001: 分布式系统基础的形式化理论 (Distributed Systems Foundation: Formal Theory)](../01-Formal-Theory/FT-001-Distributed-Systems-Foundation-Formal.md) | Formal Theory | S |
| [FT-001-B: Go Memory Model Formal Specification](../01-Formal-Theory/FT-001-Go-Memory-Model-Formal-Specification.md) | Formal Theory | S |
| [FT-002-B: GMP Scheduler Deep Dive](../01-Formal-Theory/FT-002-GMP-Scheduler-Deep-Dive.md) | Formal Theory | S |
| [FT-002: Raft 共识的形式化理论与实践 (Raft Consensus: Formal Theory & Practice)](../01-Formal-Theory/FT-002-Raft-Consensus-Formal.md) | Formal Theory | S |
| [FT-003: CAP 定理的形式化理论与实践 (CAP Theorem: Formal Theory & Practice)](../01-Formal-Theory/FT-003-CAP-Theorem-Formal.md) | Formal Theory | S |
| [FT-003-B: Distributed Consensus Raft-Paxos](../01-Formal-Theory/FT-003-Distributed-Consensus-Raft-Paxos.md) | Formal Theory | S |
| [FT-003-C: Paxos Consensus Formal](../01-Formal-Theory/FT-003-Paxos-Consensus-Formal.md) | Formal Theory | S |
| [FT-004: 一致性哈希的形式化理论与实践 (Consistent Hashing: Formal Theory & Practice)](../01-Formal-Theory/FT-004-Consistent-Hashing-Formal.md) | Formal Theory | S |
| [FT-004-B: CAP BASE ACID Fundamentals](../01-Formal-Theory/FT-004-Distributed-Systems-Fundamentals-CAP-BASE-ACID.md) | Formal Theory | S |
| [FT-005-B: Consistent Hashing](../01-Formal-Theory/FT-005-Consistent-Hashing.md) | Formal Theory | S |
| [FT-005: 向量时钟的形式化理论与实践 (Vector Clocks: Formal Theory & Practice)](../01-Formal-Theory/FT-005-Vector-Clocks-Formal.md) | Formal Theory | S |
| [FT-006: Paxos 共识算法的形式化理论 (Paxos Consensus: Formal Theory)](../01-Formal-Theory/FT-006-Paxos-Formal.md) | Formal Theory | S |
| [FT-006-B: Vector Clocks Logical Time](../01-Formal-Theory/FT-006-Vector-Clocks-Logical-Time.md) | Formal Theory | S |
| [FT-007-B: Byzantine Fault Tolerance](../01-Formal-Theory/FT-007-Byzantine-Fault-Tolerance.md) | Formal Theory | S |
| [FT-007: Multi-Paxos 的形式化理论与实践 (Multi-Paxos: Formal Theory & Practice)](../01-Formal-Theory/FT-007-Multi-Paxos-Formal.md) | Formal Theory | S |
| [FT-008: 拜占庭共识的形式化理论 (Byzantine Consensus: Formal Theory)](../01-Formal-Theory/FT-008-Byzantine-Consensus-Formal.md) | Formal Theory | S |
...
| [FT-044: 分布式事务的形式化理论 (Distributed Transactions: Formal Theory)](../01-Formal-Theory/FT-044-Distributed-Transactions-Formal.md) | Formal Theory | S |
...
| [FT-011: 顺序一致性的形式化理论 (Sequential Consistency: Formal Theory)](../01-Formal-Theory/FT-011-Sequential-Consistency-Formal.md) | Formal Theory | S |
| [FT-012-B: CRDT Conflict-Free Replicated Data Types](../01-Formal-Theory/FT-012-CRDT-Conflict-Free-Replicated-Data-Types.md) | Formal Theory | S |
| [FT-012: 因果一致性的形式化理论 (Causal Consistency: Formal Theory)](../01-Formal-Theory/FT-012-Causal-Consistency-Formal.md) | Formal Theory | S |
| [FT-013-B: Byzantine Fault Tolerance](../01-Formal-Theory/FT-013-Byzantine-Fault-Tolerance.md) | Formal Theory | S |
| [FT-013: 最终一致性的形式化理论 (Eventual Consistency: Formal Theory)](../01-Formal-Theory/FT-013-Eventual-Consistency-Formal.md) | Formal Theory | S |
| [FT-014: Session Guarantees - Formal Specification](../01-Formal-Theory/FT-014-Session-Guarantees-Formal.md) | Formal Theory | S |
| [FT-014-B: Two Phase Commit Formalization](../01-Formal-Theory/FT-014-Two-Phase-Commit-Formalization.md) | Formal Theory | S |
| [FT-015-B: Distributed Consensus Lower Bounds](../01-Formal-Theory/FT-015-Distributed-Consensus-Lower-Bounds.md) | Formal Theory | S |
| [FT-015: FLP Impossibility - Formal Analysis](../01-Formal-Theory/FT-015-FLP-Impossibility-Formal.md) | Formal Theory | S |
| [FT-016: PACELC Theorem - Formal Specification](../01-Formal-Theory/FT-016-PACELC-Theorem-Formal.md) | Formal Theory | S |
| [FT-017: Quorum Consensus - Formal Specification](../01-Formal-Theory/FT-017-Quorum-Consensus-Formal.md) | Formal Theory | S |
| [FT-018: CRDT - Conflict-Free Replicated Data Types - Formal Specification](../01-Formal-Theory/FT-018-CRDT-Formal.md) | Formal Theory | S |
| [FT-019: Operational Transformation - Formal Specification](../01-Formal-Theory/FT-019-Operational-Transformation.md) | Formal Theory | S |
| [FT-020: Distributed Snapshot - Formal Specification](../01-Formal-Theory/FT-020-Distributed-Snapshot-Formal.md) | Formal Theory | S |
| [FT-021: Two-Phase Commit (2PC) - Formal Specification](../01-Formal-Theory/FT-021-Two-Phase-Commit-Formal.md) | Formal Theory | S |
| [FT-022: Three-Phase Commit (3PC) - Formal Specification](../01-Formal-Theory/FT-022-Three-Phase-Commit-Formal.md) | Formal Theory | S |
| [FT-023: SAGA Pattern - Formal Specification](../01-Formal-Theory/FT-023-SAGA-Formal.md) | Formal Theory | S |
| [FT-024: Consensus Variations - Formal Analysis](../01-Formal-Theory/FT-024-Consensus-Variations-Formal.md) | Formal Theory | S |
| [FT-025: Leader Election - Formal Theory and Analysis](../01-Formal-Theory/FT-025-Leader-Election-Formal.md) | Formal Theory | S |
| [FT-026: Membership Protocol - Formal Theory and Analysis](../01-Formal-Theory/FT-026-Membership-Protocol-Formal.md) | Formal Theory | S |
| [FT-027: Gossip Protocol - Formal Theory and Analysis](../01-Formal-Theory/FT-027-Gossip-Protocol-Formal.md) | Formal Theory | S |
| [FT-031: Byzantine Fault Tolerance - Formal Theory](../01-Formal-Theory/FT-031-Byzantine-Fault-Tolerance-Formal.md) | Formal Theory | S |
| [FT-034: Distributed System Failure Case Studies](../01-Formal-Theory/FT-034-Distributed-System-Failure-Case-Studies.md) | Formal Theory | S |
| [Slice 内部实现 (Slice Internals)](../02-Language-Design/02-Language-Features/17-Slice-Internals.md) | Language Design | S |
| [Go 提案流程 (Proposal Process)](../02-Language-Design/03-Evolution/06-Proposal-Process.md) | Language Design | S |
| [Go vs Rust: Comprehensive Language Comparison](../02-Language-Design/04-Comparison/COMP-001-Go-vs-Rust.md) | Language Design | S |
| [Go vs Java: Enterprise Language Comparison](../02-Language-Design/04-Comparison/COMP-002-Go-vs-Java.md) | Language Design | S |
| [Go vs C++: Systems Programming Comparison](../02-Language-Design/04-Comparison/COMP-003-Go-vs-Cpp.md) | Language Design | S |
| [Go vs Python: Productivity and Deployment Comparison](../02-Language-Design/04-Comparison/COMP-004-Go-vs-Python.md) | Language Design | S |
| [Go vs Node.js: Async and Scalability Comparison](../02-Language-Design/04-Comparison/COMP-005-Go-vs-Nodejs.md) | Language Design | S |
| [Go vs Kotlin: Android and Server-Side Comparison](../02-Language-Design/04-Comparison/COMP-006-Go-vs-Kotlin.md) | Language Design | S |
| [Go vs Swift: Apple Ecosystem and Performance Comparison](../02-Language-Design/04-Comparison/COMP-007-Go-vs-Swift.md) | Language Design | S |
| [Generics Comparison: Go vs Other Languages](../02-Language-Design/04-Comparison/COMP-011-Generics-Comparison.md) | Language Design | S |
| [Error Handling Comparison: Go vs Other Languages](../02-Language-Design/04-Comparison/COMP-012-Error-Handling-Comparison.md) | Language Design | S |
| [Concurrency Models Comparison](../02-Language-Design/04-Comparison/COMP-013-Concurrency-Models-Comparison.md) | Language Design | S |
| [Memory Management Comparison Across Languages](../02-Language-Design/04-Comparison/COMP-014-Memory-Management-Comparison.md) | Language Design | S |
| [Type System Comparison: Go vs Other Languages](../02-Language-Design/04-Comparison/COMP-015-Type-System-Comparison.md) | Language Design | S |
| [Build System and Dependency Management Comparison](../02-Language-Design/04-Comparison/COMP-016-Build-System-Comparison.md) | Language Design | S |
| [Testing Frameworks Comparison](../02-Language-Design/04-Comparison/COMP-017-Testing-Frameworks-Comparison.md) | Language Design | S |
...
| [LD-016: Go 标准库深度剖析 (Go Standard Library Deep Dive)](../02-Language-Design/LD-016-Go-Standard-Library-Deep-Dive.md) | Language Design | S |
| [LD-017: Go HTTP 服务器内部原理 (Go HTTP Server Internals)](../02-Language-Design/LD-017-Go-HTTP-Server-Internals.md) | Language Design | S |
| [LD-018: Go 数据库/SQL 内部原理 (Go Database/SQL Internals)](../02-Language-Design/LD-018-Go-Database-SQL-Internals.md) | Language Design | S |
| [LD-019: Go JSON 编码内部原理 (Go JSON Encoding Internals)](../02-Language-Design/LD-019-Go-JSON-Encoding-Internals.md) | Language Design | S |
| [LD-020: Go 密码学包深度剖析 (Go Cryptography Packages)](../02-Language-Design/LD-020-Go-Cryptography-Packages.md) | Language Design | S |
| [LD-021: Go Sync 包深度剖析 (Go Sync Package Deep Dive)](../02-Language-Design/LD-021-Go-Sync-Package-Deep-Dive.md) | Language Design | S |
| [LD-022: Go 上下文传播机制 (Go Context Propagation)](../02-Language-Design/LD-022-Go-Context-Propagation.md) | Language Design | S |
| [LD-023: Go 错误处理模式详解 (Go Error Handling Patterns Deep Dive)](../02-Language-Design/LD-023-Go-Error-Handling-Patterns.md) | Language Design | S |
| [LD-024: Go 测试高级模式 (Go Testing Advanced Patterns)](../02-Language-Design/LD-024-Go-Testing-Advanced-Patterns.md) | Language Design | S |
| [LD-025: Go 性能剖析与优化 (Go Profiling & Optimization)](../02-Language-Design/LD-025-Go-Profiling-Optimization.md) | Language Design | S |
| [LD-026: Go 1.26 新特性深度解析 (Go 1.26 New Features Deep Dive)](../02-Language-Design/LD-026-Go-126-New-Features.md) | Language Design | S |
| [EC-M01: Clean Code Principles in Go (S-Level)](../03-Engineering-CloudNative/01-Methodology/01-Clean-Code.md) | Engineering CloudNative | S |
| [EC-M02: Design Patterns in Go (S-Level)](../03-Engineering-CloudNative/01-Methodology/02-Design-Patterns.md) | Engineering CloudNative | S |
| [EC-M03: Testing Strategies in Go (S-Level)](../03-Engineering-CloudNative/01-Methodology/03-Testing-Strategies.md) | Engineering CloudNative | S |
| [错误处理模式 (Error Handling Patterns)](../03-Engineering-CloudNative/01-Methodology/06-Error-Handling-Patterns.md) | Engineering CloudNative | S |
| [计划任务与上下文管理专题索引](../03-Engineering-CloudNative/02-Cloud-Native/00-Scheduled-Tasks-Context-Management-Index.md) | Engineering CloudNative | S |
| [任务资源配额管理 (Task Resource Quota Management)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/110-Task-Resource-Quota-Management.md) | Engineering CloudNative | S |
| [任务事件溯源实现 (Task Event Sourcing Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/111-Task-Event-Sourcing-Implementation.md) | Engineering CloudNative | S |
| [Saga 模式完整实现 (Saga Pattern Complete Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/112-Task-Saga-Pattern-Complete.md) | Engineering CloudNative | S |
| [Kubernetes CronJob Controller 源码深度分析](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/114-Task-K8s-CronJob-Controller-Analysis.md) | Engineering CloudNative | S |
| [Temporal Workflow 深度分析](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/115-Task-Temporal-Workflow-Deep-Dive.md) | Engineering CloudNative | S |
| [etcd 分布式协调模式 (etcd Coordination Patterns)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/116-Task-etcd-Coordination-Patterns.md) | Engineering CloudNative | S |
| [熔断器高级实现 (Circuit Breaker Advanced Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/117-Task-Circuit-Breaker-Advanced.md) | Engineering CloudNative | S |
| [背压与流量控制 (Backpressure & Flow Control)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/118-Task-Backpressure-Flow-Control.md) | Engineering CloudNative | S |
| [幂等性保证机制 (Idempotency Guarantee Mechanism)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/119-Task-Idempotency-Guarantee.md) | Engineering CloudNative | S |
| [优雅关闭完整实现 (Graceful Shutdown Complete Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/120-Task-Graceful-Shutdown-Complete.md) | Engineering CloudNative | S |
| [熔断器模式详解 (Circuit Breaker Patterns)](../03-Engineering-CloudNative/02-Cloud-Native/08-Circuit-Breaker-Patterns.md) | Engineering CloudNative | S |
| [形式化验证任务调度器 (Formal Verification of Task Scheduler)](../03-Engineering-CloudNative/02-Cloud-Native/101-Formal-Verification-Task-Scheduler.md) | Engineering CloudNative | S |
| [性能基准测试方法论 (Performance Benchmarking Methodology)](../03-Engineering-CloudNative/02-Cloud-Native/102-Performance-Benchmarking-Methodology.md) | Engineering CloudNative | S |
| [真实世界案例研究 (Real-World Case Studies)](../03-Engineering-CloudNative/02-Cloud-Native/103-Real-World-Case-Studies.md) | Engineering CloudNative | S |
| [安全加固检查清单 (Security Hardening Checklist)](../03-Engineering-CloudNative/02-Cloud-Native/104-Security-Hardening-Checklist.md) | Engineering CloudNative | S |
| [灾难恢复规划 (Disaster Recovery Planning)](../03-Engineering-CloudNative/02-Cloud-Native/105-Disaster-Recovery-Planning.md) | Engineering CloudNative | S |
| [分布式共识 Raft 实现 (Distributed Consensus Raft Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/108-Distributed-Consensus-Raft-Implementation.md) | Engineering CloudNative | S |
| [生产级任务调度器完整实现 (Production-Ready Task Scheduler Complete Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/109-Production-Ready-Task-Scheduler-Complete-Implementation.md) | Engineering CloudNative | S |
| [上下文感知日志 (Context-Aware Logging)](../03-Engineering-CloudNative/02-Cloud-Native/22-Context-Aware-Logging.md) | Engineering CloudNative | S |
| [任务监控与告警 (Task Monitoring & Alerting)](../03-Engineering-CloudNative/02-Cloud-Native/26-Task-Monitoring-Alerting.md) | Engineering CloudNative | S |
| [任务可观测性 (Task Observability)](../03-Engineering-CloudNative/02-Cloud-Native/32-Task-Observability.md) | Engineering CloudNative | S |
| [任务 Web UI (Task Web UI)](../03-Engineering-CloudNative/02-Cloud-Native/42-Task-Web-UI.md) | Engineering CloudNative | S |
| [Cadence/Temporal 工作流引擎深度解析 (Cadence/Temporal Workflow Engine Deep Dive)](../03-Engineering-CloudNative/02-Cloud-Native/58-Cadence-Temporal-Workflow-Engine.md) | Engineering CloudNative | S |
| [Kubernetes CronJob Controller 源码深度解析 (Kubernetes CronJob Controller Deep Dive)](../03-Engineering-CloudNative/02-Cloud-Native/59-Kubernetes-CronJob-Controller-Deep-Dive.md) | Engineering CloudNative | S |
| [Kubernetes CronJob Controller V2 深度解析](../03-Engineering-CloudNative/02-Cloud-Native/68-Kubernetes-CronJob-V2-Controller.md) | Engineering CloudNative | S |
| [Temporal 工作流引擎架构与实现](../03-Engineering-CloudNative/02-Cloud-Native/69-Temporal-Workflow-Engine.md) | Engineering CloudNative | S |
...
| [取消传播模式 (Cancellation Propagation Patterns)](../03-Engineering-CloudNative/EC-084-Cancellation-Propagation-Patterns.md) | Engineering CloudNative | S |
| [资源管理与调度 (Resource Management & Scheduling)](../03-Engineering-CloudNative/EC-085-Resource-Management-Scheduling.md) | Engineering CloudNative | S |
| [健康检查模式 (Health Check Patterns)](../03-Engineering-CloudNative/EC-086-Health-Check-Patterns.md) | Engineering CloudNative | S |
| [异步任务模式 (Async Task Patterns)](../03-Engineering-CloudNative/EC-087-Async-Task-Patterns.md) | Engineering CloudNative | S |
| [延迟任务调度 (Delayed Task Scheduling)](../03-Engineering-CloudNative/EC-088-Delayed-Task-Scheduling.md) | Engineering CloudNative | S |
| [任务优先级队列 (Task Priority Queue)](../03-Engineering-CloudNative/EC-089-Task-Priority-Queue.md) | Engineering CloudNative | S |
| [任务补偿与 Saga 模式 (Task Compensation & Saga Pattern)](../03-Engineering-CloudNative/EC-090-Task-Compensation-Saga-Pattern.md) | Engineering CloudNative | S |
| [分布式锁实现 (Distributed Lock Implementation)](../03-Engineering-CloudNative/EC-091-Distributed-Lock-Implementation.md) | Engineering CloudNative | S |
| [任务事件溯源持久化 (Task Event Sourcing Persistence)](../03-Engineering-CloudNative/EC-092-Task-Event-Sourcing-Persistence.md) | Engineering CloudNative | S |
| [多租户任务隔离 (Multi-Tenancy Task Isolation)](../03-Engineering-CloudNative/EC-093-Multi-Tenancy-Task-Isolation.md) | Engineering CloudNative | S |
| [任务调试与诊断 (Task Debugging & Diagnostics)](../03-Engineering-CloudNative/EC-094-Task-Debugging-Diagnostics.md) | Engineering CloudNative | S |
| [任务测试策略 (Task Testing Strategies)](../03-Engineering-CloudNative/EC-095-Task-Testing-Strategies.md) | Engineering CloudNative | S |
| [任务部署与运维 (Task Deployment & Operations)](../03-Engineering-CloudNative/EC-096-Task-Deployment-Operations.md) | Engineering CloudNative | S |
...
| [TS-CL-001: Go Standard Library Architecture and Design Philosophy](../04-Technology-Stack/01-Core-Library/01-Standard-Library-Overview.md) | Technology Stack | S |
| [TS-CL-002: Go I/O Package - Deep Architecture and Patterns](../04-Technology-Stack/01-Core-Library/02-IO-Package.md) | Technology Stack | S |
| [TS-CL-003: Go net/http Package Architecture](../04-Technology-Stack/01-Core-Library/03-HTTP-Package.md) | Technology Stack | S |
| [TS-CL-004: Go Context Package - Deep Architecture and Cancellation Patterns](../04-Technology-Stack/01-Core-Library/04-Context-Package.md) | Technology Stack | S |
| [TS-CL-005: Go sync Package - Concurrency Primitives Deep Dive](../04-Technology-Stack/01-Core-Library/05-Sync-Package.md) | Technology Stack | S |
| [TS-CL-006: Go time Package - Deep Architecture and Temporal Patterns](../04-Technology-Stack/01-Core-Library/06-Time-Package.md) | Technology Stack | S |
| [TS-CL-007: Go encoding/json Package - Deep Architecture and Serialization Patterns](../04-Technology-Stack/01-Core-Library/07-JSON-Package.md) | Technology Stack | S |
| [TS-CL-009: Go regexp Package - Deep Architecture and Pattern Matching](../04-Technology-Stack/01-Core-Library/09-Regexp-Package.md) | Technology Stack | S |
| [TS-CL-010: Go flag Package - Deep Architecture and CLI Patterns](../04-Technology-Stack/01-Core-Library/10-Flag-Package.md) | Technology Stack | S |
| [TS-CL-011: Go Context Advanced Patterns - Deep Dive](../04-Technology-Stack/01-Core-Library/11-Context-Advanced.md) | Technology Stack | S |
| [TS-CL-012: Go File Operations - Deep Architecture and Patterns](../04-Technology-Stack/01-Core-Library/12-File-Operations.md) | Technology Stack | S |
| [TS-CL-013: Go Hash Maps - Deep Architecture and Patterns](../04-Technology-Stack/01-Core-Library/13-Hash-Maps.md) | Technology Stack | S |
| [TS-CL-014: Go Channels Advanced Patterns](../04-Technology-Stack/01-Core-Library/14-Channels-Advanced.md) | Technology Stack | S |
| [TS-CL-015: Go text/template - Deep Architecture and Patterns](../04-Technology-Stack/01-Core-Library/15-Text-Template.md) | Technology Stack | S |
| [TS-DB-001: Database Connectivity in Go](../04-Technology-Stack/02-Database/01-Database-Connectivity.md) | Technology Stack | S |
| [TS-DB-002: GORM - Go ORM Architecture and Patterns](../04-Technology-Stack/02-Database/02-ORM-GORM.md) | Technology Stack | S |
| [TS-DB-004: Redis Internals and Go Integration](../04-Technology-Stack/02-Database/04-Redis.md) | Technology Stack | S |
| [TS-DB-005: MongoDB Architecture and Go Integration](../04-Technology-Stack/02-Database/05-MongoDB.md) | Technology Stack | S |
| [ClickHouse Columnar Database](../04-Technology-Stack/02-Database/06-ClickHouse.md) | Technology Stack | S |
| [TS-DB-008: Vector Databases](../04-Technology-Stack/02-Database/08-Vector-Database.md) | Technology Stack | S |
| [TS-DB-010: Database Sharding Strategies](../04-Technology-Stack/02-Database/10-Database-Sharding.md) | Technology Stack | S |
| [TS-DB-011: Caching Strategies and Patterns](../04-Technology-Stack/02-Database/11-Caching-Strategies.md) | Technology Stack | S |
| [TS-DB-012: Database Replication Strategies](../04-Technology-Stack/02-Database/12-Database-Replication.md) | Technology Stack | S |
| [TS-DB-013: Database Connection Pooling](../04-Technology-Stack/02-Database/13-Database-Pooling.md) | Technology Stack | S |
| [TS-NET-001: Gin Web Framework Architecture](../04-Technology-Stack/03-Network/01-Gin-Framework.md) | Technology Stack | S |
| [TS-NET-002: gRPC Architecture and Go Implementation](../04-Technology-Stack/03-Network/02-gRPC.md) | Technology Stack | S |
| [TS-NET-003: Echo Web Framework](../04-Technology-Stack/03-Network/03-Echo-Framework.md) | Technology Stack | S |
| [TS-NET-004: WebSocket in Go - Deep Architecture and Patterns](../04-Technology-Stack/03-Network/04-WebSocket.md) | Technology Stack | S |
| [TS-NET-005: Apache Kafka Architecture and Go Integration](../04-Technology-Stack/03-Network/05-Kafka.md) | Technology Stack | S |
| [TS-NET-006: NATS Messaging - Deep Architecture and Patterns](../04-Technology-Stack/03-Network/06-NATS.md) | Technology Stack | S |
| [TS-NET-007: etcd - Distributed Key-Value Store](../04-Technology-Stack/03-Network/07-Etcd.md) | Technology Stack | S |
| [TS-NET-008: Load Balancing Strategies](../04-Technology-Stack/03-Network/08-Load-Balancing.md) | Technology Stack | S |
| [TS-NET-009: Service Mesh Architecture (Istio/Linkerd)](../04-Technology-Stack/03-Network/09-Service-Mesh.md) | Technology Stack | S |
| [TS-NET-010: DNS Resolution in Go](../04-Technology-Stack/03-Network/10-DNS-Resolution.md) | Technology Stack | S |
| [TS-NET-011: Protocol Buffers in Go](../04-Technology-Stack/03-Network/11-Protocol-Buffers.md) | Technology Stack | S |
| [TS-NET-012: API Client Design Patterns in Go](../04-Technology-Stack/03-Network/12-API-Client-Design.md) | Technology Stack | S |
| [TS-NET-013: API Documentation Best Practices](../04-Technology-Stack/03-Network/13-API-Documentation.md) | Technology Stack | A |
| [TS-DT-001: Go Modules - Dependency Management](../04-Technology-Stack/04-Development-Tools/01-Go-Modules.md) | Technology Stack | S |
| [TS-DT-002: Go Linting and Static Analysis](../04-Technology-Stack/04-Development-Tools/02-Go-Linter.md) | Technology Stack | S |
| [TS-DT-005: API Documentation with Swagger/OpenAPI](../04-Technology-Stack/04-Development-Tools/05-Swagger-Doc.md) | Technology Stack | S |
| [TS-DT-007: Go Generate for Code Generation](../04-Technology-Stack/04-Development-Tools/07-Go-Generate.md) | Technology Stack | S |
| [TS-DT-008: Go Workspaces (Go 1.18+)](../04-Technology-Stack/04-Development-Tools/08-Go-Workspaces.md) | Technology Stack | S |
...
| [TS-020: Vault Secrets Management](../04-Technology-Stack/TS-020-Vault-Secrets-Management.md) | Technology Stack | S |
| [TS-021: Kubernetes Networking](../04-Technology-Stack/TS-021-Kubernetes-Networking.md) | Technology Stack | S |
| [TS-022: Docker Container Runtime](../04-Technology-Stack/TS-022-Docker-Container-Runtime.md) | Technology Stack | S |
| [TS-023: Envoy Proxy Configuration](../04-Technology-Stack/TS-023-Envoy-Proxy-Configuration.md) | Technology Stack | S |
| [TS-024: Linkerd Service Mesh](../04-Technology-Stack/TS-024-Linkerd-Service-Mesh.md) | Technology Stack | S |
| [TS-025: Cilium eBPF Networking](../04-Technology-Stack/TS-025-Cilium-eBPF-Networking.md) | Technology Stack | S |
| [TS-026: Terraform Infrastructure](../04-Technology-Stack/TS-026-Terraform-Infrastructure.md) | Technology Stack | S |
...
| [TS-037: MySQL 9 InnoDB Internals - S-Level Technical Reference](../04-Technology-Stack/TS-037-MySQL-9-Features.md) | Technology Stack | S |
| [TS-038: MongoDB 8 Replication Algorithm - S-Level Technical Reference](../04-Technology-Stack/TS-038-MongoDB-8-Features.md) | Technology Stack | S |
| [TS-039: TiDB 8.5 Distributed Transactions - S-Level Technical Reference](../04-Technology-Stack/TS-039-TiDB-8-5-Features.md) | Technology Stack | S |
| [TS-040: CockroachDB 25 C-SPANN Vector Index - S-Level Technical Reference](../04-Technology-Stack/TS-040-CockroachDB-25-Features.md) | Technology Stack | S |
| [TS-041: ClickHouse 25 Columnar Storage - S-Level Technical Reference](../04-Technology-Stack/TS-041-ClickHouse-25-Features.md) | Technology Stack | S |
| [TS-042: Redis 8 Data Structure Implementations - S-Level Technical Reference](../04-Technology-Stack/TS-042-Redis-8-Features.md) | Technology Stack | S |
| [RESTful API Design Patterns](../05-Application-Domains/01-Backend-Development/01-RESTful-API.md) | Application Domains | S |
| [02-Authentication](../05-Application-Domains/01-Backend-Development/02-Authentication.md) | Application Domains | S |
| [HTTP Middleware Patterns in Go](../05-Application-Domains/01-Backend-Development/03-Middleware-Patterns.md) | Application Domains | S |
| [GraphQL API Development in Go](../05-Application-Domains/01-Backend-Development/05-GraphQL.md) | Application Domains | S |
| [Rate Limiting Patterns](../05-Application-Domains/01-Backend-Development/06-Rate-Limiting.md) | Application Domains | S |
| [领域驱动设计模式 (DDD Patterns)](../05-Application-Domains/01-Backend-Development/12-DDD-Patterns.md) | Application Domains | S |
| [请求验证 (Request Validation)](../05-Application-Domains/01-Backend-Development/13-Request-Validation.md) | Application Domains | S |
| [Kubernetes Operators in Go](../05-Application-Domains/02-Cloud-Infrastructure/01-Kubernetes-Operators.md) | Application Domains | S |
| [多集群管理 (Multi-Cluster Management)](../05-Application-Domains/02-Cloud-Infrastructure/10-Multi-Cluster-Management.md) | Application Domains | S |
| [CLI Application Development in Go](../05-Application-Domains/03-DevOps-Tools/01-CLI-Development.md) | Application Domains | S |

### 2026-08

| Document | Dimension | Level |
|----------|-----------|-------|
| [Go 1.26 → Go 1.27 演进史](../02-Language-Design/03-Evolution/07-Go126-to-Go127.md) | Language Design | B |
| [LD-037: Go 1.27 泛型方法（Generic Methods）](../02-Language-Design/LD-037-Go-1.27-Generic-Methods.md) | Language Design | B |
...
| Document | Dimension | Level |
| ---------- | ----------- | ------- |
| [FT-028: Anti-Entropy Protocol - Formal Theory and Analysis](../01-Formal-Theory/FT-028-Anti-Entropy-Formal.md) | Formal Theory | S |
| [FT-029: Distributed Locking - Formal Theory and Analysis](../01-Formal-Theory/FT-029-Distributed-Locking-Formal.md) | Formal Theory | S |
...
| [FT-038-Distributed-Transactions](../01-Formal-Theory/FT-038-Distributed-Transactions.md) | Formal Theory | S |
| [FT-039-Raft-Consensus-Formal-Specification](../01-Formal-Theory/FT-039-Raft-Consensus-Formal-Specification.md) | Formal Theory | S |
| [FT-040-Paxos-Consensus-Formal](../01-Formal-Theory/FT-040-Paxos-Consensus-Formal.md) | Formal Theory | A |
| [简洁性原则 (Simplicity)](../02-Language-Design/01-Design-Philosophy/01-Simplicity.md) | Language Design | S |
| [组合优于继承 (Composition)](../02-Language-Design/01-Design-Philosophy/02-Composition.md) | Language Design | S |
| [显式优于隐式 (Explicit over Implicit)](../02-Language-Design/01-Design-Philosophy/03-Explicitness.md) | Language Design | S |
| [正交性 (Orthogonality)](../02-Language-Design/01-Design-Philosophy/04-Orthogonality.md) | Language Design | S |
| [类型系统 (Type System)](../02-Language-Design/02-Language-Features/01-Type-System.md) | Language Design | S |
| [Go 接口 (Interfaces)](../02-Language-Design/02-Language-Features/02-Interfaces.md) | Language Design | S |
| [Goroutines](../02-Language-Design/02-Language-Features/03-Goroutines.md) | Language Design | S |
| [Channels](../02-Language-Design/02-Language-Features/04-Channels.md) | Language Design | S |
| [错误处理 (Error Handling)](../02-Language-Design/02-Language-Features/05-Error-Handling.md) | Language Design | S |
| [泛型 (Generics)](../02-Language-Design/02-Language-Features/06-Generics.md) | Language Design | S |
| [反射 (Reflection)](../02-Language-Design/02-Language-Features/07-Reflection.md) | Language Design | S |
| [Go 运行时 (Runtime)](../02-Language-Design/02-Language-Features/08-Runtime.md) | Language Design | S |
| [内存管理 (Memory Management)](../02-Language-Design/02-Language-Features/09-Memory-Management.md) | Language Design | S |
| [垃圾回收 (Garbage Collection)](../02-Language-Design/02-Language-Features/10-GC.md) | Language Design | S |
| [Defer, Panic, Recover](../02-Language-Design/02-Language-Features/11-Defer-Panic-Recover.md) | Language Design | S |
| [Select 语句](../02-Language-Design/02-Language-Features/12-Select-Statement.md) | Language Design | S |
| [结构体嵌入 (Struct Embedding)](../02-Language-Design/02-Language-Features/13-Struct-Embedding.md) | Language Design | S |
| [匿名函数与闭包 (Anonymous Functions & Closures)](../02-Language-Design/02-Language-Features/14-Anonymous-Functions.md) | Language Design | S |
| [字符串处理 (String Handling)](../02-Language-Design/02-Language-Features/15-String-Handling.md) | Language Design | S |
| [接口内部实现 (Interface Internals)](../02-Language-Design/02-Language-Features/16-Interface-Internals.md) | Language Design | S |
| [包管理详解 (Package Management)](../02-Language-Design/02-Language-Features/18-Package-Management.md) | Language Design | S |
| [常量 (Constants)](../02-Language-Design/02-Language-Features/19-Constants.md) | Language Design | S |
| [类型断言 (Type Assertions)](../02-Language-Design/02-Language-Features/20-Type-Assertions.md) | Language Design | S |
| [Go 1.0 - 1.15 演进](../02-Language-Design/03-Evolution/01-Go1-to-Go115.md) | Language Design | S |
| [Go 1.16 - 1.20 演进](../02-Language-Design/03-Evolution/02-Go116-to-Go120.md) | Language Design | S |
| [Go 1.21 - 1.24 演进](../02-Language-Design/03-Evolution/03-Go121-to-Go124.md) | Language Design | S |
| [Go 1.25 - 1.26 演进](../02-Language-Design/03-Evolution/04-Go125-to-Go126.md) | Language Design | S |
| [破坏性变更 (Breaking Changes)](../02-Language-Design/03-Evolution/05-Breaking-Changes.md) | Language Design | S |
| [Go vs C#: .NET Ecosystem and Enterprise Comparison](../02-Language-Design/04-Comparison/COMP-008-Go-vs-CSharp.md) | Language Design | S |
| [Go vs Erlang/Elixir: Fault Tolerance and Concurrency Comparison](../02-Language-Design/04-Comparison/COMP-009-Go-vs-Erlang-Elixir.md) | Language Design | S |
| [Go vs Haskell: Functional Programming and Type System Comparison](../02-Language-Design/04-Comparison/COMP-010-Go-vs-Haskell.md) | Language Design | S |
| [Deployment and Operations Comparison](../02-Language-Design/04-Comparison/COMP-018-Deployment-Comparison.md) | Language Design | S |
| [Performance Benchmarks: Comprehensive Language Comparison](../02-Language-Design/04-Comparison/COMP-019-Performance-Benchmarks-Comparison.md) | Language Design | S |
| [Ecosystem and Libraries Comparison](../02-Language-Design/04-Comparison/COMP-020-Ecosystem-Libraries-Comparison.md) | Language Design | S |
...
| [LD-029-Go-126-Features](../02-Language-Design/LD-029-Go-126-Features.md) | Language Design | B |
| [LD-030-Go-127-Roadmap](../02-Language-Design/LD-030-Go-127-Roadmap.md) | Language Design | B |
| [LD-031-Go-Concurrency-Patterns-Advanced](../02-Language-Design/LD-031-Go-Concurrency-Patterns-Advanced.md) | Language Design | A |
| [LD-032-Go-Testing-Advanced](../02-Language-Design/LD-032-Go-Testing-Advanced.md) | Language Design | A |
| [LD-033-Go-Runtime-Scheduler-Deep-Dive](../02-Language-Design/LD-033-Go-Runtime-Scheduler-Deep-Dive.md) | Language Design | A |
| [LD-034-Go-Garbage-Collector-Internals](../02-Language-Design/LD-034-Go-Garbage-Collector-Internals.md) | Language Design | A |
| [EC-M04: Code Review Guidelines (S-Level)](../03-Engineering-CloudNative/01-Methodology/04-Code-Review.md) | Engineering CloudNative | S |
| [项目结构 (Project Structure)](../03-Engineering-CloudNative/01-Methodology/05-Project-Structure.md) | Engineering CloudNative | S |
| [日志模式 (Logging Patterns)](../03-Engineering-CloudNative/01-Methodology/07-Logging-Patterns.md) | Engineering CloudNative | S |
| [CRDT 冲突解决实现 (CRDT Conflict Resolution Implementation)](../03-Engineering-CloudNative/02-Cloud-Native/05-Scheduled-Tasks/113-Task-CRDT-Conflict-Resolution.md) | Engineering CloudNative | S |
| [优雅关闭 (Graceful Shutdown)](../03-Engineering-CloudNative/02-Cloud-Native/07-Graceful-Shutdown.md) | Engineering CloudNative | S |
| [编译器优化任务调度器 (Compiler Optimizations For Task Scheduler)](../03-Engineering-CloudNative/02-Cloud-Native/106-Compiler-Optimizations-For-Task-Scheduler.md) | Engineering CloudNative | S |
| [内核级任务调度 (Kernel-Level Task Scheduling)](../03-Engineering-CloudNative/02-Cloud-Native/107-Kernel-Level-Task-Scheduling.md) | Engineering CloudNative | S |
| [性能剖析 (Profiling)](../03-Engineering-CloudNative/03-Performance/01-Profiling.md) | Engineering CloudNative | S |
| [性能优化 (Optimization)](../03-Engineering-CloudNative/03-Performance/02-Optimization.md) | Engineering CloudNative | S |
| [竞态检测 (Race Detection)](../03-Engineering-CloudNative/03-Performance/04-Race-Detection.md) | Engineering CloudNative | S |
| [内存泄漏检测 (Memory Leak Detection)](../03-Engineering-CloudNative/03-Performance/05-Memory-Leak-Detection.md) | Engineering CloudNative | S |
| [无锁编程 (Lock-Free Programming)](../03-Engineering-CloudNative/03-Performance/06-Lock-Free-Programming.md) | Engineering CloudNative | S |
| [逃逸分析 (Escape Analysis)](../03-Engineering-CloudNative/03-Performance/07-Escape-Analysis.md) | Engineering CloudNative | S |
| [内存分配优化 (Allocation Optimization)](../03-Engineering-CloudNative/03-Performance/08-Allocation-Optimization.md) | Engineering CloudNative | S |
| [安全编码 (Secure Coding)](../03-Engineering-CloudNative/04-Security/01-Secure-Coding.md) | Engineering CloudNative | S |
| [漏洞管理 (Vulnerability Management)](../03-Engineering-CloudNative/04-Security/02-Vulnerability-Management.md) | Engineering CloudNative | S |
| [密钥管理 (Secrets Management)](../03-Engineering-CloudNative/04-Security/04-Secrets-Management.md) | Engineering CloudNative | S |
| [OWASP Top 10 for Go](../03-Engineering-CloudNative/04-Security/05-OWASP-Top-10.md) | Engineering CloudNative | S |
| [零信任架构 (Zero Trust)](../03-Engineering-CloudNative/04-Security/06-Zero-Trust.md) | Engineering CloudNative | S |
...
| [数据库迁移 (Database Migration)](../04-Technology-Stack/02-Database/09-Database-Migration.md) | Technology Stack | S |
...
| [TS-032-PostgreSQL-19-New-Features](../04-Technology-Stack/TS-032-PostgreSQL-19-New-Features.md) | Technology Stack | B |
| [TS-033-Linux-Kernel-6-15-Features](../04-Technology-Stack/TS-033-Linux-Kernel-6-15-Features.md) | Technology Stack | B |
| [TS-043-Go-Web-Frameworks-2026](../04-Technology-Stack/TS-043-Go-Web-Frameworks-2026.md) | Technology Stack | B |
| [TS-044-Database-Sharding-Partitioning](../04-Technology-Stack/TS-044-Database-Sharding-Partitioning.md) | Technology Stack | A |
| [TS-045-PostgreSQL-Internals-MVCC](../04-Technology-Stack/TS-045-PostgreSQL-Internals-MVCC.md) | Technology Stack | A |
| [API 网关设计与实现](../05-Application-Domains/01-Backend-Development/04-API-Gateway.md) | Application Domains | S |
| [分布式事务 (Distributed Transactions)](../05-Application-Domains/01-Backend-Development/07-Distributed-Transactions.md) | Application Domains | S |
| [实时通信 (Real-Time Communication)](../05-Application-Domains/01-Backend-Development/08-Real-Time-Communication.md) | Application Domains | S |
| [Webhook 安全实践](../05-Application-Domains/01-Backend-Development/10-Webhook-Security.md) | Application Domains | S |
| [API 版本控制 (API Versioning)](../05-Application-Domains/01-Backend-Development/11-API-Versioning.md) | Application Domains | S |
| [内容协商 (Content Negotiation)](../05-Application-Domains/01-Backend-Development/14-Content-Negotiation.md) | Application Domains | S |
| [Terraform Providers](../05-Application-Domains/02-Cloud-Infrastructure/02-Terraform-Providers.md) | Application Domains | S |
| [Docker SDK](../05-Application-Domains/02-Cloud-Infrastructure/03-Docker-Lib.md) | Application Domains | S |
| [Helm Charts](../05-Application-Domains/02-Cloud-Infrastructure/04-Helm-Charts.md) | Application Domains | S |
| [Prometheus Operator](../05-Application-Domains/02-Cloud-Infrastructure/05-Prometheus-Operator.md) | Application Domains | S |
| [服务网格控制面 (Service Mesh Control Plane)](../05-Application-Domains/02-Cloud-Infrastructure/06-Service-Mesh-Control.md) | Application Domains | S |
| [事件驱动架构 (Event-Driven Architecture)](../05-Application-Domains/02-Cloud-Infrastructure/07-Event-Driven-Architecture.md) | Application Domains | S |
| [GitOps 实践](../05-Application-Domains/02-Cloud-Infrastructure/08-GitOps.md) | Application Domains | S |
| [边缘计算 (Edge Computing)](../05-Application-Domains/02-Cloud-Infrastructure/09-Edge-Computing.md) | Application Domains | S |
| [成本管理 (Cost Management)](../05-Application-Domains/02-Cloud-Infrastructure/11-Cost-Management.md) | Application Domains | S |
| [监控工具开发](../05-Application-Domains/03-DevOps-Tools/02-Monitoring-Tools.md) | Application Domains | S |
| [测试工具链](../05-Application-Domains/03-DevOps-Tools/03-Testing-Tools.md) | Application Domains | S |
| [CI/CD 集成](../05-Application-Domains/03-DevOps-Tools/04-CI-CD.md) | Application Domains | S |
| [日志分析工具](../05-Application-Domains/03-DevOps-Tools/05-Log-Analysis.md) | Application Domains | S |
| [配置管理](../05-Application-Domains/03-DevOps-Tools/06-Configuration-Management.md) | Application Domains | S |
| [混沌工程 (Chaos Engineering)](../05-Application-Domains/03-DevOps-Tools/08-Chaos-Engineering.md) | Application Domains | S |
| [基础设施即代码 (IaC)](../05-Application-Domains/03-DevOps-Tools/09-Infrastructure-as-Code.md) | Application Domains | S |
| [特性开关 (Feature Flags)](../05-Application-Domains/03-DevOps-Tools/10-Feature-Flags.md) | Application Domains | S |
| [AIOps 基础](../05-Application-Domains/03-DevOps-Tools/11-AIOps.md) | Application Domains | S |
| [备份与恢复 (Backup & Recovery)](../05-Application-Domains/03-DevOps-Tools/14-Backup-Recovery.md) | Application Domains | S |
| [AD-010-System-Design-Interview](../05-Application-Domains/AD-010-System-Design-Interview.md) | Application Domains | S |
| [AD-011: Real-Time System Design](../05-Application-Domains/AD-011-Real-Time-System-Design.md) | Application Domains | S |
| [AD-012: High Availability Design](../05-Application-Domains/AD-012-High-Availability-Design.md) | Application Domains | S |
| [AD-013: Security Architecture Design](../05-Application-Domains/AD-013-Security-Architecture.md) | Application Domains | S |
| [AD-014: Data Pipeline Architecture](../05-Application-Domains/AD-014-Data-Pipeline-Architecture.md) | Application Domains | S |
| [AD-015: Mobile Backend Design](../05-Application-Domains/AD-015-Mobile-Backend-Design.md) | Application Domains | S |
| [AD-016: E-commerce System Design](../05-Application-Domains/AD-016-E-commerce-System-Design.md) | Application Domains | S |
| [AD-017: Financial System Design](../05-Application-Domains/AD-017-Financial-System-Design.md) | Application Domains | S |
| [AD-018: Gaming Backend Design](../05-Application-Domains/AD-018-Gaming-Backend-Design.md) | Application Domains | S |
| [AD-019: IoT Platform Design](../05-Application-Domains/AD-019-IoT-Platform-Design.md) | Application Domains | S |
| [AD-020: Blockchain System Design](../05-Application-Domains/AD-020-Blockchain-System-Design.md) | Application Domains | S |
| [AD-021: Search Engine Design](../05-Application-Domains/AD-021-Search-Engine-Design.md) | Application Domains | S |
| [AD-022: Recommendation System Design](../05-Application-Domains/AD-022-Recommendation-System.md) | Application Domains | S |
| [AD-023: Ad Serving Platform Design](../05-Application-Domains/AD-023-Ad-Serving-Platform.md) | Application Domains | S |
...
| [AD-030-E-commerce-Systems-2026](../05-Application-Domains/AD-030-E-commerce-Systems-2026.md) | Application Domains | S |
| [AD-031-IoT-Edge-Computing-2026](../05-Application-Domains/AD-031-IoT-Edge-Computing-2026.md) | Application Domains | S |
