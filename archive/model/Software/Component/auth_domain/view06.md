...
- [加密](#加密)
  - [1. ](#11-目录)
  - [2. ](#12-1-引言核心概念)
    - [2.1 ](#121-加密-cryptography)
    - [2.2 ](#122-验证-authentication)
    - [2.3 ](#123-授权-authorization)
  - [3. ](#13-2-编程语言基础与安全)
    - [3.1 ](#131-变量-variables)
    - [3.2 ](#132-类型系统-type-system)
    - [3.3 ](#133-控制结构-control-structures)
    - [3.4 ](#134-语法与语义-syntax--semantics)
    - [3.5 ](#135-作用域-scope)
  - [4. ](#14-3-程序执行流与安全分析)
    - [4.1 ](#141-控制流-control-flow)
    - [4.2 ](#142-数据流-data-flow)
    - [4.3 ](#143-执行流-execution-flow)
    - [4.4 ](#144-同步与异步-syncasync)
  - [5. ](#15-4-形式化方法与证明)
    - [5.1 ](#151-概念与定义)
    - [5.2 ](#152-在安全领域的应用)
    - [5.3 ](#153-形式化推理与证明)
  - [6. ](#16-5-元理论与分层模型)
    - [6.1 ](#161-元模型-metamodel-与模型-model)
    - [6.2 ](#162-元理论-metatheory-与理论-theory)
    - [6.3 ](#163-分层分析)
  - [7. ](#17-6-思维导图-text)
  - [8. ](#18-7-总结)
  - [9. ](#19-8-语言特性与具体漏洞类型的关联)
    - [9.1 ](#191-内存安全与缓冲区溢出use-after-free)
    - [9.2 ](#192-类型系统与类型混淆注入)
    - [9.3 ](#193-控制流与逻辑漏洞旁路)
    - [9.4 ](#194-并发与竞态条件-toctou)
  - [10. ](#110-9-安全工程实践整合分析)
    - [10.1 ](#1101-安全开发生命周期-sdl)
    - [10.2 ](#1102-威胁建模-threat-modeling)
    - [10.3 ](#1103-安全编码规范)
    - [10.4 ](#1104-代码审计与静态动态分析)
