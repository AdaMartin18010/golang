...
- [ ](#1-1-1-1-1-1-1-docker与kubernetes架构模型解构分析和综合)
  - [1. ](#11-目录)
  - [2. ](#12-思维导图)
  - [3. ](#13-1-基础架构概念)
    - [3.1 ](#131-docker容器化核心概念)
    - [3.2 ](#132-kubernetes编排平台架构)
  - [4. ](#14-2-系统架构层次分析)
    - [4.1 ](#141-docker架构模型)
    - [4.2 ](#142-kubernetes架构模型)
    - [4.3 ](#143-控制平面与数据平面)
  - [5. ](#15-3-组件交互与关系分析)
    - [5.1 ](#151-docker组件交互模型)
    - [5.2 ](#152-kubernetes组件交互模型)
    - [5.3 ](#153-cri接口与容器运行时)
  - [6. ](#16-4-工作流与编排模型)
    - [6.1 ](#161-声明式api与控制循环)
    - [6.2 ](#162-调度与资源管理)
