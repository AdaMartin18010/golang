...
- [Rust实现的23种工作流设计模式全解析](#rust实现的23种工作流设计模式全解析)
  ...
  - [2. 基本控制流模式](#2-基本控制流模式)
    - [2.1 序列模式](#21-序列模式)
    - [2.2 并行拆分模式](#22-并行拆分模式)
    - [2.3 同步模式](#23-同步模式)
    - [2.4 独占选择模式](#24-独占选择模式)
    - [2.5 简单合并模式](#25-简单合并模式)
  - [3. 高级分支合并模式](#3-高级分支合并模式)
    - [3.1 多选模式](#31-多选模式)
    - [3.2 同步合并模式](#32-同步合并模式)
    - [3.3 多合并模式](#33-多合并模式)
    - [3.4 结构化判别模式](#34-结构化判别模式)
    - [3.5 通用判别模式](#35-通用判别模式)
  - [4. 结构模式](#4-结构模式)
  ...
  - [8. 模式组合应用](#8-模式组合应用)
    - [8.1 订单处理工作流](#81-订单处理工作流)
    - [8.2 审批工作流](#82-审批工作流)
  - [9. Rust开源工作流库](#9-rust开源工作流库)
    - [9.1 流行库概述](#91-流行库概述)
    - [9.2 Swirl 工作流引擎](#92-swirl-工作流引擎)
      - [9.2.1 基本概念](#921-基本概念)
      - [9.2.2 安装和基本使用](#922-安装和基本使用)
      - [9.2.3 高级功能](#923-高级功能)
    - [9.3 实现自定义工作流库](#93-实现自定义工作流库)
      - [9.3.1 核心组件设计](#931-核心组件设计)
      - [9.3.2 使用示例](#932-使用示例)
  - [10. 总结](#10-总结)
    - [10.1 工作流模式选择指南](#101-工作流模式选择指南)
    - [10.2 Rust工作流实践中的最佳实践](#102-rust工作流实践中的最佳实践)
