...
- [rust 实现设计模式](#rust-实现设计模式)
  - [1. ](#11-异步实现)
    ...
    - [1.1.12 总结](#1112-总结)
  - [2. ](#12-同步多线程实现)
    - [2.1 ](#121-1-单例模式singleton-pattern)
    - [2.2 ](#122-2-工厂方法模式factory-method-pattern)
    - [2.3 ](#123-3-抽象工厂模式abstract-factory-pattern)
    - [2.4 ](#124-4-建造者模式builder-pattern)
    - [2.5 ](#125-5-原型模式prototype-pattern)
    - [2.6 ](#126-6-对象池模式object-pool-pattern)
    - [2.7 ](#127-7-多例模式multiton-pattern)
    - [2.8 ](#128-8-静态工厂方法static-factory-method)
    - [2.9 ](#129-9-简单工厂模式simple-factory-pattern)
    - [2.10 ](#1210-10-懒汉式与饿汉式单例)
    - [2.11 ](#1211-11-登记式单例registry-singleton)
    - [2.12 ](#1212-总结)
<!-- TOC END -->
...
### 1.2.9 *9. 简单工厂模式（Simple Factory Pattern）*
