...
- [并发模式(Concurrent Patterns)](#并发模式concurrent-patterns)
  - [1. ](#11-同步实现)
    - [1.1 ](#111-1-线程池模式thread-pool-pattern)
    - [1.2 ](#112-2-future模式future-pattern)
    - [1.3 ](#113-3-promise模式promise-pattern)
    - [1.4 ](#114-4-反应器模式reactor-pattern)
    - [1.5 ](#115-5-提议者模式proactor-pattern)
...
### 1.1.11 11. 工作窃取模式（Work Stealing Pattern）
...
### 1.1.14 14. 双重检查锁定模式（Double-Checked Locking Pattern）
