# 人工智能/机器学习 (AI/ML) 领域架构分析

## 目录

- [人工智能/机器学习 (AI/ML) 领域架构分析](#人工智能机器学习-aiml-领域架构分析)
  - [目录](#目录)
  - [概述](#概述)
    - [核心挑战](#核心挑战)
  - [核心概念与形式化定义](#核心概念与形式化定义)
    - [2.1 机器学习模型](#21-机器学习模型)
      - [定义 2.1.1 (机器学习模型)](#定义-211-机器学习模型)
      - [定义 2.1.2 (训练过程)](#定义-212-训练过程)
      - [定义 2.1.3 (推理过程)](#定义-213-推理过程)
    - [2.2 特征工程](#22-特征工程)
      - [定义 2.2.1 (特征向量)](#定义-221-特征向量)
      - [定义 2.2.2 (特征变换)](#定义-222-特征变换)
      - [定理 2.2.1 (特征重要性)](#定理-221-特征重要性)
    - [2.3 模型评估](#23-模型评估)
      - [定义 2.3.1 (准确率)](#定义-231-准确率)
      - [定义 2.3.2 (精确率和召回率)](#定义-232-精确率和召回率)
      - [定义 2.3.3 (F1分数)](#定义-233-f1分数)
  - [MLOps架构](#mlops架构)
    - [3.1 分层架构](#31-分层架构)
    - [3.2 微服务架构](#32-微服务架构)
