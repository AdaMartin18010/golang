...
- [Rust所有权系统的资源管理分析](#rust所有权系统的资源管理分析)
  ...
  - [1.3 2. 所有权与类型系统](#13-2-所有权与类型系统)
    ...
    - [1.3.2 所有权模式分析](#132-所有权模式分析)
    - [1.3.3 类型对称性与非对称处理](#133-类型对称性与非对称处理)
  - [1.4 3. 所有权与控制流](#14-3-所有权与控制流)
    - [1.4.1 控制流设计原则](#141-控制流设计原则)
    - [1.4.2 借用检查器的工作模式](#142-借用检查器的工作模式)
    - [1.4.3 控制流中的对称与非对称](#143-控制流中的对称与非对称)
  - [1.5 4. 所有权与变量](#15-4-所有权与变量)
    - [1.5.1 变量设计原则](#151-变量设计原则)
    - [1.5.2 变量生命周期模式](#152-变量生命周期模式)
    - [1.5.3 变量操作的对称性](#153-变量操作的对称性)
  - [1.6 5. 统一模型：对称性法则](#16-5-统一模型对称性法则)
    - [1.6.1 核心形式模式](#161-核心形式模式)
    - [1.6.2 对称性破缺处理](#162-对称性破缺处理)
  - [1.7 6. 总结](#17-6-总结)
