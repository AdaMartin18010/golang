...
<!-- TOC START -->
- [ ](#1-1-1-1-1-1-1-类型-never-type)
  - [1. ](#11-定义)
  - [2. ](#12-使用场景)
    - [2.1 ](#121-1-无限循环当一个函数需要无限循环时可以使用--类型作为返回值)
    - [2.2 ](#122-2-错误处理在某些情况下函数可能会遇到错误情况并立即退出使用--可以表示这种情况)
    - [2.3 ](#123-3-异步编程在异步编程中-类型用于表示一个-future-可能永远不会完成)
  - [3. ](#13-特点)
  - [4. ](#14-负特征-negative-trait-bounds)
<!-- TOC END -->
