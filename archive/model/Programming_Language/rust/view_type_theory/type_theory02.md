...
- [类型论（Type Theory）](#类型论type-theory)
  - [1.1 目录](#11-目录)
  - [1.2 **类型（Type）**](#12-类型type)
  - [1.3 **项（Term）**](#13-项term)
  - [1.4 **上下文（Context）**](#14-上下文context)
  - [1.5 **判断（Judgment）**](#15-判断judgment)
  - [1.6 **函数类型（Function Type）**](#16-函数类型function-type)
  - [1.7 **乘积类型（Product Type）**](#17-乘积类型product-type)
  - [1.8 **和类型（Sum Type）**](#18-和类型sum-type)
  - [1.9 **归纳类型（Inductive Type）**](#19-归纳类型inductive-type)
  - [1.10 **类型检查（Type Checking）**](#110-类型检查type-checking)
  - [1.11 **类型推导（Type Inference）**](#111-类型推导type-inference)
  - [1.12 总结](#112-总结)
  - [1.13 2. 类型论在编程语言中的应用](#113-2-类型论在编程语言中的应用)
    - [1.13.1 **类型系统设计**](#1131-类型系统设计)
    - [1.13.2 **函数式编程**](#1132-函数式编程)
    - [1.13.3 **泛型编程**](#1133-泛型编程)
    - [1.13.4 **依赖类型**](#1134-依赖类型)
    - [1.13.5 **并发和并行编程**](#1135-并发和并行编程)
    - [1.13.6 **语言互操作性**](#1136-语言互操作性)
    - [1.13.7 **编译器和解释器实现**](#1137-编译器和解释器实现)
    - [1.13.8 **教育和研究**](#1138-教育和研究)
    - [1.13.9 **总结**](#1139-总结)
    - [1.13.10 1. 类型的结构定义](#11310-1-类型的结构定义)
    - [1.13.11 2. 类型的法则](#11311-2-类型的法则)
    - [1.13.12 3. 其他重要概念](#11312-3-其他重要概念)
    - [1.13.13 1. 变量法则](#11313-1-变量法则)
    - [1.13.14 2. 抽象法则](#11314-2-抽象法则)
    - [1.13.15 3. 应用法则](#11315-3-应用法则)
    - [1.13.16 4. 让步法则（Let法则）](#11316-4-让步法则let法则)
    - [1.13.17 5. 递归法则](#11317-5-递归法则)
    - [1.13.18 6. 组合法则](#11318-6-组合法则)
    - [1.13.19 7. 多态法则](#11319-7-多态法则)
    - [1.13.20 1. 类型等价](#11320-1-类型等价)
    - [1.13.21 2. 类型定义](#11321-2-类型定义)
    - [1.13.22 3. 类型别名](#11322-3-类型别名)
    - [1.13.23 总结](#11323-总结)
    - [1.13.24 1. 运行时等价法则](#11324-1-运行时等价法则)
      - [1.13.24.1 1.1. 结构等价法则](#113241-11-结构等价法则)
      - [1.13.24.2 1.2. 归纳法则](#113242-12-归纳法则)
      - [1.13.24.3 1.3. 替换法则](#113243-13-替换法则)
      - [1.13.24.4 1.4. 透明性法则](#113244-14-透明性法则)
    - [1.13.25 2. 运行时等价推理模型的应用](#11325-2-运行时等价推理模型的应用)
    - [1.13.26 3. 总结](#11326-3-总结)
