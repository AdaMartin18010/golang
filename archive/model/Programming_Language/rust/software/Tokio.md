...
- [Tokio 异步运行时](#tokio-异步运行时)
  - [1.1 1. Tokio 及其生态](#11-1-tokio-及其生态)
    - [1.1.1 网络服务与 Web 框架](#111-网络服务与-web-框架)
    - [1.1.2 数据库驱动与中间件](#112-数据库驱动与中间件)
    - [1.1.3 分布式系统与微服务](#113-分布式系统与微服务)
  - [1.2 2. 其他异步运行时及框架](#12-2-其他异步运行时及框架)
  - [1.3 3. 应用领域](#13-3-应用领域)
  - [1.4 4. 总结](#14-4-总结)
  - [1.5 Tokio 中的异步任务能否指定优先级？](#15-tokio-中的异步任务能否指定优先级)
  - [1.6 替代方案与变通方法](#16-替代方案与变通方法)
  - [1.7 总结](#17-总结)
  - [1.8 Rust 如何实现运行时负载感知并调整运行策略](#18-rust-如何实现运行时负载感知并调整运行策略)
  - [1.9 1. 负载监控](#19-1-负载监控)
    - [1.9.1 利用系统信息查询库](#191-利用系统信息查询库)
    - [1.9.2 定时采集指标并监控](#192-定时采集指标并监控)
  - [1.10 2. 动态调整策略](#110-2-动态调整策略)
  - [1.11 3. 应用场景整合](#111-3-应用场景整合)
    - [1.11.1 异步任务调度](#1111-异步任务调度)
    - [1.11.2 微服务 / IoT 网关](#1112-微服务--iot-网关)
  - [1.12 小结](#112-小结)
<!-- TOC END -->
