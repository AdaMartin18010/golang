...
<!-- TOC START -->
- [RPIT（Reference-Passing In Trait）在 Rust 2024 中的含义、举例和应用](#rpitreference-passing-in-trait在-rust-2024-中的含义举例和应用)
  - [1.1 1. 含义](#11-1-含义)
  - [1.2 2. 举例](#12-2-举例)
    - [1.2.1 旧的 RPIT 用法](#121-旧的-rpit-用法)
    - [1.2.2 Rust 2024 的新用法](#122-rust-2024-的新用法)
    - [1.2.3 3. 应用](#123-3-应用)
      - [1.2.3.1 简化异步编程](#1231-简化异步编程)
      - [1.2.3.2 简化泛型函数](#1232-简化泛型函数)
      - [1.2.3.3 提高代码可读性](#1233-提高代码可读性)
    - [1.2.4 4. 迁移指南](#124-4-迁移指南)
      - [1.2.4.1 使用 `cargo fix` 自动迁移](#1241-使用-cargo-fix-自动迁移)
      - [1.2.4.2 手动迁移](#1242-手动迁移)
    - [1.2.5 总结](#125-总结)
    - [1.2.6 Rust 2024 对异步编程的具体影响](#126-rust-2024-对异步编程的具体影响)
      - [1.2.6.1 1. **异步闭包（Async Closures）**](#1261-1-异步闭包async-closures)
      - [1.2.6.2 2. **改进的错误处理**](#1262-2-改进的错误处理)
      - [1.2.6.3 3. **`AsyncFn` 特性**](#1263-3-asyncfn-特性)
      - [1.2.6.4 4. **`Future` 和 `IntoFuture` 到标准库 Prelude**](#1264-4-future-和-intofuture-到标准库-prelude)
      - [1.2.6.5 5. **改进的生命周期捕获规则**](#1265-5-改进的生命周期捕获规则)
  - [1.3 *总结*](#13-总结)
<!-- TOC END -->
