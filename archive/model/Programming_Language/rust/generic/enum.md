...
- [rust generic type](#rust-generic-type)
  - [1.1 目录](#11-目录)
  - [1.2 Rust 的 `enum` 支持泛型吗？](#12-rust-的-enum-支持泛型吗)
    - [1.2.1 示例](#121-示例)
    - [1.2.2 `enum` 是否可以像结构体一样实现某个 trait？](#122-enum-是否可以像结构体一样实现某个-trait)
    - [1.2.3 -示例-](#123--示例-)
    - [1.2.4 总结](#124-总结)
    - [1.2.5 `enum` 支持泛型吗？](#125-enum-支持泛型吗)
    - [1.2.6 支持 `impl Trait` 吗？](#126-支持-impl-trait-吗)
    - [1.2.7 \*总结](#127-总结)
    - [1.2.8 Rust 的 Enum 支持泛型吗？](#128-rust-的-enum-支持泛型吗)
    - [1.2.9 例子](#129-例子)
      - [1.2.9.1 泛型枚举](#1291-泛型枚举)
      - [1.2.9.2 自定义的泛型枚举](#1292-自定义的泛型枚举)
    - [1.2.10 使用](#1210-使用)
    - [1.2.11 \*\*总结](#1211-总结)
