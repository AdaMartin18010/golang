...
- [rust分布式日志实现](#rust分布式日志实现)
  - [1.1 目录](#11-目录)
  - [1.2 1. 项目依赖配置](#12-1-项目依赖配置)
    - [1.2.1 2. 基础设施代码](#121-2-基础设施代码)
    - [1.2.2 3. 创建自定义的跟踪宏](#122-3-创建自定义的跟踪宏)
    - [1.2.3 4. 实现业务逻辑](#123-4-实现业务逻辑)
    - [1.2.4 5. 实现 HTTP 服务器](#124-5-实现-http-服务器)
    - [1.2.5 6. 主程序入口](#125-6-主程序入口)
    - [1.2.6 7. 使用示例](#126-7-使用示例)
    - [1.2.7 8. 配置文件示例](#127-8-配置文件示例)
    - [1.2.8 9. 设计规范](#128-9-设计规范)
    - [1.2.9 10. 监控面板配置](#129-10-监控面板配置)
    - [1.2.10 \*1. 项目依赖配置](#1210-1-项目依赖配置)
    - [1.2.11 2. 自定义跟踪器实现](#1211-2-自定义跟踪器实现)
    - [1.2.12 3. 自定义日志格式化器](#1212-3-自定义日志格式化器)
    - [1.2.13 4. 异步任务跟踪器](#1213-4-异步任务跟踪器)
    - [1.2.14 5. 示例应用程序](#1214-5-示例应用程序)
    - [1.2.15 6. 使用示例](#1215-6-使用示例)
    - [1.2.16 7. 运行时环境变量配置](#1216-7-运行时环境变量配置)
    - [1.2.17 8. 输出示例](#1217-8-输出示例)
    - [1.2.18 9. 调试功能](#1218-9-调试功能)
      - [1.2.18.1 1. **条件跟踪**](#12181-1-条件跟踪)
      - [1.2.18.2 2. **性能分析**](#12182-2-性能分析)
      - [1.2.18.3 3. **错误跟踪**](#12183-3-错误跟踪)
    - [1.2.19 10. 最佳实践](#1219-10-最佳实践)
      - [1.2.19.1 1. **使用有意义的 span 名称**](#12191-1-使用有意义的-span-名称)
      - [1.2.19.2 2. **结构化日志记录**](#12192-2-结构化日志记录)
      - [1.2.19.3 3. **错误处理与日志记录**](#12193-3-错误处理与日志记录)
      - [1.2.19.4 4. **异步上下文传播**](#12194-4-异步上下文传播)
