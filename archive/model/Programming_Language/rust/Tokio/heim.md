...
- [Rust 2024 + Tokio + Heim + OpenTelemetry 实现的分布式监控系统](#rust-2024--tokio--heim--opentelemetry-实现的分布式监控系统)
  ...
  - [1.3 2. 系统指标收集器实现](#13-2-系统指标收集器实现)
  - [1.4 3. 分布式追踪实现](#14-3-分布式追踪实现)
  - [1.5 4. 指标控制器实现](#15-4-指标控制器实现)
  - [1.6 5. gRPC 服务实现](#16-5-grpc-服务实现)
  - [1.7 6. 指标聚合器实现](#17-6-指标聚合器实现)
  - [1.8 7. 告警系统实现](#18-7-告警系统实现)
  - [1.9 8. 存储系统实现](#19-8-存储系统实现)
  - [1.10 9. 主程序实现](#110-9-主程序实现)
  - [1.11 10. 配置文件示例](#111-10-配置文件示例)
