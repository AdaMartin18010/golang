...
- [Rust异步日志](#rust异步日志)
  - [1.1 目录](#11-目录)
  - [1.2 1. 初始化 OpenTelemetry](#12-1-初始化-opentelemetry)
    - [1.2.1 2. 创建 Tracer](#121-2-创建-tracer)
    - [1.2.2 3. 创建 Span](#122-3-创建-span)
    - [1.2.3 4. 记录日志](#123-4-记录日志)
    - [1.2.4 5. 导出跟踪数据](#124-5-导出跟踪数据)
    - [1.2.5 6. 上下文传播](#125-6-上下文传播)
    - [1.2.6 7. 错误处理](#126-7-错误处理)
    - [1.2.7 总结](#127-总结)
    - [1.2.8 1. 项目依赖配置](#128-1-项目依赖配置)
    - [1.2.9 2. 日志管理器实现](#129-2-日志管理器实现)
    - [1.2.10 3. 跟踪器实现](#1210-3-跟踪器实现)
    - [1.2.11 4. 执行跟踪器实现](#1211-4-执行跟踪器实现)
    - [1.2.12 5. 异步任务跟踪器](#1212-5-异步任务跟踪器)
    - [1.2.13 6. 使用示例](#1213-6-使用示例)
    - [1.2.14 7. 错误处理和调试工具](#1214-7-错误处理和调试工具)
    - [1.2.15 8. 日志分析工具](#1215-8-日志分析工具)
    - [1.2.16 9. 配置示例](#1216-9-配置示例)
    - [1.2.17 10. 使用示例](#1217-10-使用示例)
