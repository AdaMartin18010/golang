...
- [Rust实现异步的metric](#rust实现异步的metric)
  ...
  - [1.2 1. 项目依赖配置](#12-1-项目依赖配置)
    - [1.2.1 2. 度量收集器实现](#121-2-度量收集器实现)
    - [1.2.2 3. 异步跟踪器实现](#122-3-异步跟踪器实现)
    - [1.2.3 4. 请求上下文实现](#123-4-请求上下文实现)
    - [1.2.4 5. 业务服务实现](#124-5-业务服务实现)
    - [1.2.5 6. HTTP 服务器实现](#125-6-http-服务器实现)
    - [1.2.6 7. 主程序入口](#126-7-主程序入口)
    - [1.2.7 8. 使用示例](#127-8-使用示例)
    - [1.2.8 9. Prometheus 查询示例](#128-9-prometheus-查询示例)
    - [.1  10. Grafana 仪表板配置](#1--10-grafana-仪表板配置)
