...
- [rust实现api](#rust实现api)
  ...
  - [1.2 1. 项目依赖配置](#12-1-项目依赖配置)
    - [1.2.1 2. OpenAPI 解析和代码生成器](#121-2-openapi-解析和代码生成器)
    - [1.2.2 3. 数据库集成生成器](#122-3-数据库集成生成器)
    - [1.2.3 4. 消息中间件集成生成器](#123-4-消息中间件集成生成器)
    - [1.2.4 5. API 路由生成器](#124-5-api-路由生成器)
    - [1.2.5 6. 验证生成器](#125-6-验证生成器)
    - [1.2.6 7. 集成测试生成器](#126-7-集成测试生成器)
    - [1.2.7 8. 主程序实现](#127-8-主程序实现)
