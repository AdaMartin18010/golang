...
- [rust Tcp IM](#rust-tcp-im)
  ...
  - [1.3 2. 消息协议定义](#13-2-消息协议定义)
  - [1.4 3. TCP 服务端实现](#14-3-tcp-服务端实现)
  - [1.5 4. TCP 客户端实现](#15-4-tcp-客户端实现)
  - [1.6 5. UDP 消息广播实现](#16-5-udp-消息广播实现)
  - [1.7 6. 消息存储实现](#17-6-消息存储实现)
  - [1.8 7. 错误处理实现](#18-7-错误处理实现)
  - [1.9 8. 指标收集实现](#19-8-指标收集实现)
  - [1.10 9. 主程序实现](#110-9-主程序实现)
  - [1.11 10. 测试实现](#111-10-测试实现)
