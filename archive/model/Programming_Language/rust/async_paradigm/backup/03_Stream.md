...
<!-- TOC START -->
- [Rust Stream](#rust-stream)
  - [1.1 `Stream` Trait 定义](#11-stream-trait-定义)
    - [1.1.1 使用 `Stream`](#111-使用-stream)
      - [1.1.1.1 示例：实现一个简单的 `Stream`](#1111-示例实现一个简单的-stream)
    - [1.1.2 解释](#112-解释)
    - [1.1.3 异步运行时](#113-异步运行时)
  - [1.2 1. Stream 的主要用途](#12-1-stream-的主要用途)
  - [1.3 2. 典型的代码示例](#13-2-典型的代码示例)
    - [1.3.1 示例：通过 `futures::stream::iter` 模拟数据流](#131-示例通过-futuresstreamiter-模拟数据流)
    - [1.3.2 示例：使用 `async_stream` 宏构建 Stream](#132-示例使用-async_stream-宏构建-stream)
  - [1.4 3. 分析](#14-3-分析)
  - [1.5 4. 常见的“反例”及误区](#15-4-常见的反例及误区)
    - [1.5.1 反例 1：在异步 Stream 内运行密集计算导致阻塞](#151-反例-1在异步-stream-内运行密集计算导致阻塞)
    - [1.5.2 反例 2：错误使用同步 Iterator 替代 Stream](#152-反例-2错误使用同步-iterator-替代-stream)
  - [1.6 5. 思维导图总结](#16-5-思维导图总结)
  - [1.7 6. 总结](#17-6-总结)
<!-- TOC END -->
