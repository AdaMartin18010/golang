...
- [Markdown 格式检查和修复工具使用指南](#markdown-格式检查和修复工具使用指南)
  - [📋 目录](#-目录)
  - [🛠️ 工具概览](#️-工具概览)
    - [1. 基础检查工具（无需外部依赖）](#1-基础检查工具无需外部依赖)
    - [2. 完整检查工具（需要 markdownlint-cli）](#2-完整检查工具需要-markdownlint-cli)
    - [3. 目录链接修复工具](#3-目录链接修复工具)
    - [4. 重复版本信息修复工具](#4-重复版本信息修复工具)
    - [5. 全面修复工具（一键修复）](#5-全面修复工具一键修复)
  - [⚙️ 配置文件](#️-配置文件)
  ...
  - [📚 规则说明](#-规则说明)
    ...
    - [禁用的规则](#禁用的规则)
  - [❓ 常见问题](#-常见问题)
    - [1. markdownlint-cli 未安装怎么办？](#1-markdownlint-cli-未安装怎么办)
    - [2. 如何临时禁用某个规则？](#2-如何临时禁用某个规则)
    - [3. 如何检查单个文件？](#3-如何检查单个文件)
    - [4. 自动修复会改变什么？](#4-自动修复会改变什么)
    - [5. 如何处理误报？](#5-如何处理误报)
  - [🎯 最佳实践](#-最佳实践)
  - [📞 支持](#-支持)
