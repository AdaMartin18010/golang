# 1 1 1 1 1 1 1 内部可变性和外部可变性

<!-- TOC START -->
- [1 1 1 1 1 1 1 内部可变性和外部可变性](#1-1-1-1-1-1-1-内部可变性和外部可变性)
  - [1.1 目录](#目录)
  - [1.2 1. 内部可变性（Interior Mutability）](#1-内部可变性（interior-mutability）)
    - [1.2.1 示例](#示例)
  - [1.3 2. 外部可变性（External Mutability）](#2-外部可变性（external-mutability）)
    - [1.3.1 示例](#示例)
  - [1.4 3. 区别与联系](#3-区别与联系)
    - [1.4.1 区别](#区别)
    - [1.4.2 联系](#联系)
  - [1.5 4. 总结](#4-总结)
  - [1.6 对比 1. 内部可变性（Interior Mutability）](#对比-1-内部可变性（interior-mutability）)
    - [1.6.1 Rust 中的内部可变性](#rust-中的内部可变性)
    - [1.6.2 C++ 中的内部可变性](#c++-中的内部可变性)
  - [1.7 对比 2. 外部可变性（External Mutability）](#对比-2-外部可变性（external-mutability）)
    - [1.7.1 Rust 中的外部可变性](#rust-中的外部可变性)
    - [1.7.2 C++ 中的外部可变性](#c++-中的外部可变性)
    - [1.7.3 3. 总结对比](#3-总结对比)
    - [1.7.4 4. 结论](#4-结论)
    - [1.7.5 1. `mutable` 关键字](#1-mutable-关键字)
    - [1.7.6 2. 常量成员函数](#2-常量成员函数)
    - [1.7.7 示例代码](#示例代码)
    - [1.7.8 代码解释](#代码解释)
    - [1.7.9 对比示例](#对比示例)
    - [1.7.10 总结](#总结)
    - [1.7.11 1. 类型系统](#1-类型系统)
      - [1.7.11.1 Rust 的类型系统](#rust-的类型系统)
      - [1.7.11.2 C++ 的类型系统](#c++-的类型系统)
    - [1.7.12 2. 内存管理](#2-内存管理)
      - [1.7.12.1 Rust 的内存管理](#rust-的内存管理)
      - [1.7.12.2 C++ 的内存管理](#c++-的内存管理)
    - [1.7.13 3. 简约性](#3-简约性)
      - [1.7.13.1 Rust 的简约性](#rust-的简约性)
      - [1.7.13.2 C++ 的简约性](#c++-的简约性)
    - [1.7.14 4. 等效性](#4-等效性)
      - [1.7.14.1 Rust 的等效性](#rust-的等效性)
      - [1.7.14.2 C++ 的等效性](#c++-的等效性)
    - [1.7.15 5. 严谨性](#5-严谨性)
      - [1.7.15.1 Rust 的严谨性](#rust-的严谨性)
      - [1.7.15.2 C++ 的严谨性](#c++-的严谨性)
    - [1.7.16 对比 总结](#对比-总结)
    - [1.7.17 1. 约束变量本身的语义模型](#1-约束变量本身的语义模型)
      - [1.7.17.1 所有权（Ownership）](#所有权（ownership）)
      - [1.7.17.2 借用（Borrowing）](#借用（borrowing）)
      - [1.7.17.3 生命周期（Lifetimes）](#生命周期（lifetimes）)
    - [1.7.18 2. 约束变量值的语义](#2-约束变量值的语义)
      - [1.7.18.1 类型系统（Type System）](#类型系统（type-system）)
      - [1.7.18.2 泛型（Generics）](#泛型（generics）)
      - [1.7.18.3 Trait（特征）](#trait（特征）)
    - [1.7.19 对比 *总结*](#对比-*总结*)
    - [1.7.20 1. 所有权（Ownership）](#1-所有权（ownership）)
    - [1.7.21 2. 借用（Borrowing）](#2-借用（borrowing）)
    - [1.7.22 3. 生命周期（Lifetimes）](#3-生命周期（lifetimes）)
    - [1.7.23 4. 变量所有权、借用和生命周期的关系](#4-变量所有权、借用和生命周期的关系)
    - [1.7.24 5. 示例代码](#5-示例代码)
    - [1.7.25 *总结*](#*总结*)
<!-- TOC END -->
...
## 1.2 1. 内部可变性（Interior Mutability）
