# 1 1 1 1 1 1 1 Rust和C++在复制、克隆和移动语义方面有着不同的实现和概念

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust和C++在复制、克隆和移动语义方面有着不同的实现和概念](#1-1-1-1-1-1-1-rust和c++在复制、克隆和移动语义方面有着不同的实现和概念)
  - [1.1 C++ 中的复制语义和移动语义](#c++-中的复制语义和移动语义)
  - [1.2 Rust 中的所有权和移动语义](#rust-中的所有权和移动语义)
  - [1.3 C++中的Copy、Clone、Moving语义](#c++中的copy、clone、moving语义)
  - [1.4 Rust中的Copy、Clone、Moving语义](#rust中的copy、clone、moving语义)
  - [1.5 对比](#对比)
    - [1.5.1 C++中的Move语义](#c++中的move语义)
      - [1.5.1.1 定义](#定义)
    - [1.5.2 联系和解释](#联系和解释)
    - [1.5.3 Rust中的Move语义](#rust中的move语义)
    - [1.5.4 Rust中的Copy语义](#rust中的copy语义)
  - [1.6 类型系统中的变体性：C++ 与 Rust 对比](#类型系统中的变体性：c++-与-rust-对比)
    - [1.6.1 一、基本概念定义](#一、基本概念定义)
      - [1.6.1.1 可变性 (Mutability)](#可变性-mutability)
      - [1.6.1.2 协变 (Covariance)](#协变-covariance)
      - [1.6.1.3 逆变 (Contravariance)](#逆变-contravariance)
      - [1.6.1.4 不变性 (Invariance)](#不变性-invariance)
  - [1.7 二、C++ 中的变体性](#二、c++-中的变体性)
    - [1.7.1 1. 可变性](#1-可变性)
    - [1.7.2 2. 协变](#2-协变)
    - [1.7.3 3. 逆变](#3-逆变)
    - [1.7.4 4. 不变性](#4-不变性)
  - [1.8 三、Rust 中的变体性](#三、rust-中的变体性)
    - [1.8.1 1. rust可变性](#1-rust可变性)
    - [1.8.2 2. rust协变](#2-rust协变)
    - [1.8.3 3. rust逆变](#3-rust逆变)
    - [1.8.4 4. rust不变性](#4-rust不变性)
  - [1.9 四、C++ 与 Rust 对比](#四、c++-与-rust-对比)
    - [1.9.1 1. 可变性对比](#1-可变性对比)
    - [1.9.2 2. 协变对比](#2-协变对比)
    - [1.9.3 3. 逆变对比](#3-逆变对比)
    - [1.9.4 4. 不变性对比](#4-不变性对比)
  - [1.10 五、应用场景对比](#五、应用场景对比)
    - [1.10.1 C++ 应用场景](#c++-应用场景)
    - [1.10.2 Rust 应用场景](#rust-应用场景)
  - [1.11 六、总结](#六、总结)
    - [1.11.1 C++ 变体性特点](#c++-变体性特点)
    - [1.11.2 Rust 变体性特点](#rust-变体性特点)
    - [1.11.3 核心差异](#核心差异)
  - [1.12 1. Rust 支持的编程范式](#1-rust-支持的编程范式)
    - [1.12.1 面向过程编程](#面向过程编程)
    - [1.12.2 函数式编程](#函数式编程)
    - [1.12.3 面向对象编程（OOP）](#面向对象编程（oop）)
    - [1.12.4 泛型编程](#泛型编程)
    - [1.12.5 并发编程](#并发编程)
  - [1.13 2. Rust 的思维模式](#2-rust-的思维模式)
    - [1.13.1 安全第一](#安全第一)
    - [1.13.2 零成本抽象](#零成本抽象)
    - [1.13.3 函数式思维](#函数式思维)
    - [1.13.4 组合优先与模块化](#组合优先与模块化)
    - [1.13.5 并发安全](#并发安全)
  - [1.14 3. 思维导图](#3-思维导图)
  - [1.15 4. 总结](#4-总结)
<!-- TOC END -->
