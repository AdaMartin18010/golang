...
- [1 1 1 1 1 1 1 n8n工作流编排架构模型详解](#1-1-1-1-1-1-1-n8n工作流编排架构模型详解)
  - [1.1 目录](#11-目录)
  - [1.2 1. n8n架构概述](#12-1-n8n架构概述)
  - [1.3 2. 核心概念定义](#13-2-核心概念定义)
    - [1.3.1 工作流(Workflow)](#131-工作流workflow)
    - [1.3.2 节点(Node)](#132-节点node)
    - [1.3.3 连接(Connection)](#133-连接connection)
    - [1.3.4 执行(Execution)](#134-执行execution)
  - [1.4 3. 工作流编排模型](#14-3-工作流编排模型)
    - [1.4.1 数据流转模型](#141-数据流转模型)
    - [1.4.2 状态管理](#142-状态管理)
    - [1.4.3 错误处理机制](#143-错误处理机制)
  - [1.5 4. 组合与嵌套关系](#15-4-组合与嵌套关系)
    - [1.5.1 顺序执行](#151-顺序执行)
    - [1.5.2 并行执行](#152-并行执行)
    - [1.5.3 条件分支](#153-条件分支)
    - [1.5.4 循环结构](#154-循环结构)
    - [1.5.5 子工作流](#155-子工作流)
  - [1.6 5. 代码实现示例](#16-5-代码实现示例)
    - [1.6.1 工作流定义](#161-工作流定义)
    - [1.6.2 自定义节点开发](#162-自定义节点开发)
    - [1.6.3 工作流执行](#163-工作流执行)
  - [1.7 6. 工作流形式转换](#17-6-工作流形式转换)
    - [1.7.1 可视化到代码的映射](#171-可视化到代码的映射)
    - [1.7.2 跨平台工作流迁移](#172-跨平台工作流迁移)
  - [1.8 7. 高级特性与模式](#18-7-高级特性与模式)
    - [1.8.1 事件驱动模式](#181-事件驱动模式)
    - [1.8.2 异步执行模式](#182-异步执行模式)
    - [1.8.3 数据转换与聚合模式](#183-数据转换与聚合模式)
  - [1.9 8. 演化与发展趋势](#19-8-演化与发展趋势)
<!-- TOC END -->
