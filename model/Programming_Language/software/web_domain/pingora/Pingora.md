# 1 1 1 1 1 1 1 Pingora Rust 的设计和核心概念

<!-- TOC START -->
- [1 1 1 1 1 1 1 Pingora Rust 的设计和核心概念](#1-1-1-1-1-1-1-pingora-rust-的设计和核心概念)
  - [1.1 1. 设计理念与核心概念](#1-设计理念与核心概念)
  - [1.2 2. 使用到的主要开源库](#2-使用到的主要开源库)
  - [1.3 3. 系统组成](#3-系统组成)
    - [1.3.1 网络与 I/O 层](#网络与-io-层)
    - [1.3.2 业务逻辑层](#业务逻辑层)
    - [1.3.3 数据处理与通信层](#数据处理与通信层)
    - [1.3.4 可观测性与监控层](#可观测性与监控层)
  - [1.4 4. 总结](#4-总结)
  - [1.5 Pingora 模块划分与源代码分析](#pingora-模块划分与源代码分析)
  - [1.6 1. 整体架构概述](#1-整体架构概述)
  - [1.7 2. 模块划分详情](#2-模块划分详情)
    - [1.7.1 核心入口模块](#核心入口模块)
    - [1.7.2 网络与 I/O 层](#网络与-io-层)
    - [1.7.3 协议解析层](#协议解析层)
    - [1.7.4 业务处理层](#业务处理层)
    - [1.7.5 数据存储层](#数据存储层)
    - [1.7.6 可观测性与监控层](#可观测性与监控层)
    - [1.7.7 配置及工具模块](#配置及工具模块)
  - [1.8 3. 总结](#3-总结)
<!-- TOC END -->
