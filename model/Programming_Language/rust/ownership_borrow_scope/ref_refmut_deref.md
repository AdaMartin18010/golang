...
- [引用与解引用](#引用与解引用)
  ...
  - [1.6 小结](#16-小结)
  - [1.7 RUST多级引用](#17-rust多级引用)
  - [1.8 Rust 的多级引用有哪些常见错误](#18-rust-的多级引用有哪些常见错误)
    - [1.8.1 **1. 解引用层数不匹配**](#181-1-解引用层数不匹配)
    - [1.8.2 **2. 生命周期不匹配**](#182-2-生命周期不匹配)
    - [1.8.3 **3. 可变引用与不可变引用冲突**](#183-3-可变引用与不可变引用冲突)
    - [1.8.4 **4. 多级引用的错误使用**](#184-4-多级引用的错误使用)
    - [1.8.5 **5. 生命周期结束前的错误引用**](#185-5-生命周期结束前的错误引用)
    - [1.8.6 **总结**](#186-总结)
<!-- TOC END -->
