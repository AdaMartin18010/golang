...
- [Rust 所有权系统的资源管理视角（续）](#rust-所有权系统的资源管理视角续)
  - [1.1 前言](#11-前言)
  - [1.2 目录](#12-目录)
  - [1.3 1. 所有权在并发编程中的应用](#13-1-所有权在并发编程中的应用)
    - [1.3.1 线程安全保障](#131-线程安全保障)
    - [1.3.2 Send 与 Sync 特性](#132-send-与-sync-特性)
    - [1.3.3 并发模式与所有权](#133-并发模式与所有权)
    - [1.3.4 并发形式化模型](#134-并发形式化模型)
  - [1.4 2. 高级所有权模式](#14-2-高级所有权模式)
    - [1.4.1 内部可变性深入分析](#141-内部可变性深入分析)
    - [1.4.2 自引用结构](#142-自引用结构)
    - [1.4.3 零成本抽象与所有权](#143-零成本抽象与所有权)
    - [1.4.4 借用分离模式](#144-借用分离模式)
  - [1.5 3. 所有权系统的边界](#15-3-所有权系统的边界)
    - [1.5.1 unsafe 代码与所有权系统](#151-unsafe-代码与所有权系统)
    - [1.5.2 所有权回避模式](#152-所有权回避模式)
    - [1.5.3 所有权系统的限制](#153-所有权系统的限制)
  - [1.6 4. 与其他语言的比较](#16-4-与其他语言的比较)
    - [1.6.1 对比垃圾回收](#161-对比垃圾回收)
    - [1.6.2 对比手动内存管理](#162-对比手动内存管理)
    - [1.6.3 对比其他资源管理方式](#163-对比其他资源管理方式)
  - [1.7 5. 实际应用案例分析](#17-5-实际应用案例分析)
    - [1.7.1 系统编程中的应用](#171-系统编程中的应用)
    - [1.7.2 Web 开发中的应用](#172-web-开发中的应用)
    - [1.7.3 性能敏感场景中的应用](#173-性能敏感场景中的应用)
