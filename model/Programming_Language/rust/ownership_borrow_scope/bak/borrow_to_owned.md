...
- [ToOwned](#toowned)
  ...
  - [1.3 使用示例](#13-使用示例)
  - [1.4 总结](#14-总结)
  - [1.5 1. **ToOwned** Trait 的定义](#15-1-toowned-trait-的定义)
  - [1.6 2. 为什么不区分可变和不可变借用？](#16-2-为什么不区分可变和不可变借用)
  - [1.7 3. 代码示例](#17-3-代码示例)
    - [1.7.1 示例 1：直接从不可变借用生成拥有数据](#171-示例-1直接从不可变借用生成拥有数据)
    - [1.7.2 示例 2：从可变引用调用 `to_owned()`](#172-示例-2从可变引用调用-to_owned)
  - [1.8 4. 总结](#18-4-总结)
<!-- TOC END -->
