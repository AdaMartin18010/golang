...
<!-- TOC START -->
- [RefCell](#refcell)
  - [1.1 什么是内部可变性？](#11-什么是内部可变性)
  - [1.2 `RefCell` 的作用](#12-refcell-的作用)
  - [1.3 使用 `RefCell` 的关键点](#13-使用-refcell-的关键点)
  - [1.4 示例代码](#14-示例代码)
  - [1.5 `Borrow`](#15-borrow)
  - [1.6 `BorrowMut`](#16-borrowmut)
  - [1.7 其他相关 trait](#17-其他相关-trait)
  - [1.8 运行时借用检查](#18-运行时借用检查)
<!-- TOC END -->
