# 1 1 1 1 1 1 1 reference.md

<!-- TOC START -->
- [1 1 1 1 1 1 1 reference.md](#1-1-1-1-1-1-1-referencemd)
  - [1.1 **1. 解引用层数不匹配**](#**1-解引用层数不匹配**)
  - [1.2 **2. 生命周期不匹配**](#**2-生命周期不匹配**)
  - [1.3 **3. 可变引用与不可变引用冲突**](#**3-可变引用与不可变引用冲突**)
  - [1.4 **4. 多级引用的错误使用**](#**4-多级引用的错误使用**)
  - [1.5 **5. 生命周期结束前的错误引用**](#**5-生命周期结束前的错误引用**)
  - [1.6 **总结**](#**总结**)
<!-- TOC END -->
