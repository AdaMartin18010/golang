# 1 1 1 1 1 1 1 Rust 异步编程中的错误处理

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust 异步编程中的错误处理](#1-1-1-1-1-1-1-rust-异步编程中的错误处理)
  - [1.1 代码说明](#代码说明)
  - [1.2 思维导图](#思维导图)
  - [1.3 总结](#总结)
  - [1.4 1. 显式处理机制](#1-显式处理机制)
    - [1.4.1 显式同步原语](#显式同步原语)
    - [1.4.2 合理的锁粒度和设计](#合理的锁粒度和设计)
  - [1.5 2. 隐式处理机制](#2-隐式处理机制)
    - [1.5.1 编译器的类型检查与借用检查](#编译器的类型检查与借用检查)
    - [1.5.2 异步任务本质上的协作式调度](#异步任务本质上的协作式调度)
  - [1.6 3. 示例说明](#3-示例说明)
  - [1.7 4. 思维导图](#4-思维导图)
  - [1.8 5. 总结](#5-总结)
<!-- TOC END -->
