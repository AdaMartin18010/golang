# 1 1 1 1 1 1 1 Rust异步 TCP/UDP 协议定制处理

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust异步 TCP/UDP 协议定制处理](#1-1-1-1-1-1-1-rust异步-tcpudp-协议定制处理)
  - [1.1 1. 实现思路概述](#1-实现思路概述)
  - [1.2 2. TCP 定制协议处理](#2-tcp-定制协议处理)
    - [1.2.1 框架思路](#框架思路)
    - [1.2.2 示例代码](#示例代码)
  - [1.3 3. UDP 定制协议处理](#3-udp-定制协议处理)
    - [1.3.1 框架思路](#框架思路)
    - [1.3.2 示例代码](#示例代码)
  - [1.4 4. 进阶：基于 Codec 的定制协议](#4-进阶：基于-codec-的定制协议)
  - [1.5 5. 小结](#5-小结)
<!-- TOC END -->
