# 1 1 1 1 1 1 1 Rust异步编程的实现原理

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust异步编程的实现原理](#1-1-1-1-1-1-1-rust异步编程的实现原理)
  - [1.1 1. 同步过程到状态机的转换](#1-同步过程到状态机的转换)
    - [1.1.1 **状态机转换**](#**状态机转换**)
    - [1.1.2 **保存执行上下文**](#**保存执行上下文**)
  - [1.2 2. 重组调用关系成树形递归](#2-重组调用关系成树形递归)
    - [1.2.1 **树形依赖结构**](#**树形依赖结构**)
    - [1.2.2 **状态机调度顺序**](#**状态机调度顺序**)
  - [1.3 3. 总结说明](#3-总结说明)
    - [1.3.1 **拆分与重组**](#**拆分与重组**)
    - [1.3.2 **树形递归结构**](#**树形递归结构**)
  - [1.4 4. 生命周期与资源释放](#4-生命周期与资源释放)
    - [1.4.1 1. 异步函数与状态机转换](#1-异步函数与状态机转换)
    - [1.4.2 2. 生命周期的管理和借用检查](#2-生命周期的管理和借用检查)
  - [1.5 3. 资源释放的细节](#3-资源释放的细节)
  - [1.6 4. 示例代码解析](#4-示例代码解析)
  - [1.7 5. 总结](#5-总结)
<!-- TOC END -->
