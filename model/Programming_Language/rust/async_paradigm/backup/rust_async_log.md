...
<!-- TOC START -->
- [1 1 1 1 1 1 1 rust_async_log](#1-1-1-1-1-1-1-rust_async_log)
  - [1.1 1. 开源日志堆栈](#1-开源日志堆栈)
    - [1.1.1 基于传统日志接口](#基于传统日志接口)
    - [1.1.2 基于结构化日志与追踪](#基于结构化日志与追踪)
  - [1.2 2. 按照日期打 Tag、输出压缩文件、本地滚动存储](#2-按照日期打-tag、输出压缩文件、本地滚动存储)
    - [1.2.1 使用 tracing-appender](#使用-tracing-appender)
    - [1.2.2 基于 flexi_logger](#基于-flexi_logger)
  - [1.3 3. 日志与函数调用语义顺序关联机制](#3-日志与函数调用语义顺序关联机制)
    - [1.3.1 使用 Span](#使用-span)
    - [1.3.2 #[instrument] 属性宏](##instrument-属性宏)
    - [1.3.3 Subscriber 格式化输出](#subscriber-格式化输出)
