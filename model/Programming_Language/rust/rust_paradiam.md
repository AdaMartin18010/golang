...
<!-- TOC START -->
- [1 1 1 1 1 1 1 编程范式](#1-1-1-1-1-1-1-编程范式)
  - [1.1 **命令式编程（Imperative Programming）**](#**命令式编程（imperative-programming）**)
  - [1.2 **结构化编程（Structured Programming）**](#**结构化编程（structured-programming）**)
  - [1.3 **声明式编程（Declarative Programming）**](#**声明式编程（declarative-programming）**)
  - [1.4 **面向对象编程（Object-Oriented Programming, OOP）**](#**面向对象编程（object-oriented-programming-oop）**)
  - [1.5 **函数式编程（Functional Programming, FP）**](#**函数式编程（functional-programming-fp）**)
  - [1.6 **逻辑编程（Logic Programming）**](#**逻辑编程（logic-programming）**)
  - [1.7 **并发编程（Concurrent Programming）**](#**并发编程（concurrent-programming）**)
  - [1.8 **事件驱动编程（Event-Driven Programming）**](#**事件驱动编程（event-driven-programming）**)
  - [1.9 **泛型编程（Generic Programming）**](#**泛型编程（generic-programming）**)
  - [1.10 **元编程（Metaprogramming）**](#**元编程（metaprogramming）**)
  - [1.11 **响应式编程（Reactive Programming）**](#**响应式编程（reactive-programming）**)
  - [1.12 **Rust 编程范式**](#**rust-编程范式**)
    - [1.12.1 1. **结构化编程**](#1-**结构化编程**)
    - [1.12.2 2. **面向对象编程**（OOP）](#2-**面向对象编程**（oop）)
    - [1.12.3 3. **泛型编程**](#3-**泛型编程**)
    - [1.12.4 4. **函数式编程**](#4-**函数式编程**)
    - [1.12.5 5. **内存安全**](#5-**内存安全**)
    - [1.12.6 6. **模式匹配**](#6-**模式匹配**)
    - [1.12.7 7. **错误处理**](#7-**错误处理**)
    - [1.12.8 8. **迭代器,生成器和闭包**](#8-**迭代器生成器和闭包**)
    - [1.12.9 9. **智能指针**](#9-**智能指针**)
    - [1.12.10 10. **模块化**](#10-**模块化**)
    - [1.12.11 11. **宏系统**](#11-**宏系统**)
    - [1.12.12 12. **并发编程**](#12-**并发编程**)
      - [1.12.12.1 1. **多线程并发编程**](#1-**多线程并发编程**)
      - [1.12.12.2 2. **异步编程模型**](#2-**异步编程模型**)
      - [1.12.12.3 3. **async/await语法**](#3-**asyncawait语法**)
      - [1.12.12.4 4. **性能与安全性**](#4-**性能与安全性**)
      - [1.12.12.5 5. **并发与并行的区别**](#5-**并发与并行的区别**)
      - [1.12.12.6 6. **消息传递并发**](#6-**消息传递并发**)
      - [1.12.12.7 7. **共享状态并发**](#7-**共享状态并发**)
      - [1.12.12.8 8. **`Sync`和`Send` trait**](#8-**sync和send-trait**)
    - [1.12.13 13. **并行编程**](#13-**并行编程**)
      - [1.12.13.1 1. **多线程**](#1-**多线程**)
      - [1.12.13.2 2. **线程池**](#2-**线程池**)
      - [1.12.13.3 3. **数据并行**](#3-**数据并行**)
      - [1.12.13.4 4. **并行算法库**](#4-**并行算法库**)
      - [1.12.13.5 5. **crossbeam**](#5-**crossbeam**)
      - [1.12.13.6 6. **消息传递**](#6-**消息传递**)
      - [1.12.13.7 7. **异步编程**](#7-**异步编程**)
      - [1.12.13.8 8. **并行计算框架**](#8-**并行计算框架**)
      - [1.12.13.9 9. **SIMD指令**](#9-**simd指令**)
      - [1.12.13.10 10. **并行编译**](#10-**并行编译**)
      - [1.12.13.11 11. **Rust的所有权和借用规则**](#11-**rust的所有权和借用规则**)
      - [1.12.13.12 12. **`Send`和`Sync`特性**](#12-**send和sync特性**)
<!-- TOC END -->
