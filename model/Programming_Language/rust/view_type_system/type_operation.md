...
- [Rust 类型系统](#rust-类型系统)
  - [1.1 目录](#11-目录)
  - [1.2 1. 新类型（Newtype）](#12-1-新类型newtype)
    - [1.2.1 示例](#121-示例)
  - [1.3 2. 类型别名（Type Alias）](#13-2-类型别名type-alias)
    - [1.3.1 示例](#131-示例)
  - [1.4 3. 类型相同（Type Identity）](#14-3-类型相同type-identity)
    - [1.4.1 示例](#141-示例)
  - [1.5 4. 类型等价（Type Equivalence）](#15-4-类型等价type-equivalence)
    - [1.5.1 示例](#151-示例)
  - [1.6 5. 类型操作（Type Operations）](#16-5-类型操作type-operations)
    - [1.6.1 示例](#161-示例)
  - [1.7 总结](#17-总结)
  - [1.8 6. 类型推导（Type Inference）](#18-6-类型推导type-inference)
    - [1.8.1 示例](#181-示例)
  - [1.9 7. 泛型（Generics）](#19-7-泛型generics)
    - [1.9.1 示例](#191-示例)
  - [1.10 8. 类型转换（Type Conversion）](#110-8-类型转换type-conversion)
    - [1.10.1 示例](#1101-示例)
  - [1.11 9. 类型约束（Type Constraints）](#111-9-类型约束type-constraints)
    - [1.11.1 示例](#1111-示例)
  - [1.12 10. 组合类型（Composite Types）](#112-10-组合类型composite-types)
    - [1.12.1 示例](#1121-示例)
  - [1.13 总结](#113-总结)
  - [1.14 11. 生命周期（Lifetimes）](#114-11-生命周期lifetimes)
    - [1.14.1 示例](#1141-示例)
  - [1.15 12. 关联类型（Associated Types）](#115-12-关联类型associated-types)
    - [1.15.1 示例](#1151-示例)
  - [1.16 13. 特征对象（Trait Objects）](#116-13-特征对象trait-objects)
    - [1.16.1 示例](#1161-示例)
  - [1.17 14. 代数数据类型（Algebraic Data Types, ADTs）](#117-14-代数数据类型algebraic-data-types-adts)
    - [1.17.1 示例](#1171-示例)
  - [1.18 15. 组合与解构（Composition and Destructuring）](#118-15-组合与解构composition-and-destructuring)
    - [1.18.1 示例](#1181-示例)
  - [1.19 16. 运行时与编译时类型检查](#119-16-运行时与编译时类型检查)
  - [1.20 17. 反射与类型信息](#120-17-反射与类型信息)
  - [1.21 总结](#121-总结)
  - [1.22 18. 组合模式（Composition Patterns）](#122-18-组合模式composition-patterns)
    - [1.22.1 示例](#1221-示例)
  - [1.23 19. 组合与继承](#123-19-组合与继承)
    - [1.23.1 示例](#1231-示例)
  - [1.24 20. 迭代器（Iterators）](#124-20-迭代器iterators)
    - [1.24.1 示例](#1241-示例)
  - [1.25 21. 错误处理（Error Handling）](#125-21-错误处理error-handling)
  - [1.26 22. 并发（Concurrency）](#126-22-并发concurrency)
    - [1.26.1 示例](#1261-示例)
  - [1.27 23. 宏（Macros）](#127-23-宏macros)
    - [1.27.1 示例](#1271-示例)
  - [1.28 24. 代码组织（Modules and Crates）](#128-24-代码组织modules-and-crates)
    - [1.28.1 示例](#1281-示例)
  - [1.29 25. 性能优化](#129-25-性能优化)
    - [1.29.1 总结](#1291-总结)
