...
- [ ](#1-1-1-1-1-1-1-rust容器类型详解)
  ...
  - [2. ](#12-一序列容器)
    - [2.1 ](#121-1-vect---动态数组)
    - [2.2 ](#122-2-vecdequet---双端队列)
    - [2.3 ](#123-3-linkedlistt---双向链表)
  - [3. ](#13-二关联容器)
    - [3.1 ](#131-1-hashmapk-v---哈希映射)
    - [3.2 ](#132-2-btreemapk-v---有序映射)
    - [3.3 ](#133-3-hashsett---哈希集合)
    - [3.4 ](#134-4-btreesett---有序集合)
  - [4. ](#14-三特殊容器)
    - [4.1 ](#141-1-binaryheapt---二叉堆优先队列)
    - [4.2 ](#142-2-string---字符串)
  - [5. ](#15-四智能指针容器)
    - [5.1 ](#151-1-boxt---堆分配值)
    - [5.2 ](#152-2-rct---引用计数指针)
    - [5.3 ](#153-3-arct---原子引用计数指针)
    - [5.4 ](#154-4-cellt-和-refcellt---内部可变性)
  - [6. ](#16-五并发容器)
    - [6.1 ](#161-1-mutext---互斥锁)
    - [6.2 ](#162-2-rwlockt---读写锁)
    - [6.3 ](#163-3-atomic类型)
  - [7. ](#17-六特殊用途容器)
    - [7.1 ](#171-1-optiont---可选值)
    - [7.2 ](#172-2-resultt-e---成功或错误)
  - [8. ](#18-容器类型使用规范与用途总结)
  - [9. ](#19-选择容器的一般原则)
  - [10. ](#110-各容器类型的最佳用途)
