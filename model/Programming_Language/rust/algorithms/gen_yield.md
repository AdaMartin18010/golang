# 1 1 1 1 1 1 1 Rust中使用生成器(Generator)和yield实现基本算法

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust中使用生成器(Generator)和yield实现基本算法](#1-1-1-1-1-1-1-rust中使用生成器generator和yield实现基本算法)
  - [1.1 目录](#目录)
  - [1.2 同步模式下的生成器实现](#同步模式下的生成器实现)
    - [1.2.1 斐波那契数列生成器](#斐波那契数列生成器)
    - [1.2.2 使用泛型容器的素数筛选](#使用泛型容器的素数筛选)
  - [1.3 异步模式下的生成器实现](#异步模式下的生成器实现)
    - [1.3.1 异步斐波那契数列生成器](#异步斐波那契数列生成器)
    - [1.3.2 使用泛型异步队列的生产者-消费者模式](#使用泛型异步队列的生产者-消费者模式)
    - [1.3.3 使用泛型实现异步迭代器适配器](#使用泛型实现异步迭代器适配器)
  - [1.4 总结](#总结)
<!-- TOC END -->
