...
<!-- TOC START -->
- [ ](#1-1-1-1-1-1-1-rust语言语法语义特性全面解析rust-language-syntax-and-semantics-features)
  - [1. ](#1-基础语法与表达式)
    - [1.1 ](#变量绑定与声明)
  ...
  - [4. ](#4-错误处理与异常安全)
    - [4.1 ](#41-42-错误表示与传播)
    - [4.2 ](#43-44-异常处理与错误设计模式)
  - [5. ](#5-模块系统与包管理)
    - [5.1 ](#代码组织)
    - [5.2 ](#52-53-包、箱与依赖管理)
- [ ](#2-2-2-2-2-2-2-cargotoml-示例)
...
#### 1.2.3.2 2.3.2-2.3.3 特征作为参数与特征对象
