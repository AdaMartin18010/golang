# 1 1 1 1 1 1 1 范畴论（Category Theory）理论基础与形式化推理

<!-- TOC START -->
- [1 1 1 1 1 1 1 范畴论（Category Theory）理论基础与形式化推理](#1-1-1-1-1-1-1-范畴论（category-theory）理论基础与形式化推理)
  - [1.1 目录](#目录)
  - [1.2 1. 范畴论基础定义](#1-范畴论基础定义)
    - [1.2.1 范畴的形式化定义](#范畴的形式化定义)
    - [1.2.2 态射与组合律](#态射与组合律)
    - [1.2.3 同构与等价关系](#同构与等价关系)
    - [1.2.4 特殊对象与态射](#特殊对象与态射)
  - [1.3 2. 函子理论](#2-函子理论)
    - [1.3.1 函子的定义与性质](#函子的定义与性质)
    - [1.3.2 函子范畴](#函子范畴)
    - [1.3.3 特殊函子类型](#特殊函子类型)
    - [1.3.4 表示函子](#表示函子)
  - [1.4 3. 自然变换](#3-自然变换)
    - [1.4.1 自然变换的形式化定义](#自然变换的形式化定义)
    - [1.4.2 自然同构](#自然同构)
    - [1.4.3 交换图与自然性条件](#交换图与自然性条件)
    - [1.4.4 水平与垂直组合](#水平与垂直组合)
  - [1.5 4. 伴随函子](#4-伴随函子)
    - [1.5.1 伴随函子的定义与性质](#伴随函子的定义与性质)
    - [1.5.2 单位与余单位变换](#单位与余单位变换)
    - [1.5.3 伴随对的等价表示](#伴随对的等价表示)
    - [1.5.4 伴随函子基本定理](#伴随函子基本定理)
  - [1.6 5. 极限理论](#5-极限理论)
    - [1.6.1 图与函子](#图与函子)
    - [1.6.2 极限的普遍性质](#极限的普遍性质)
    - [1.6.3 余极限](#余极限)
    - [1.6.4 极限的存在条件](#极限的存在条件)
  - [1.7 6. 单子与余单子](#6-单子与余单子)
    - [1.7.1 单子的代数定义](#单子的代数定义)
    - [1.7.2 克莱斯利范畴](#克莱斯利范畴)
    - [1.7.3 单子代数与余代数](#单子代数与余代数)
    - [1.7.4 单子的组合定理](#单子的组合定理)
  - [1.8 7. 高级定理与推论](#7-高级定理与推论)
    - [1.8.1 Yoneda引理及其证明](#yoneda引理及其证明)
    - [1.8.2 可表函子定理](#可表函子定理)
    - [1.8.3 伴随函数定理](#伴随函数定理)
    - [1.8.4 巴尔加定理](#巴尔加定理)
  - [1.9 8. 笛卡尔闭范畴](#8-笛卡尔闭范畴)
    - [1.9.1 笛卡尔积与终对象](#笛卡尔积与终对象)
    - [1.9.2 指数对象与内部Hom](#指数对象与内部hom)
    - [1.9.3 闭性质与柯里化](#闭性质与柯里化)
    - [1.9.4 笛卡尔闭范畴的性质定理](#笛卡尔闭范畴的性质定理)
<!-- TOC END -->
