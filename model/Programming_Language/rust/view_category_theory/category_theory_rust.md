<!-- TOC START -->
- [1 1 1 1 1 1 1 范畴论与Rust编程：核心概念与应用](#1-1-1-1-1-1-1-范畴论与rust编程：核心概念与应用)
  - [1.1 目录](#目录)
  - [1.2 1. 范畴论基础](#1-范畴论基础)
    - [1.2.1 范畴的定义](#范畴的定义)
    - [1.2.2 对象与态射](#对象与态射)
    - [1.2.3 组合与恒等态射](#组合与恒等态射)
  - [1.3 2. 函子](#2-函子)
    - [1.3.1 函子的定义](#函子的定义)
    - [1.3.2 内函子和协变函子](#内函子和协变函子)
    - [1.3.3 Rust中的函子实现](#rust中的函子实现)
  - [1.4 3. 自然变换](#3-自然变换)
    - [1.4.1 自然变换的定义](#自然变换的定义)
    - [1.4.2 自然变换的性质](#自然变换的性质)
    - [1.4.3 Rust中的自然变换](#rust中的自然变换)
  - [1.5 4. 单子](#4-单子)
    - [1.5.1 单子的定义](#单子的定义)
    - [1.5.2 单子的定律](#单子的定律)
    - [1.5.3 Rust中的Option和Result单子](#rust中的option和result单子)
  - [1.6 5. 积与余积](#5-积与余积)
    - [1.6.1 积的定义](#积的定义)
    - [1.6.2 余积的定义](#余积的定义)
    - [1.6.3 Rust中的产品类型与和类型](#rust中的产品类型与和类型)
  - [1.7 6. 极限与余极限](#6-极限与余极限)
    - [1.7.1 极限的定义](#极限的定义)
    - [1.7.2 余极限的定义](#余极限的定义)
    - [1.7.3 Rust中的应用](#rust中的应用)
  - [1.8 7. 代数数据类型](#7-代数数据类型)
    - [1.8.1 归纳类型](#归纳类型)
    - [1.8.2 余归纳类型](#余归纳类型)
    - [1.8.3 Rust中的递归类型](#rust中的递归类型)
  - [1.9 目录（续）](#目录（续）)
  - [1.10 8. 伴随函子](#8-伴随函子)
    - [1.10.1 伴随函子的定义](#伴随函子的定义)
    - [1.10.2 单位与余单位](#单位与余单位)
    - [1.10.3 Rust中的伴随函子](#rust中的伴随函子)
  - [1.11 9. Yoneda引理](#9-yoneda引理)
    - [1.11.1 Yoneda引理的陈述](#yoneda引理的陈述)
    - [1.11.2 Yoneda引理的含义](#yoneda引理的含义)
    - [1.11.3 Rust中的Yoneda引理应用](#rust中的yoneda引理应用)
  - [1.12 10. 自由单子](#10-自由单子)
    - [1.12.1 自由单子的定义](#自由单子的定义)
    - [1.12.2 解释器模式](#解释器模式)
    - [1.12.3 Rust中的自由单子实现](#rust中的自由单子实现)
  - [1.13 11. Kleisli范畴](#11-kleisli范畴)
    - [1.13.1 Kleisli范畴的定义](#kleisli范畴的定义)
    - [1.13.2 Kleisli范畴与单子编程](#kleisli范畴与单子编程)
    - [1.13.3 Rust中的Kleisli箭头](#rust中的kleisli箭头)
  - [1.14 12. F-代数与递归模式](#12-f-代数与递归模式)
    - [1.14.1 F-代数的定义](#f-代数的定义)
    - [1.14.2 递归模式](#递归模式)
    - [1.14.3 Rust中的F-代数应用](#rust中的f-代数应用)
  - [1.15 13. 多函子与Lens](#13-多函子与lens)
    - [1.15.1 多函子的定义](#多函子的定义)
    - [1.15.2 Lens的结构](#lens的结构)
    - [1.15.3 Rust中的Lens实现](#rust中的lens实现)
  - [1.16 14. 范畴论视角下的Rust类型系统](#14-范畴论视角下的rust类型系统)
    - [1.16.1 类型即对象](#类型即对象)
    - [1.16.2 函数即态射](#函数即态射)
    - [1.16.3 Rust类型系统的范畴论解释](#rust类型系统的范畴论解释)
  - [1.17 15. 高阶函子与应用函子](#15-高阶函子与应用函子)
    - [1.17.1 高阶函子的定义](#高阶函子的定义)
    - [1.17.2 应用函子结构](#应用函子结构)
    - [1.17.3 Rust中的高阶函子实现](#rust中的高阶函子实现)
  - [1.18 16. 范畴论与Rust的所有权系统](#16-范畴论与rust的所有权系统)
    - [1.18.1 线性类型与所有权](#线性类型与所有权)
    - [1.18.2 借用作为自然变换](#借用作为自然变换)
    - [1.18.3 所有权系统的范畴论解释](#所有权系统的范畴论解释)
  - [1.19 17. 类型级编程与实例推导](#17-类型级编程与实例推导)
    - [1.19.1 类型族与关联类型](#类型族与关联类型)
    - [1.19.2 特征解析作为实例推导](#特征解析作为实例推导)
    - [1.19.3 Rust中的依赖类型模拟](#rust中的依赖类型模拟)
  - [1.20 18. 效果系统与计算的范畴](#18-效果系统与计算的范畴)
    - [1.20.1 代数效果与处理器](#代数效果与处理器)
    - [1.20.2 函数式反应式编程](#函数式反应式编程)
    - [1.20.3 Rust中实现效果系统](#rust中实现效果系统)
  - [1.21 19. 高级模式与范畴论应用](#19-高级模式与范畴论应用)
    - [1.21.1 Tagless Final模式](#tagless-final模式)
    - [1.21.2 自由模板与余余单子](#自由模板与余余单子)
    - [1.21.3 Rust中的范畴论库](#rust中的范畴论库)
  - [1.22 20. 计算模型与范畴嵌入](#20-计算模型与范畴嵌入)
    - [1.22.1 lambda演算与笛卡尔闭范畴](#lambda演算与笛卡尔闭范畴)
    - [1.22.2 线性逻辑与线性范畴](#线性逻辑与线性范畴)
    - [1.22.3 Rust的计算模型分析](#rust的计算模型分析)
  - [1.23 21. 范畴论与并发系统](#21-范畴论与并发系统)
    - [1.23.1 Actor模型的范畴论视角](#actor模型的范畴论视角)
    - [1.23.2 并行计算的单子模型](#并行计算的单子模型)
    - [1.23.3 Rust并发原语的范畴论解释](#rust并发原语的范畴论解释)
