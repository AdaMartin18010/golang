...
<!-- TOC START -->
- [rust threads trait send and sync](#rust-threads-trait-send-and-sync)
  - [1.1 1. 基本概念](#11-1-基本概念)
    - [1.1.1 **Send Trait**](#111-send-trait)
    - [1.1.2 **Sync Trait**](#112-sync-trait)
  - [1.2 2. 编译器如何处理 Send 和 Sync](#12-2-编译器如何处理-send-和-sync)
    - [1.2.1 自动实现（Auto Trait）](#121-自动实现auto-trait)
    - [1.2.2 编译器生成的代码](#122-编译器生成的代码)
  - [1.3 3. 总结](#13-3-总结)
  - [1.4 thread-safe](#14-thread-safe)
    - [1.4.1 1. -基本概念](#141-1--基本概念)
      - [1.4.1.1 -**Send Trait**](#1411--send-trait)
      - [1.4.1.2 -**Sync Trait**](#1412--sync-trait)
    - [1.4.2 2. -编译器如何处理 Send 和 Sync](#142-2--编译器如何处理-send-和-sync)
      - [1.4.2.1 -自动实现（Auto Trait）](#1421--自动实现auto-trait)
      - [1.4.2.2 -编译器生成的代码](#1422--编译器生成的代码)
    - [1.4.3 3. -总结](#143-3--总结)
  - [1.5 thread-safe type](#15-thread-safe-type)
    - [1.5.1 1. 不同访问方式下的情况](#151-1-不同访问方式下的情况)
      - [1.5.1.1 不可变共享（\&T）](#1511-不可变共享t)
      - [1.5.1.2 可变共享（\&mut T）](#1512-可变共享mut-t)
      - [1.5.1.3 跨线程修改：使用同步原语和原子类型](#1513-跨线程修改使用同步原语和原子类型)
    - [1.5.2 2. 总结](#152-2-总结)
<!-- TOC END -->
