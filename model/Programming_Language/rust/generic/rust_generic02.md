...
- [Rust泛型全面指南](#rust泛型全面指南)
  ...
  - [1.2 1. Rust泛型基础](#12-1-rust泛型基础)
    - [1.2.1 泛型的定义与基本语法](#121-泛型的定义与基本语法)
    - [1.2.2 类型推导机制](#122-类型推导机制)
    - [1.2.3 泛型约束](#123-泛型约束)
    - [1.2.4 泛型参数默认值](#124-泛型参数默认值)
  - [1.3 2. 泛型与Trait系统](#13-2-泛型与trait系统)
    - [1.3.1 Trait基础与泛型实现](#131-trait基础与泛型实现)
    - [1.3.2 关联类型](#132-关联类型)
    - [1.3.3 泛型Trait与Trait约束](#133-泛型trait与trait约束)
  - [1.4 3. 生命周期与泛型](#14-3-生命周期与泛型)
    - [1.4.1 生命周期基础](#141-生命周期基础)
    - [1.4.2 生命周期参数约束](#142-生命周期参数约束)
    - [1.4.3 高级生命周期技巧](#143-高级生命周期技巧)
  - [1.5 4. 编译期计算与常量泛型](#15-4-编译期计算与常量泛型)
    - [1.5.1 const泛型基础](#151-const泛型基础)
    - [1.5.2 const fn与编译期求值](#152-const-fn与编译期求值)
  - [1.6 5. 泛型编程模式与技巧](#16-5-泛型编程模式与技巧)
    - [1.6.1 零成本抽象](#161-零成本抽象)
    - [1.6.2 静态分派vs动态分派](#162-静态分派vs动态分派)
    - [1.6.3 泛型设计模式](#163-泛型设计模式)
  - [1.7 6. 泛型在多线程编程中的应用](#17-6-泛型在多线程编程中的应用)
    - [1.7.1 线程安全抽象](#171-线程安全抽象)
    - [1.7.2 Send与Sync特性](#172-send与sync特性)
  - [1.8 7. 泛型在异步编程中的应用](#18-7-泛型在异步编程中的应用)
    - [1.8.1 Future特性与异步泛型](#181-future特性与异步泛型)
    - [1.8.2 泛型在异步执行器中的应用](#182-泛型在异步执行器中的应用)
  - [1.9 8. 泛型与算法设计](#19-8-泛型与算法设计)
    - [1.9.1 泛型算法接口](#191-泛型算法接口)
    - [1.9.2 迭代器与泛型](#192-迭代器与泛型)
    - [1.9.3 递归与泛型](#193-递归与泛型)
