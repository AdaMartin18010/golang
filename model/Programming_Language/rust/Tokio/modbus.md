...
- [rust实现mqtt](#rust实现mqtt)
  ...
  - [1.2 1. 项目依赖配置](#12-1-项目依赖配置)
    - [1.2.1 2. 设备配置和状态定义](#121-2-设备配置和状态定义)
    - [1.2.2 3. Modbus 设备管理器实现](#122-3-modbus-设备管理器实现)
    - [1.2.3 4. MQTT 消息处理器实现](#123-4-mqtt-消息处理器实现)
    - [1.2.4 5. 数据存储实现](#124-5-数据存储实现)
    - [1.2.5 6. 设备管理器实现](#125-6-设备管理器实现)
    - [1.2.6 7. 主程序实现](#126-7-主程序实现)
    - [1.2.7 8. HTTP API 实现](#127-8-http-api-实现)
    - [1.2.8 9. 配置文件示例](#128-9-配置文件示例)
    - [.1  10. 测试实现](#1--10-测试实现)
