...
- [Rust实现分布式IM](#rust实现分布式im)
  ...
  - [1.2 1. 项目依赖配置](#12-1-项目依赖配置)
    - [1.2.1 2. P2P 网络层实现](#121-2-p2p-网络层实现)
    - [1.2.2 3. Raft 状态机实现](#122-3-raft-状态机实现)
    - [1.2.3 4. IM 消息处理](#123-4-im-消息处理)
    - [1.2.4 5. 消息处理器实现](#124-5-消息处理器实现)
    - [1.2.5 6. 存储层实现](#125-6-存储层实现)
