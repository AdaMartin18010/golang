...
- [Rust实现异步交互式控制台](#rust实现异步交互式控制台)
  ...
  - [1.3 2. 基础 UI 框架实现](#13-2-基础-ui-框架实现)
  - [1.4 3. 指标状态管理](#14-3-指标状态管理)
  - [1.5 4. UI 渲染实现](#15-4-ui-渲染实现)
  - [1.6 5. 交互控制实现](#16-5-交互控制实现)
  - [1.7 6. 帮助菜单实现](#17-6-帮助菜单实现)
  - [1.8 7. 指标收集器实现](#18-7-指标收集器实现)
  - [1.9 8. 主程序实现](#19-8-主程序实现)
  - [1.10 9. 自定义图表实现](#110-9-自定义图表实现)
  - [1.11 10. 配置文件支持](#111-10-配置文件支持)
