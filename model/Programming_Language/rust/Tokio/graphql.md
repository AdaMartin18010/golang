...
- [基于 Rust 2024 + Generator 的 GraphQL API 与多数据库集成项目](#基于-rust-2024--generator-的-graphql-api-与多数据库集成项目)
  - [1.1 目录](#11-目录)
  - [1.2 1. 项目配置](#12-1-项目配置)
  - [5.1 2. GraphQL Schema 生成器](#51-2-graphql-schema-生成器)
  - [5.2 3. 数据库模型生成器](#52-3-数据库模型生成器)
  - [5.3 4. 查询解析器生成器](#53-4-查询解析器生成器)
  - [5.4 5. 数据库连接池管理器](#54-5-数据库连接池管理器)
  - [5.5 6. 实体关系管理器](#55-6-实体关系管理器)
  - [5.6 7. 使用示例](#56-7-使用示例)
  - [5.7 1.  项目配置](#57-1--项目配置)
  - [10.1 2. 数据模型定义](#101-2-数据模型定义)
  - [10.2 3. 数据库连接管理器](#102-3-数据库连接管理器)
  - [10.3 4. GraphQL 查询解析器](#103-4-graphql-查询解析器)
  - [10.4 5. GraphQL 变更解析器](#104-5-graphql-变更解析器)
  - [10.5 6. 数据库迁移生成器](#105-6-数据库迁移生成器)
  - [10.6 7.  使用示例](#106-7--使用示例)
