# 1 1 1 1 1 1 1 Rust分布式控制系统

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust分布式控制系统](#1-1-1-1-1-1-1-rust分布式控制系统)
  - [1.1 目录](#目录)
  - [1.2 1. 项目依赖配置](#1-项目依赖配置)
  - [1.3 2. Raft 节点实现](#2-raft-节点实现)
    - [1.3.1 3. P2P 网络实现](#3-p2p-网络实现)
    - [1.3.2 4. NATS 消息处理器](#4-nats-消息处理器)
    - [1.3.3 5. 分布式状态机实现](#5-分布式状态机实现)
    - [1.3.4 6. 控制系统实现](#6-控制系统实现)
