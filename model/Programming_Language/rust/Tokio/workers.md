# 1 1 1 1 1 1 1 Rust异步多线程

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust异步多线程](#1-1-1-1-1-1-1-rust异步多线程)
  - [1.1 目录](#目录)
  - [1.2 1. 项目依赖配置](#1-项目依赖配置)
    - [1.2.1 2. 任务定义和状态](#2-任务定义和状态)
    - [1.2.2 3. 工作者池实现](#3-工作者池实现)
    - [1.2.3 4. 异步队列实现](#4-异步队列实现)
    - [1.2.4 5. 观察者模式实现](#5-观察者模式实现)
    - [1.2.5 6. 任务生成器实现](#6-任务生成器实现)
    - [1.2.6 7. 任务调度器实现](#7-任务调度器实现)
    - [1.2.7 8. 使用示例](#8-使用示例)
    - [1.2.8 9. 自定义观察者示例](#9-自定义观察者示例)
