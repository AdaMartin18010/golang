# 1 1 1 1 1 1 1 分布式控制系统(DCS)

<!-- TOC START -->
- [1 1 1 1 1 1 1 分布式控制系统(DCS)](#1-1-1-1-1-1-1-分布式控制系统dcs)
  - [1.1 目录](#目录)
  - [1.2 首先是项目依赖配置](#首先是项目依赖配置)
  - [1.3 下面是主要实现代码](#下面是主要实现代码)
    - [1.3.1 这个实现包含以下主要特性](#这个实现包含以下主要特性)
    - [1.3.2 1. 配置环境](#1-配置环境)
- [2 2 2 2 2 2 2 设置环境变量](#2-2-2-2-2-2-2-设置环境变量)
    - [2 2 2 2 2 2 2 2. 初始化数据库](#2-2-2-2-2-2-2-2-初始化数据库)
    - [2 2 2 2 2 2 2 3. 运行系统](#2-2-2-2-2-2-2-3-运行系统)
    - [2 2 2 2 2 2 2 项目依赖配置](#2-2-2-2-2-2-2-项目依赖配置)
    - [2 2 2 2 2 2 2 主要实现代码](#2-2-2-2-2-2-2-主要实现代码)
    - [2 2 2 2 2 2 2 代码说明](#2-2-2-2-2-2-2-代码说明)
    - [2 2 2 2 2 2 2 使用建议](#2-2-2-2-2-2-2-使用建议)
