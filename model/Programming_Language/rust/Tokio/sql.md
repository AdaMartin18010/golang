# 1 1 1 1 1 1 1 Rust 2024 数据库访问

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust 2024 数据库访问](#1-1-1-1-1-1-1-rust-2024-数据库访问)
  - [1.1 目录](#目录)
  - [1.2 1. 项目配置](#1-项目配置)
  - [1.3 2. 数据库连接池管理](#2-数据库连接池管理)
  - [1.4 3. 事务管理器](#3-事务管理器)
  - [1.5 4. 锁管理器](#4-锁管理器)
  - [1.6 5. JSON 操作管理器](#5-json-操作管理器)
  - [1.7 6. 存储过程管理器](#6-存储过程管理器)
  - [1.8 7. 异常处理](#7-异常处理)
  - [1.9 8. 使用示例](#8-使用示例)
<!-- TOC END -->
