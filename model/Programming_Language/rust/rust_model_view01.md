...
- [Rust 编程语言的形式模型、元模型与关联分析](#rust-编程语言的形式模型元模型与关联分析)
  ...
  - [1.4 3. Rust 中的形式模型](#14-3-rust-中的形式模型)
    - [1.4.1 核心：所有权系统与借用检查器](#141-核心所有权系统与借用检查器)
      - [1.4.1.1 所有权的形式化](#1411-所有权的形式化)
      - [1.4.1.2 借用规则与生命周期的形式化](#1412-借用规则与生命周期的形式化)
    - [1.4.2 类型系统](#142-类型系统)
    - [1.4.3 内存模型](#143-内存模型)
    - [1.4.4 并发模型](#144-并发模型)
    - [1.4.5 MIR (Mid-level Intermediate Representation)](#145-mir-mid-level-intermediate-representation)
    - [1.4.6 形式化验证工具与研究项目](#146-形式化验证工具与研究项目)
  - [1.5 4. 形式模型示例 (Rust 概念性)](#15-4-形式模型示例-rust-概念性)
    - [1.5.1 简化的所有权转移规则 (伪代码)](#151-简化的所有权转移规则-伪代码)
    - [1.5.2 简化的借用规则 (伪代码)](#152-简化的借用规则-伪代码)
  - [1.6 5. 元模型 (Metamodel) 与模型 (Model)](#16-5-元模型-metamodel-与模型-model)
    - [1.6.1 定义](#161-定义)
  ...
  - [1.7 6. 展开与关联性分析](#17-6-展开与关联性分析)
    ...
    - [1.7.2 Rust 设计哲学与形式化](#172-rust-设计哲学与形式化)
    - [1.7.3 形式化对可靠软件的贡献](#173-形式化对可靠软件的贡献)
  - [1.8 7. 总结](#18-7-总结)
  - [1.9 8. 思维导图 (文本形式)](#19-8-思维导图-文本形式)
  - [1.10 深入元模型-模型的论证、证明与拓展](#110-深入元模型-模型的论证证明与拓展)
    - [1.10.1 1. 编译器的“论证”：模型对元模型的一致性检查](#1101-1-编译器的论证模型对元模型的一致性检查)
    - [1.10.2 2. 超越编译器的“证明”：形式化验证的应用](#1102-2-超越编译器的证明形式化验证的应用)
    - [1.10.3 3. 元模型与模型的“拓展”](#1103-3-元模型与模型的拓展)
  - [1.11 Rust 形式化面临的挑战](#111-rust-形式化面临的挑战)
  - [1.12 形式化对日常 Rust 开发者的实际意义](#112-形式化对日常-rust-开发者的实际意义)
  - [1.13 Rust 形式化的未来可能方向](#113-rust-形式化的未来可能方向)
