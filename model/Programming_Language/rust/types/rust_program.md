# 1 1 1 1 1 1 1 Rust Trait 和泛型对程序可扩展性的影响

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust Trait 和泛型对程序可扩展性的影响](#1-1-1-1-1-1-1-rust-trait-和泛型对程序可扩展性的影响)
  - [1.1 目录](#目录)
  - [1.2 一、引言](#一、引言)
  - [1.3 二、泛型对可扩展性的影响](#二、泛型对可扩展性的影响)
    - [1.3.1 （一）代码通用性](#（一）代码通用性)
    - [1.3.2 （二）减少重复代码](#（二）减少重复代码)
  - [1.4 三、Trait 对可扩展性的影响](#三、trait-对可扩展性的影响)
    - [1.4.1 （一）定义共享行为](#（一）定义共享行为)
    - [1.4.2 （二）实现多态性](#（二）实现多态性)
    - [1.4.3 （三）与其他特性结合使用](#（三）与其他特性结合使用)
  - [1.5 四、泛型和 Trait 的结合使用](#四、泛型和-trait-的结合使用)
    - [1.5.1 （一）泛型函数与 Trait 约束](#（一）泛型函数与-trait-约束)
    - [1.5.2 （二）泛型结构体与 Trait 实现](#（二）泛型结构体与-trait-实现)
  - [1.6 五、总结](#五、总结)
<!-- TOC END -->
