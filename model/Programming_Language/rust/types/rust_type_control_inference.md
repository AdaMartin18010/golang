...
- [1 1 1 1 1 1 1 类型控制推理](#1-1-1-1-1-1-1-类型控制推理)
  - [1.1 目录](#11-目录)
  - [1.2 1. 类型代数与执行流的关系](#12-1-类型代数与执行流的关系)
  - [1.3 2. 函数调用链的推理](#13-2-函数调用链的推理)
    - [1.3.1 示例：函数调用链](#131-示例函数调用链)
    - [1.3.2 推理执行流的可能性](#132-推理执行流的可能性)
  - [1.4 3. 结论](#14-3-结论)
  - [1.5 4. 类型理论](#15-4-类型理论)
  - [1.6 5. 逻辑推理](#16-5-逻辑推理)
  - [1.7 6. 代数语义](#17-6-代数语义)
  - [1.8 7. 过程语义](#18-7-过程语义)
  - [1.9 8. 形式化验证工具](#19-8-形式化验证工具)
  - [1.10 9. 结论](#110-9-结论)
