# 1 1 1 1 1 1 1 Rust Object Safety

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust Object Safety](#1-1-1-1-1-1-1-rust-object-safety)
  - [1.1 目录](#目录)
  - [1.2 1. 对象安全的定义](#1-对象安全的定义)
  - [1.3 2. 对象安全的必要条件](#2-对象安全的必要条件)
  - [1.4 3. 示例说明](#3-示例说明)
    - [1.4.1 示例1：对象安全的 trait](#示例1：对象安全的-trait)
    - [1.4.2 示例2：不符合对象安全要求的 trait](#示例2：不符合对象安全要求的-trait)
  - [1.5 4. 对象安全的限制与设计权衡](#4-对象安全的限制与设计权衡)
  - [1.6 总结](#总结)
  - [1.7 1. 返回 `Self` 类型的问题](#1-返回-self-类型的问题)
  - [1.8 2. 泛型参数的问题](#2-泛型参数的问题)
  - [1.9 3. 总结](#3-总结)
  - [1.10 1. 什么是对象安全（Object Safety）](#1-什么是对象安全（object-safety）)
    - [1.10.1 对象安全需要满足的主要条件](#对象安全需要满足的主要条件)
  - [1.11 2. 为什么需要对象安全](#2-为什么需要对象安全)
  - [1.12 3. 反例与示例](#3-反例与示例)
    - [1.12.1 反例：返回 `Self` 的方法](#反例：返回-self-的方法)
    - [1.12.2 反例：泛型方法](#反例：泛型方法)
    - [1.12.3 对象安全的示例](#对象安全的示例)
  - [1.13 4. 思维导图](#4-思维导图)
  - [1.14 5. 总结](#5-总结)
  - [1.15 1. Trait 对象安全概述](#1-trait-对象安全概述)
  - [1.16 2. 泛型方法与对象安全](#2-泛型方法与对象安全)
    - [1.16.1 泛型方法不满足对象安全要求](#泛型方法不满足对象安全要求)
    - [1.16.2 理解对象安全规范](#理解对象安全规范)
  - [1.17 3. 举例说明](#3-举例说明)
    - [1.17.1 不对象安全的 trait 示例](#不对象安全的-trait-示例)
    - [1.17.2 对象安全的 trait 示例](#对象安全的-trait-示例)
  - [1.18 思维导图](#思维导图)
  - [1.19 --总结](#总结)
    - [1.19.1 -总结](#总结)
<!-- TOC END -->
