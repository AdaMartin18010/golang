...
- [1 1 1 1 1 1 1 Rust Object Safety](#1-1-1-1-1-1-1-rust-object-safety)
  - [1.1 目录](#11-目录)
  - [1.2 1. 对象安全的定义](#12-1-对象安全的定义)
  - [1.3 2. 对象安全的必要条件](#13-2-对象安全的必要条件)
  - [1.4 3. 示例说明](#14-3-示例说明)
    - [1.4.1 示例1：对象安全的 trait](#141-示例1对象安全的-trait)
    - [1.4.2 示例2：不符合对象安全要求的 trait](#142-示例2不符合对象安全要求的-trait)
  - [1.5 4. 对象安全的限制与设计权衡](#15-4-对象安全的限制与设计权衡)
  - [1.6 总结](#16-总结)
  - [1.7 1. 返回 `Self` 类型的问题](#17-1-返回-self-类型的问题)
  - [1.8 2. 泛型参数的问题](#18-2-泛型参数的问题)
  - [1.9 3. 总结](#19-3-总结)
  - [1.10 1. 什么是对象安全（Object Safety）](#110-1-什么是对象安全object-safety)
    - [1.10.1 对象安全需要满足的主要条件](#1101-对象安全需要满足的主要条件)
