...
- [ ](#1-1-1-1-1-1-1-rust-object-safety)
  ...
  - [3. ](#13-2-对象安全的必要条件)
  - [4. ](#14-3-示例说明)
    - [4.1 ](#141-示例1对象安全的-trait)
    - [4.2 ](#142-示例2不符合对象安全要求的-trait)
  - [5. ](#15-4-对象安全的限制与设计权衡)
  - [6. ](#16-总结)
  - [7. ](#17-1-返回-self-类型的问题)
  - [8. ](#18-2-泛型参数的问题)
  - [9. ](#19-3-总结)
  - [10. ](#110-1-什么是对象安全object-safety)
    - [10.1 ](#1101-对象安全需要满足的主要条件)
  - [1.11 2. 为什么需要对象安全](#111-2-为什么需要对象安全)
  - [1.12 3. 反例与示例](#112-3-反例与示例)
    - [1.12.1 反例：返回 `Self` 的方法](#1121-反例返回-self-的方法)
    - [1.12.2 反例：泛型方法](#1122-反例泛型方法)
    - [1.12.3 对象安全的示例](#1123-对象安全的示例)
  - [1.13 4. 思维导图](#113-4-思维导图)
  - [1.14 5. 总结](#114-5-总结)
  - [1.15 1. Trait 对象安全概述](#115-1-trait-对象安全概述)
  - [1.16 2. 泛型方法与对象安全](#116-2-泛型方法与对象安全)
    - [1.16.1 泛型方法不满足对象安全要求](#1161-泛型方法不满足对象安全要求)
    - [1.16.2 理解对象安全规范](#1162-理解对象安全规范)
  - [1.17 3. 举例说明](#117-3-举例说明)
    - [1.17.1 不对象安全的 trait 示例](#1171-不对象安全的-trait-示例)
    - [1.17.2 对象安全的 trait 示例](#1172-对象安全的-trait-示例)
  - [1.18 思维导图](#118-思维导图)
  - [1.19 --总结](#119---总结)
    - [1.19.1 -总结](#1191--总结)
