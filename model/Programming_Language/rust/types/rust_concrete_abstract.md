...
- [1 1 1 1 1 1 1 Rust 中的具体类型和抽象类型](#1-1-1-1-1-1-1-rust-中的具体类型和抽象类型)
  - [1.1 目录](#目录)
  - [1.2 1. 具体类型（Concrete Types）](#1-具体类型（concrete-types）)
  - [1.3 2. 抽象类型（Abstract Types）](#2-抽象类型（abstract-types）)
  - [1.4 总结](#总结)
    - [1.4.1 1. 类型别名（Type Alias）](#1-类型别名（type-alias）)
      - [1.4.1.1 示例](#示例)
    - [1.4.2 2. 新类型（Newtype）](#2-新类型（newtype）)
      - [1.4.2.1 示例](#示例)
    - [1.4.3 3 总结](#3-总结)
    - [1.4.4 1. `impl Trait` 是抽象类型](#1-impl-trait-是抽象类型)
      - [1.4.4.1 示例](#示例)
    - [1.4.5 2. `impl Trait` 是否可以用于类型别名](#2-impl-trait-是否可以用于类型别名)
      - [1.4.5.1 *示例*](#*示例*)
    - [1.4.6 3 *总结*](#3-*总结*)
<!-- TOC END -->
