...
- [1 1 1 1 1 1 1 函数](#1-1-1-1-1-1-1-函数)
  - [1.1 目录](#目录)
  - [1.2 函数声明 (Function Declaration)](#函数声明-function-declaration)
  - [1.3 函数定义 (Function Definition)](#函数定义-function-definition)
  - [1.4 函数实现 (Function Implementation)](#函数实现-function-implementation)
  - [1.5 抽象和默认实现](#抽象和默认实现)
  - [1.6 默认实现](#默认实现)
  - [1.7 分离定义和实现](#分离定义和实现)
  - [1.8 示例](#示例)
