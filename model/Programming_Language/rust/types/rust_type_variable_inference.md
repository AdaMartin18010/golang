...
- [1 1 1 1 1 1 1 Rust 变量与类型系统](#1-1-1-1-1-1-1-rust-变量与类型系统)
  - [1.1 目录](#11-目录)
  - [1.2 变量与类型的关系](#12-变量与类型的关系)
  - [1.3 类型的核心模型-可以理解为Rust的类型系统有那些语义model](#13-类型的核心模型-可以理解为rust的类型系统有那些语义model)
  - [1.4 完全的解释](#14-完全的解释)
  - [1.5 编译器如何查看变量](#15-编译器如何查看变量)
    - [1.5.1 静态检查（Static Checking）](#151-静态检查static-checking)
    - [1.5.2 动态行为（Dynamic Behavior）](#152-动态行为dynamic-behavior)
  - [1.6 总结](#16-总结)
  - [1.7 Rust 中的变体性与多态：关系、证明与安全保证](#17-rust-中的变体性与多态关系证明与安全保证)
    - [1.7.1 一、变体性与多态的关系](#171-一变体性与多态的关系)
      - [1.7.1.1 1. 基本关系](#1711-1-基本关系)
      - [1.7.1.2 2. 具体联系](#1712-2-具体联系)
    - [1.7.2 二、变体性规则的推理与证明](#172-二变体性规则的推理与证明)
      - [1.7.2.1 1. 协变性推理](#1721-1-协变性推理)
      - [1.7.2.2 2. 逆变性推理](#1722-2-逆变性推理)
      - [1.7.2.3 3. 不变性推理](#1723-3-不变性推理)
    - [1.7.3 三、变体性如何保证类型安全和内存安全](#173-三变体性如何保证类型安全和内存安全)
      - [1.7.3.1 1. 协变与安全保证](#1731-1-协变与安全保证)
      - [1.7.3.2 2. 逆变与安全保证](#1732-2-逆变与安全保证)
      - [1.7.3.3 3. 不变性与安全保证](#1733-3-不变性与安全保证)
    - [1.7.4 四、运行时安全与变体性](#174-四运行时安全与变体性)
      - [1.7.4.1 1. 防止悬垂引用](#1741-1-防止悬垂引用)
      - [1.7.4.2 2. 防止数据竞争](#1742-2-防止数据竞争)
      - [1.7.4.3 3. 保证 trait 对象安全](#1743-3-保证-trait-对象安全)
    - [1.7.5 五、形式化证明示例](#175-五形式化证明示例)
