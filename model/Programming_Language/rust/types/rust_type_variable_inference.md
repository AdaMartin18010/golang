...
- [ ](#1-1-1-1-1-1-1-rust-变量与类型系统)
  - [1. ](#11-目录)
  - [2. ](#12-变量与类型的关系)
  - [3. ](#13-类型的核心模型-可以理解为rust的类型系统有那些语义model)
  - [4. ](#14-完全的解释)
  - [5. ](#15-编译器如何查看变量)
    - [5.1 ](#151-静态检查static-checking)
    - [5.2 ](#152-动态行为dynamic-behavior)
  - [6. ](#16-总结)
  - [7. ](#17-rust-中的变体性与多态关系证明与安全保证)
    - [7.1 ](#171-一变体性与多态的关系)
      - [1.7.1.1 1. 基本关系](#1711-1-基本关系)
      - [1.7.1.2 2. 具体联系](#1712-2-具体联系)
    - [7.2 ](#172-二变体性规则的推理与证明)
      - [1.7.2.1 1. 协变性推理](#1721-1-协变性推理)
      - [1.7.2.2 2. 逆变性推理](#1722-2-逆变性推理)
      - [1.7.2.3 3. 不变性推理](#1723-3-不变性推理)
    - [7.3 ](#173-三变体性如何保证类型安全和内存安全)
      - [1.7.3.1 1. 协变与安全保证](#1731-1-协变与安全保证)
      - [1.7.3.2 2. 逆变与安全保证](#1732-2-逆变与安全保证)
      - [1.7.3.3 3. 不变性与安全保证](#1733-3-不变性与安全保证)
    - [7.4 ](#174-四运行时安全与变体性)
      - [1.7.4.1 1. 防止悬垂引用](#1741-1-防止悬垂引用)
      - [1.7.4.2 2. 防止数据竞争](#1742-2-防止数据竞争)
      - [1.7.4.3 3. 保证 trait 对象安全](#1743-3-保证-trait-对象安全)
    - [7.5 ](#175-五形式化证明示例)
      - [1.7.5.1 1. 协变安全性证明](#1751-1-协变安全性证明)
      - [1.7.5.2 2. 逆变安全性证明](#1752-2-逆变安全性证明)
      - [1.7.5.3 3. 不变性安全性证明](#1753-3-不变性安全性证明)
    - [1.7.6 六、变体性与多态的实际应用](#176-六变体性与多态的实际应用)
      - [1.7.6.1 1. 构建灵活的 API](#1761-1-构建灵活的-api)
      - [1.7.6.2 2. 实现类型安全的回调系统](#1762-2-实现类型安全的回调系统)
      - [1.7.6.3 3. 保证容器类型的安全](#1763-3-保证容器类型的安全)
    - [1.7.7 七、总结](#177-七总结)
