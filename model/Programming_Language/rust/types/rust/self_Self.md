...
- [1 1 1 1 1 1 1 Self 与 self](#1-1-1-1-1-1-1-self-与-self)
  - [1.1 目录](#目录)
  - [1.2 1. `self`（小写）](#1-self（小写）)
  - [1.3 2. `Self`（大写）](#2-self（大写）)
  - [1.4 示例代码](#示例代码)
  - [1.5 总结](#总结)
  - [1.6 1. 基本概念](#1-基本概念)
    - [1.6.1 `self`（小写）](#self（小写）)
    - [1.6.2 `Self`（大写）](#self（大写）)
  - [1.7 2. 详细解释与区别](#2-详细解释与区别)
    - [1.7.1 `self` 的作用](#self-的作用)
    - [1.7.2 `Self` 的作用](#self-的作用)
  - [1.8 3. 应用总结](#3-应用总结)
  - [1.9 4. 示例代码](#4-示例代码)
  - [1.10 5. 总结](#5-总结)
<!-- TOC END -->
