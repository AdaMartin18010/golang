# 1 1 1 1 1 1 1 marker trait

<!-- TOC START -->
- [1 1 1 1 1 1 1 marker trait](#1-1-1-1-1-1-1-marker-trait)
  - [1.1 目录](#目录)
  - [1.2 标记 trait 的特点](#标记-trait-的特点)
  - [1.3 标记 trait 的使用场景](#标记-trait-的使用场景)
  - [1.4 总结](#总结)
  - [1.5 1. 编译时静态检查](#1-编译时静态检查)
  - [1.6 2. 标记 Trait：Send 与 Sync](#2-标记-trait：send-与-sync)
  - [1.7 3. 运行时同步原语](#3-运行时同步原语)
  - [1.8 4. 整体安全保证](#4-整体安全保证)
  - [1.9 自动 trait 的工作原理](#自动-trait-的工作原理)
  - [1.10 示例说明](#示例说明)
  - [1.11 总结](#总结)
  - [1.12 1. 自动 trait 的基本原理](#1-自动-trait-的基本原理)
  - [1.13 2. 编译器中的实现机制](#2-编译器中的实现机制)
  - [1.14 3. 举例说明](#3-举例说明)
  - [1.15 小结](#小结)
  - [1.16 1. 确保线程安全](#1-确保线程安全)
  - [1.17 2. 使用 `unsafe impl` 的谨慎性](#2-使用-unsafe-impl-的谨慎性)
  - [1.18 3. 注意负实现（Negative impl）](#3-注意负实现（negative-impl）)
  - [1.19 4. 编译器的自动推导与局限性](#4-编译器的自动推导与局限性)
  - [1.20 总结](#总结)
<!-- TOC END -->
