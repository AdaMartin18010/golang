...
<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust 中对象安全（Object Safety）的定义、解释和所受到的限制](#1-1-1-1-1-1-1-rust-中对象安全（object-safety）的定义、解释和所受到的限制)
  - [1.1 1. 对象安全的定义](#1-对象安全的定义)
  - [1.2 2. 对象安全的必要条件](#2-对象安全的必要条件)
  - [1.3 3. 示例说明](#3-示例说明)
    - [1.3.1 示例1：对象安全的 trait](#示例1：对象安全的-trait)
    - [1.3.2 示例2：不符合对象安全要求的 trait](#示例2：不符合对象安全要求的-trait)
  - [1.4 4. 对象安全的限制与设计权衡](#4-对象安全的限制与设计权衡)
  - [1.5 总结](#总结)
  - [1.6 1. 返回 `Self` 类型的问题](#1-返回-self-类型的问题)
  - [1.7 2. 泛型参数的问题](#2-泛型参数的问题)
  - [1.8 3. 总结](#3-总结)
  - [1.9 1. 什么是对象安全（Object Safety）](#1-什么是对象安全（object-safety）)
    - [1.9.1 对象安全需要满足的主要条件](#对象安全需要满足的主要条件)
  - [1.10 2. 为什么需要对象安全](#2-为什么需要对象安全)
