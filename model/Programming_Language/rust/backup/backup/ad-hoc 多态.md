...
<!-- TOC START -->
- [1 1 1 1 1 1 1 Ad-hoc Polymorphism](#1-1-1-1-1-1-1-ad-hoc-polymorphism)
  - [1.1 1. 什么是 ad-hoc 多态](#1-什么是-ad-hoc-多态)
  - [1.2 2. Rust 中 ad-hoc 多态的实现机制](#2-rust-中-ad-hoc-多态的实现机制)
    - [1.2.1 Trait 定义与实现](#trait-定义与实现)
      - [1.2.1.1 示例](#示例)
    - [1.2.2 静态分发与单态化](#静态分发与单态化)
    - [1.2.3 关联函数和方法调用](#关联函数和方法调用)
  - [1.3 3. ad-hoc 多态的优势与设计思路](#3-ad-hoc-多态的优势与设计思路)
  - [1.4 4. 思维导图示例](#4-思维导图示例)
  - [1.5 5. 总结](#5-总结)
  - [1.6 1. 实现原理与调度方式](#1-实现原理与调度方式)
    - [1.6.1 Rust 中的 ad-hoc 多态](#rust-中的-ad-hoc-多态)
    - [1.6.2 OOP 中的多态](#oop-中的多态)
  - [1.7 2. 性能与安全性的对比](#2-性能与安全性的对比)
    - [1.7.1 性能考虑](#性能考虑)
    - [1.7.2 安全性与静态检查](#安全性与静态检查)
  - [1.8 3. 设计理念与表达](#3-设计理念与表达)
    - [1.8.1 Rust 的 ad-hoc 多态](#rust-的-ad-hoc-多态)
    - [1.8.2 OOP 的多态](#oop-的多态)
  - [1.9 4. 联系与共同点](#4-联系与共同点)
  - [1.10 5. 思维导图示例](#5-思维导图示例)
  - [1.11 6. 总结](#6-总结)
<!-- TOC END -->
