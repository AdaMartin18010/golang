...
- [堆（Heap）和栈（Stack）是计算机内存管理的基本概念，它们既与硬件体系有关，也与编程语言的实现有关](#堆heap和栈stack是计算机内存管理的基本概念它们既与硬件体系有关也与编程语言的实现有关)
  ...
  - [1.2 一般定义](#12-一般定义)
    ...
    - [1.2.2 联系](#122-联系)
    - [1.2.3 解释](#123-解释)
  - [1.3 所有权（Ownership）](#13-所有权ownership)
  - [1.4 借用（Borrowing）](#14-借用borrowing)
  - [1.5 生命周期（Lifetimes）](#15-生命周期lifetimes)
  - [1.6 `Drop` Trait](#16-drop-trait)
  - [1.7 `Clone` Trait](#17-clone-trait)
  - [1.8 `Copy` Trait](#18-copy-trait)
  - [1.9 智能指针（Smart Pointers）](#19-智能指针smart-pointers)
  - [1.10 `Deref` Trait](#110-deref-trait)
  - [1.11 `DerefMut` Trait](#111-derefmut-trait)
  - [1.12 裸指针（Raw Pointers）](#112-裸指针raw-pointers)
  - [1.13 内存分配器（Allocators）](#113-内存分配器allocators)
  - [1.14 栈和堆（Stack and Heap）](#114-栈和堆stack-and-heap)
  - [1.15 RUST内存管理定义](#115-rust内存管理定义)
    - [1.15.1 分类](#1151-分类)
  - [1.16 RUST内存管理基本原理与核心概念](#116-rust内存管理基本原理与核心概念)
    - [1.16.1 *所有权（Ownership）*](#1161-所有权ownership)
    - [1.16.2 *借用（Borrowing）*](#1162-借用borrowing)
    - [1.16.3 *生命周期（Lifetimes）*](#1163-生命周期lifetimes)
    - [1.16.4 *RAII 与 Drop 机制*](#1164-raii-与-drop-机制)
    - [1.16.5 *智能指针*](#1165-智能指针)
  - [1.17 RUST内存管理详细用例说明](#117-rust内存管理详细用例说明)
    - [1.17.1 *所有权与自动释放*](#1171-所有权与自动释放)
    - [1.17.2 *借用与生命周期*](#1172-借用与生命周期)
    - [1.17.3 *移动语义*](#1173-移动语义)
  - [1.18 *思维导图*](#118-思维导图)
  - [1.19 1. `Box<T>`](#119-1-boxt)
    - [1.19.1 定义与解释](#1191-定义与解释)
    - [1.19.2 用例](#1192-用例)
  - [1.20 2. `Rc<T>`](#120-2-rct)
  - [1.21 3. `Arc<T>`](#121-3-arct)
  - [1.22 4. 思维导图](#122-4-思维导图)
  - [1.23 栈内存碎片化](#123-栈内存碎片化)
    - [1.23.1 避免栈碎片化](#1231-避免栈碎片化)
  - [1.24 堆内存碎片化](#124-堆内存碎片化)
    - [1.24.1 避免堆溢出](#1241-避免堆溢出)
    - [1.24.2 避免堆碎片化](#1242-避免堆碎片化)
