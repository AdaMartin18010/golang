...
- [Rust 中的变体性与多态：关系、证明与安全保证](#rust-中的变体性与多态关系证明与安全保证)
  - [1.1 目录](#11-目录)
  - [1.2 一、变体性与多态的关系](#12-一变体性与多态的关系)
    - [1.2.1 1. 基本关系](#121-1-基本关系)
    - [1.2.2 2. 具体联系](#122-2-具体联系)
  - [1.3 二、变体性规则的推理与证明](#13-二变体性规则的推理与证明)
    - [1.3.1 1. 协变性推理](#131-1-协变性推理)
    - [1.3.2 2. 逆变性推理](#132-2-逆变性推理)
    - [1.3.3 3. 不变性推理](#133-3-不变性推理)
  - [1.4 三、变体性如何保证安全性](#14-三变体性如何保证安全性)
    - [1.4.1 1. 类型安全保证](#141-1-类型安全保证)
    - [1.4.2 2. 内存安全保证](#142-2-内存安全保证)
    - [1.4.3 3. 运行时安全保证](#143-3-运行时安全保证)
  - [1.5 四、形式化证明方法](#15-四形式化证明方法)
    - [1.5.1 1. 类型系统的形式化表示](#151-1-类型系统的形式化表示)
    - [1.5.2 2. 归纳证明](#152-2-归纳证明)
    - [1.5.3 3. 反证法](#153-3-反证法)
  - [1.6 五、实际应用中的安全保证](#16-五实际应用中的安全保证)
    - [1.6.1 1. 实际代码示例](#161-1-实际代码示例)
    - [1.6.2 2. 实际安全保证](#162-2-实际安全保证)
  - [1.7 六、总结](#17-六总结)
