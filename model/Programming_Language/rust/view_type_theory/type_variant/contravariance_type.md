...
- [协变和逆变的实际应用](#协变和逆变的实际应用)
  - [1.1 目录](#11-目录)
  - [1.2 一、协变（Covariance）](#12-一协变covariance)
  - [1.3 二、逆变（Contravariance）](#13-二逆变contravariance)
  - [1.4 三、实际应用场景](#14-三实际应用场景)
    - [1.4.1 1. Rust 中的协变与逆变应用](#141-1-rust-中的协变与逆变应用)
    - [1.4.2 2. Java 中的协变和逆变](#142-2-java-中的协变和逆变)
  - [1.5 逆变（Contravariance）在 Rust 中的应用](#15-逆变contravariance在-rust-中的应用)
    - [1.5.1 1. 函数参数的逆变](#151-1-函数参数的逆变)
    - [1.5.2 2. 生命周期的逆变](#152-2-生命周期的逆变)
    - [1.5.3 3. 高阶函数的逆变](#153-3-高阶函数的逆变)
    - [1.5.4 4. 函数指针的逆变](#154-4-函数指针的逆变)
  - [1.6 总结](#16-总结)
  - [1.7 如何定义逆变类型](#17-如何定义逆变类型)
    - [1.7.1 1. 函数参数](#171-1-函数参数)
    - [1.7.2 2. 生命周期参数](#172-2-生命周期参数)
    - [1.7.3 3. 函数参数的逆变](#173-3-函数参数的逆变)
    - [1.7.4 生命周期的逆变](#174-生命周期的逆变)
