...
- [Rust 中不变（Invariance）的特性](#rust-中不变invariance的特性)
  - [1.1 目录](#11-目录)
  - [1.2 常见情况与示例](#12-常见情况与示例)
    - [1.2.1 1. **`Cell<T>` 和 `UnsafeCell<T>` 的不变性**](#121-1-cellt-和-unsafecellt-的不变性)
    - [1.2.2 2. **`PhantomData<T>` 的不变性**](#122-2-phantomdatat-的不变性)
    - [1.2.3 1. 定义](#123-1-定义)
    - [1.2.4 2. 示例](#124-2-示例)
      - [1.2.4.1 协变（Covariance）参数](#1241-协变covariance参数)
      - [1.2.4.2 逆变（Contravariance）参数](#1242-逆变contravariance参数)
      - [1.2.4.3 不变（Invariance）参数](#1243-不变invariance参数)
    - [1.2.5 3. 影响](#125-3-影响)
  - [1.3 Rust 中的可变性、协变、逆变和不变性](#13-rust-中的可变性协变逆变和不变性)
  - [1.4 可变性 (Mutability)](#14-可变性-mutability)
  - [1.5 协变 (Covariance)](#15-协变-covariance)
  - [1.6 逆变 (Contravariance)](#16-逆变-contravariance)
  - [1.7 不变性 (Invariance)](#17-不变性-invariance)
  - [1.8 实际示例](#18-实际示例)
  - [1.9 为什么这些概念很重要？](#19-为什么这些概念很重要)
  - [1.10 Rust 中的类型变体性：可变性、协变、逆变和不变性](#110-rust-中的类型变体性可变性协变逆变和不变性)
    - [1.10.1 一、可变性 (Mutability)](#1101-一可变性-mutability)
      - [1.10.1.1 定义](#11011-定义)
      - [1.10.1.2 概念解释](#11012-概念解释)
      - [1.10.1.3 示例](#11013-示例)
    - [1.10.2 二、协变 (Covariance)](#1102-二协变-covariance)
    - [1.10.3 三、逆变 (Contravariance)](#1103-三逆变-contravariance)
    - [1.10.4 四、不变性 (Invariance)](#1104-四不变性-invariance)
    - [1.10.5 五、综合示例](#1105-五综合示例)
    - [1.10.6 六、为什么这些概念很重要？](#1106-六为什么这些概念很重要)
