...
- [CovariantType](#covarianttype)
  ...
  - [1.4 协变的应用](#14-协变的应用)
  - [1.5 示例](#15-示例)
  - [1.6 Rust 中如何应用协变特性](#16-rust-中如何应用协变特性)
  - [1.7 Rust 中的协变特性](#17-rust-中的协变特性)
  - [1.8 核心概念](#18-核心概念)
  - [1.9 定义](#19-定义)
  - [1.10 解释](#110-解释)
  - [1.11 引用类型的协变](#111-引用类型的协变)
  - [1.12 生命周期的协变](#112-生命周期的协变)
  - [1.13 函数返回值的协变](#113-函数返回值的协变)
  - [1.14 Trait 对象的协变](#114-trait-对象的协变)
  - [1.15 协变在 Rust 中的应用](#115-协变在-rust-中的应用)
    - [1.15.1 **1. 引用类型的协变**](#1151-1-引用类型的协变)
    - [1.15.2 **2. 生命周期的协变**](#1152-2-生命周期的协变)
    - [1.15.3 **3. Trait 对象的协变**](#1153-3-trait-对象的协变)
  - [1.16 **4. 函数返回值类型的协变**](#116-4-函数返回值类型的协变)
  - [1.17 **5. 泛型类型的协变**](#117-5-泛型类型的协变)
  - [1.18 **6. 结合生命周期和协变**](#118-6-结合生命周期和协变)
  - [1.19 **7. 协变与逆变、不变**](#119-7-协变与逆变不变)
  - [1.20 协变（Covariance）、逆变（Contravariance）和不变（Invariance）核心定义、概念解释及示例](#120-协变covariance逆变contravariance和不变invariance核心定义概念解释及示例)
    - [1.20.1 1. 核心定义](#1201-1-核心定义)
    - [1.20.2 2. 概念解释](#1202-2-概念解释)
    - [1.20.3 3. 示例](#1203-3-示例)
      - [1.20.3.1 协变（Covariance）](#12031-协变covariance)
      - [1.20.3.2 逆变（Contravariance）](#12032-逆变contravariance)
      - [1.20.3.3 不变（Invariance）](#12033-不变invariance)
    - [1.20.4 总结](#1204-总结)
