# 1 1 1 1 1 1 1 Rust 模块化系统：Package、Mod、Crate 与 Workspace

<!-- TOC START -->
- [1 1 1 1 1 1 1 Rust 模块化系统：Package、Mod、Crate 与 Workspace](#1-1-1-1-1-1-1-rust-模块化系统：package、mod、crate-与-workspace)
  - [1.1 目录](#目录)
  - [1.2 一、基本概念定义](#一、基本概念定义)
    - [1.2.1 1. Crate（包）](#1-crate（包）)
    - [1.2.2 2. Package（包）](#2-package（包）)
    - [1.2.3 3. Module（模块）](#3-module（模块）)
    - [1.2.4 4. Workspace（工作空间）](#4-workspace（工作空间）)
  - [1.3 二、概念之间的关系](#二、概念之间的关系)
    - [1.3.1 1. 层次结构](#1-层次结构)
    - [1.3.2 2. 包含关系](#2-包含关系)
    - [1.3.3 3. 关系图解](#3-关系图解)
  - [1.4 三、详细解释与示例](#三、详细解释与示例)
    - [1.4.1 1. Crate 详解](#1-crate-详解)
    - [1.4.2 2. Package 详解](#2-package-详解)
    - [1.4.3 3. Module 详解](#3-module-详解)
    - [1.4.4 4. Workspace 详解](#4-workspace-详解)
  - [1.5 四、路径与引用](#四、路径与引用)
    - [1.5.1 1. 模块路径](#1-模块路径)
    - [1.5.2 2. `use` 关键字](#2-use-关键字)
    - [1.5.3 3. 重导出](#3-重导出)
    - [1.5.4 4. 外部 Crate 引用](#4-外部-crate-引用)
  - [1.6 五、标准工程实践](#五、标准工程实践)
    - [1.6.1 1. 包结构最佳实践](#1-包结构最佳实践)
    - [1.6.2 2. 模块组织最佳实践](#2-模块组织最佳实践)
    - [1.6.3 3. Workspace 最佳实践](#3-workspace-最佳实践)
    - [1.6.4 4. 可见性控制最佳实践](#4-可见性控制最佳实践)
  - [1.7 六、深入分析与推理](#六、深入分析与推理)
    - [1.7.1 1. 模块系统设计原理](#1-模块系统设计原理)
    - [1.7.2 2. Crate 编译模型分析](#2-crate-编译模型分析)
    - [1.7.3 3. Workspace 依赖管理分析](#3-workspace-依赖管理分析)
    - [1.7.4 4. 模块可见性机制推理](#4-模块可见性机制推理)
  - [1.8 七、实际案例分析](#七、实际案例分析)
    - [1.8.1 1. 标准库结构分析](#1-标准库结构分析)
    - [1.8.2 2. 大型开源项目分析](#2-大型开源项目分析)
- [2 2 2 2 2 2 2 tokio/Cargo.toml (Workspace 配置)](#2-2-2-2-2-2-2-tokiocargotoml-workspace-配置)
    - [2 2 2 2 2 2 2 3. 微服务架构示例](#2-2-2-2-2-2-2-3-微服务架构示例)
    - [2 2 2 2 2 2 2 4. 插件系统设计](#2-2-2-2-2-2-2-4-插件系统设计)
  - [2.1 八、总结与最佳实践](#八、总结与最佳实践)
    - [2.1.1 1. 模块化设计原则](#1-模块化设计原则)
    - [2.1.2 2. 项目结构决策指南](#2-项目结构决策指南)
    - [2.1.3 3. 命名约定](#3-命名约定)
<!-- TOC END -->
