...
- [1 1 1 1 1 1 1 Rust泛型机制下的工作流系统设计模式分析](#1-1-1-1-1-1-1-rust泛型机制下的工作流系统设计模式分析)
  - [1.1 目录](#目录)
  - [1.2 引言：工作流建模与Rust泛型](#引言：工作流建模与rust泛型)
  - [1.3 1. Petri网与工作流形式化建模](#1-petri网与工作流形式化建模)
    - [1.3.1 Petri网基础](#petri网基础)
    - [1.3.2 Rust中的Petri网建模](#rust中的petri网建模)
    - [1.3.3 工作流与Petri网映射](#工作流与petri网映射)
  - [1.4 2. 基本控制流模式](#2-基本控制流模式)
    - [1.4.1 序列模式与Petri网表示](#序列模式与petri网表示)
    - [1.4.2 并行分支模式](#并行分支模式)
    - [1.4.3 排他选择模式](#排他选择模式)
  - [1.5 3. 高级分支/合并模式](#3-高级分支合并模式)
    - [1.5.1 多选择模式](#多选择模式)
    - [1.5.2 同步合并模式](#同步合并模式)
    - [1.5.3 多合并模式](#多合并模式)
  - [1.6 4. 结构模式](#4-结构模式)
    ...
    - [1.6.2 隐式终止模式](#隐式终止模式)
  - [1.7 5. 多实例模式](#5-多实例模式)
    - [1.7.1 无同步多实例模式](#无同步多实例模式)
    - [1.7.2 设计时多实例模式](#设计时多实例模式)
    - [1.7.3 运行时多实例模式](#运行时多实例模式)
    - [1.7.4 无先验知识多实例模式](#无先验知识多实例模式)
  - [1.8 6. 状态基础模式](#6-状态基础模式)
    - [1.8.1 延迟选择模式](#延迟选择模式)
    - [1.8.2 交错并行路由模式](#交错并行路由模式)
    - [1.8.3 里程碑模式](#里程碑模式)
  - [1.9 7. 取消和触发模式](#7-取消和触发模式)
    - [1.9.1 取消活动模式](#取消活动模式)
    - [1.9.2 取消案例模式](#取消案例模式)
    - [1.9.3 瞬时触发模式](#瞬时触发模式)
    - [1.9.4 持久触发模式](#持久触发模式)
  - [1.10 8. 数据基础模式](#8-数据基础模式)
    - [1.10.1 结构化判别模式](#结构化判别模式)
    - [1.10.2 通用判别模式](#通用判别模式)
    - [1.10.3 环路数据传递模式](#环路数据传递模式)
  - [1.11 9. 综合示例：基于Rust泛型的工作流系统](#9-综合示例：基于rust泛型的工作流系统)
  - [1.12 10. 结论](#10-结论)
  - [1.13 11. 开源生态系统集成](#11-开源生态系统集成)
    - [1.13.1 Tokio](#tokio)
    - [1.13.2 actix](#actix)
    - [1.13.3 async-graphql](#async-graphql)
    - [1.13.4 tide-async](#tide-async)
  - [1.14 12. 未来工作方向](#12-未来工作方向)
  - [1.15 13. 总结](#13-总结)
<!-- TOC END -->
