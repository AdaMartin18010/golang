...
- [1 1 1 1 1 1 1 rust 泛型实现设计模式](#1-1-1-1-1-1-1-rust-泛型实现设计模式)
  ...
  - [1.10 10. 懒汉式与饿汉式单例](#10-懒汉式与饿汉式单例)
  - [1.11 11. 登记式单例（Registry Singleton）](#11-登记式单例（registry-singleton）)
    - [1.11.1 总结](#总结)
  - [1.12 泛型实现设计模式](#泛型实现设计模式)
    - [1.12.1 *1. 单例模式（Singleton Pattern）*](#*1-单例模式（singleton-pattern）*)
    - [1.12.2 *2. 工厂方法模式（Factory Method Pattern）*](#*2-工厂方法模式（factory-method-pattern）*)
    - [1.12.3 *3. 抽象工厂模式（Abstract Factory Pattern）*](#*3-抽象工厂模式（abstract-factory-pattern）*)
    - [1.12.4 *4. 建造者模式（Builder Pattern）*](#*4-建造者模式（builder-pattern）*)
    - [1.12.5 *5. 原型模式（Prototype Pattern）*](#*5-原型模式（prototype-pattern）*)
    - [1.12.6 *6. 对象池模式（Object Pool Pattern）*](#*6-对象池模式（object-pool-pattern）*)
    - [1.12.7 *7. 多例模式（Multiton Pattern）*](#*7-多例模式（multiton-pattern）*)
    - [1.12.8 *8. 静态工厂方法（Static Factory Method）*](#*8-静态工厂方法（static-factory-method）*)
    - [1.12.9 *9. 简单工厂模式（Simple Factory Pattern）*](#*9-简单工厂模式（simple-factory-pattern）*)
    - [1.12.10 *10. 懒汉式与饿汉式单例*](#*10-懒汉式与饿汉式单例*)
    - [1.12.11 *11. 登记式单例（Registry Singleton）*](#*11-登记式单例（registry-singleton）*)
    - [1.12.12 *总结*](#*总结*)
<!-- TOC END -->
