...
<!-- TOC START -->
- [ ](#1-1-1-1-1-1-1-复杂分布式系统架构设计与实现方案)
  - [1. ](#一、整体架构设计)
    - [1.1 ](#1-系统架构概览)
    - [1.2 ](#2-核心层次与组件)
      - [1.1.2.1 应用层](#应用层)
...
- [ ](#4-4-4-4-4-4-4-复杂分布式系统架构设计与实现方案（续）)
  - [4.1 四、部署架构（续）](#四、部署架构（续）)
    - [4.1 ](#1-容器化与服务编排（续）)
    - [4.2 ](#2-prometheus配置)
- [ ](#5-5-5-5-5-5-5-prometheusyml)
    - [ ](#5-5-5-5-5-5-5-3-kubernetes部署配置)
- [ ](#6-6-6-6-6-6-6-order-service-deploymentyaml)
- [ ](#7-7-7-7-7-7-7-order-service-serviceyaml)
- [ ](#8-8-8-8-8-8-8-order-service-hpayaml)
...
- [ ](#20-20-20-20-20-20-20-暴露端口)
- [ ](#21-21-21-21-21-21-21-启动命令)
