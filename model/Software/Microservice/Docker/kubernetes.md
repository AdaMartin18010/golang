...
- [ ](#1-1-1-1-1-1-1-kubernetes-与-docker-容器编排架构模型解析)
  - [1. ](#11-目录)
  - [2. ](#12-思维导图)
  - [3. ](#13-1-容器技术基础概念)
    - [3.1 ](#131-docker-容器化的先驱)
    - [3.2 ](#132-kubernetes-容器编排平台)
  - [4. ](#14-2-kubernetes-架构模型)
    - [4.1 ](#141-控制平面组件)
    - [4.2 ](#142-节点组件)
    - [4.3 ](#143-核心资源对象)
  - [5. ](#15-3-从工作流编排角度理解-kubernetes)
    - [5.1 ](#151-声明式api与工作流编排)
    - [5.2 ](#152-控制循环与状态转换)
    - [5.3 ](#153-kubernetes-编排生命周期)
  - [6. ](#16-4-kubernetes-与-docker-的组合关系)
    - [6.1 ](#161-历史演变从紧密耦合到解耦)
    - [6.2 ](#162-cri-接口与容器运行时)
  - [7. ](#17-5-以-rust-代码示例理解核心概念)
    - [7.1 ](#171-声明式配置的表达)
    - [7.2 ](#172-控制器模式的实现)
  - [8. ](#18-6-总结与未来趋势)
    - [8.1 ](#181-kubernetes-与-docker-之间的关系总结)
    - [8.2 ](#182-未来发展趋势)
