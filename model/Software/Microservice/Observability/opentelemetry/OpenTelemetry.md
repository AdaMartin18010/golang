...
- [从范畴论的视角看待OpenTelemetry 开源监测系统](#从范畴论的视角看待opentelemetry-开源监测系统)
  - [1.1 1. 范畴的定义：OpenTelemetry 检测范畴](#11-1-范畴的定义opentelemetry-检测范畴)
  - [1.2 2. 关键组件作为范畴中的“箭头”](#12-2-关键组件作为范畴中的箭头)
  - [1.3 3. 设计模式分析](#13-3-设计模式分析)
  - [1.4 4. 范畴的属性](#14-4-范畴的属性)
  - [1.5 5. 范畴的控制与管理](#15-5-范畴的控制与管理)
  - [1.6 总结](#16-总结)
<!-- TOC END -->
