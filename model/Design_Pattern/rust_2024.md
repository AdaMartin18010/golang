...
<!-- TOC START -->
- [Rust 2024 设计模式实现指南](#rust-2024-设计模式实现指南)
  - [1.1 同步设计模式](#11-同步设计模式)
    - [1.1.1 1. 单例模式（Singleton Pattern）](#111-1-单例模式singleton-pattern)
    - [1.1.2 2. 工厂模式（Factory Pattern）](#112-2-工厂模式factory-pattern)
    - [1.1.3 3. 观察者模式（Observer Pattern）](#113-3-观察者模式observer-pattern)
  - [1.2 异步设计模式](#12-异步设计模式)
    - [1.2.1 1. 异步单例模式](#121-1-异步单例模式)
    - [1.2.2 2. 异步工厂模式](#122-2-异步工厂模式)
    - [1.2.3 3. 异步观察者模式](#123-3-异步观察者模式)
  - [1.3 总结](#13-总结)
<!-- TOC END -->
