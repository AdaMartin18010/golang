...
- [并行模式(Parallel Patterns)](#并行模式parallel-patterns)
  - [1. ](#11-同步实现)
    - [1.1 ](#111-1-数据并行模式data-parallelism)
    - [1.2 ](#112-2-任务并行模式task-parallelism)
    - [1.3 ](#113-3-流水线并行模式pipeline-parallelism)
    - [1.4 ](#114-4-工作分割模式work-decomposition)
    - [1.5 ](#115-5-工作窃取模式work-stealing)
