# 1 1 1 1 1 1 1 6. 分布式系统模式

<!-- TOC START -->
- [1 1 1 1 1 1 1 6. 分布式系统模式](#1-1-1-1-1-1-1-6-分布式系统模式)
  - [1.1 23. 容错模式](#11-23-容错模式)
  - [1.2 24. 事务模式](#12-24-事务模式)
  - [1.3 25. 缓存模式](#13-25-缓存模式)
  - [1.4 26. 服务发现与配置](#14-26-服务发现与配置)
  - [1.5 27. 调度与负载均衡](#15-27-调度与负载均衡)
<!-- TOC END -->
