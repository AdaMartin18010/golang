...
- [行为型模式(Behavioral Patterns)](#行为型模式behavioral-patterns)
  - [1. ](#11-异步实现)
    - [1.1 ](#111-1-责任链模式chain-of-responsibility-pattern)
    - [1.2 ](#112-2-命令模式command-pattern)
    - [1.3 ](#113-3-解释器模式interpreter-pattern)
    - [1.4 ](#114-4-迭代器模式iterator-pattern)
    - [1.5 ](#115-5-中介者模式mediator-pattern)
