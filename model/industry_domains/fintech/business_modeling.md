# 1 1 1 1 1 1 1 金融科技行业 - 业务建模详细指南

<!-- TOC START -->
- [1 1 1 1 1 1 1 金融科技行业 - 业务建模详细指南](#1-1-1-1-1-1-1-金融科技行业---业务建模详细指南)
  - [1.1 概述](#11-概述)
  - [1.2 1. 业务领域概念建模](#12-1-业务领域概念建模)
    - [1.2.1 核心业务概念](#121-核心业务概念)
      - [1.2.1.1 账户聚合根](#1211-账户聚合根)
      - [1.2.1.2 支付聚合根](#1212-支付聚合根)
      - [1.2.1.3 交易聚合根](#1213-交易聚合根)
    - [1.2.2 值对象](#122-值对象)
    - [1.2.3 领域服务](#123-领域服务)
  - [1.3 2. 数据建模](#13-2-数据建模)
    - [1.3.1 数据库设计](#131-数据库设计)
      - [1.3.1.1 账户相关表](#1311-账户相关表)
      - [1.3.1.2 支付相关表](#1312-支付相关表)
      - [1.3.1.3 交易相关表](#1313-交易相关表)
    - [1.3.2 仓储实现](#132-仓储实现)
  - [1.4 3. 流程建模](#14-3-流程建模)
    - [1.4.1 支付处理流程](#141-支付处理流程)
    - [1.4.2 交易执行流程](#142-交易执行流程)
    - [1.4.3 风控流程](#143-风控流程)
    - [1.4.4 流程实现](#144-流程实现)
  - [1.5 4. 业务规则引擎](#15-4-业务规则引擎)
    - [1.5.1 规则定义](#151-规则定义)
    - [1.5.2 规则引擎](#152-规则引擎)
  - [1.6 5. 事件溯源](#16-5-事件溯源)
    - [1.6.1 事件定义](#161-事件定义)
    - [1.6.2 事件存储](#162-事件存储)
  - [1.7 总结](#17-总结)
<!-- TOC END -->
