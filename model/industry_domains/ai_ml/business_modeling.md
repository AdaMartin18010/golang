# 1 1 1 1 1 1 1 AI/ML行业 - 业务建模详细指南

<!-- TOC START -->
- [1 1 1 1 1 1 1 AI/ML行业 - 业务建模详细指南](#1-1-1-1-1-1-1-aiml行业---业务建模详细指南)
  - [1.1 概述](#11-概述)
  - [1.2 1. 业务领域概念建模](#12-1-业务领域概念建模)
    - [1.2.1 核心业务概念](#121-核心业务概念)
      - [1.2.1.1 数据集聚合根](#1211-数据集聚合根)
      - [1.2.1.2 特征集聚合根](#1212-特征集聚合根)
      - [1.2.1.3 模型聚合根](#1213-模型聚合根)
    - [1.2.2 值对象](#122-值对象)
  - [1.3 2. 数据建模](#13-2-数据建模)
    - [1.3.1 数据库设计](#131-数据库设计)
      - [1.3.1.1 数据集相关表](#1311-数据集相关表)
      - [1.3.1.2 特征集相关表](#1312-特征集相关表)
      - [1.3.1.3 模型相关表](#1313-模型相关表)
      - [1.3.1.4 预测记录表](#1314-预测记录表)
    - [1.3.2 特征存储实现](#132-特征存储实现)
  - [1.4 3. 流程建模](#14-3-流程建模)
    - [1.4.1 模型训练流程](#141-模型训练流程)
    - [1.4.2 推理服务流程](#142-推理服务流程)
    - [1.4.3 特征工程流程](#143-特征工程流程)
    - [1.4.4 流程实现](#144-流程实现)
  - [1.5 4. 模型服务](#15-4-模型服务)
    - [1.5.1 推理服务](#151-推理服务)
    - [1.5.2 模型监控](#152-模型监控)
  - [1.6 5. 事件系统](#16-5-事件系统)
    - [1.6.1 事件定义](#161-事件定义)
    - [1.6.2 事件处理器](#162-事件处理器)
  - [1.7 总结](#17-总结)
<!-- TOC END -->
