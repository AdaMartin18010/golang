...
- [1 1 1 1 1 1 1 人工智能/机器学习 (AI/ML) - Rust架构指南](#1-1-1-1-1-1-1-人工智能机器学习-aiml---rust架构指南)
  ...
  - [14.1 架构模式](#141-架构模式)
    ...
    - [14.1.3 3. 事件驱动架构](#1413-3-事件驱动架构)
  - [14.2 业务领域建模](#142-业务领域建模)
    - [14.2.1 核心领域概念](#1421-核心领域概念)
    - [14.2.2 值对象](#1422-值对象)
  - [14.3 数据建模](#143-数据建模)
    - [14.3.1 数据库设计](#1431-数据库设计)
    - [14.3.2 特征存储](#1432-特征存储)
  - [14.4 流程建模](#144-流程建模)
    - [14.4.1 模型训练流程](#1441-模型训练流程)
    - [14.4.2 推理服务流程](#1442-推理服务流程)
  - [14.5 组件建模](#145-组件建模)
    - [14.5.1 数据处理管道](#1451-数据处理管道)
    - [14.5.2 模型训练引擎](#1452-模型训练引擎)
    - [14.5.3 推理引擎](#1453-推理引擎)
  - [14.6 性能优化](#146-性能优化)
    - [14.6.1 批处理推理](#1461-批处理推理)
    - [14.6.2 模型缓存](#1462-模型缓存)
  - [14.7 监控和可观测性](#147-监控和可观测性)
    - [14.7.1 性能监控](#1471-性能监控)
  - [14.8 测试策略](#148-测试策略)
    - [14.8.1 单元测试](#1481-单元测试)
