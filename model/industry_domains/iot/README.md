...
- [1 1 1 1 1 1 1 物联网 (IoT) - Rust架构指南](#1-1-1-1-1-1-1-物联网-iot---rust架构指南)
  ...
  - [13.1 架构模式](#131-架构模式)
    - [13.1.1 1. 分层架构](#1311-1-分层架构)
    - [13.1.2 2. 边缘计算架构](#1312-2-边缘计算架构)
    - [13.1.3 3. 事件驱动架构](#1313-3-事件驱动架构)
  - [13.2 业务领域建模](#132-业务领域建模)
    - [13.2.1 核心领域概念](#1321-核心领域概念)
    - [13.2.2 值对象](#1322-值对象)
  - [13.3 数据建模](#133-数据建模)
    - [13.3.1 数据库设计](#1331-数据库设计)
    - [13.3.2 时间序列数据存储](#1332-时间序列数据存储)
  - [13.4 流程建模](#134-流程建模)
    - [13.4.1 设备注册流程](#1341-设备注册流程)
    - [13.4.2 数据处理流程](#1342-数据处理流程)
  - [13.5 组件建模](#135-组件建模)
    - [13.5.1 设备管理器](#1351-设备管理器)
    - [13.5.2 数据处理引擎](#1352-数据处理引擎)
    - [13.5.3 规则引擎](#1353-规则引擎)
  - [13.6 通信协议](#136-通信协议)
    - [13.6.1 MQTT客户端](#1361-mqtt客户端)
    - [13.6.2 CoAP客户端](#1362-coap客户端)
  - [13.7 安全机制](#137-安全机制)
    - [13.7.1 设备认证](#1371-设备认证)
    - [13.7.2 数据加密](#1372-数据加密)
  - [13.8 性能优化](#138-性能优化)
    - [13.8.1 数据压缩](#1381-数据压缩)
    - [13.8.2 批量处理](#1382-批量处理)
  - [13.9 测试策略](#139-测试策略)
    - [13.9.1 单元测试](#1391-单元测试)
    - [13.9.2 集成测试](#1392-集成测试)
  - [13.10 部署和运维](#1310-部署和运维)
    - [13.10.1 容器化部署](#13101-容器化部署)
