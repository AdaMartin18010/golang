...
- [3 3 3 3 3 3 3 网络通信](#3-3-3-3-3-3-3-网络通信)
- [4 4 4 4 4 4 4 序列化](#4-4-4-4-4-4-4-序列化)
- [5 5 5 5 5 5 5 数据库](#5-5-5-5-5-5-5-数据库)
- [6 6 6 6 6 6 6 加密和安全](#6-6-6-6-6-6-6-加密和安全)
- [7 7 7 7 7 7 7 配置管理](#7-7-7-7-7-7-7-配置管理)
- [8 8 8 8 8 8 8 日志](#8-8-8-8-8-8-8-日志)
    - [8 8 8 8 8 8 8 行业特定库](#8-8-8-8-8-8-8-行业特定库)
- [9 9 9 9 9 9 9 硬件抽象](#9-9-9-9-9-9-9-硬件抽象)
- [10 10 10 10 10 10 10 传感器支持](#10-10-10-10-10-10-10-传感器支持)
...
- [13 13 13 13 13 13 13 缓存](#13-13-13-13-13-13-13-缓存)
  - [13.1 架构模式](#架构模式)
    - [13.1.1 1. 分层架构](#1-分层架构)
    - [13.1.2 2. 边缘计算架构](#2-边缘计算架构)
    - [13.1.3 3. 事件驱动架构](#3-事件驱动架构)
  - [13.2 业务领域建模](#业务领域建模)
    - [13.2.1 核心领域概念](#核心领域概念)
    - [13.2.2 值对象](#值对象)
  - [13.3 数据建模](#数据建模)
    - [13.3.1 数据库设计](#数据库设计)
    - [13.3.2 时间序列数据存储](#时间序列数据存储)
  - [13.4 流程建模](#流程建模)
    - [13.4.1 设备注册流程](#设备注册流程)
    - [13.4.2 数据处理流程](#数据处理流程)
  - [13.5 组件建模](#组件建模)
    - [13.5.1 设备管理器](#设备管理器)
    - [13.5.2 数据处理引擎](#数据处理引擎)
    - [13.5.3 规则引擎](#规则引擎)
  - [13.6 通信协议](#通信协议)
    - [13.6.1 MQTT客户端](#mqtt客户端)
    - [13.6.2 CoAP客户端](#coap客户端)
  - [13.7 安全机制](#安全机制)
    - [13.7.1 设备认证](#设备认证)
    - [13.7.2 数据加密](#数据加密)
  - [13.8 性能优化](#性能优化)
  ...
  - [13.10 部署和运维](#部署和运维)
    - [13.10.1 容器化部署](#容器化部署)
- [14 14 14 14 14 14 14 Dockerfile for IoT Edge Node](#14-14-14-14-14-14-14-dockerfile-for-iot-edge-node)
    - [14 14 14 14 14 14 14 配置管理](#14-14-14-14-14-14-14-配置管理)
- [15 15 15 15 15 15 15 config.toml](#15-15-15-15-15-15-15-configtoml)
  - [15.1 总结](#总结)
<!-- TOC END -->
