# 1 1 1 1 1 1 1 物联网行业 - 业务建模详细指南

<!-- TOC START -->
- [1 1 1 1 1 1 1 物联网行业 - 业务建模详细指南](#1-1-1-1-1-1-1-物联网行业---业务建模详细指南)
  - [1.1 概述](#11-概述)
  - [1.2 1. 业务领域概念建模](#12-1-业务领域概念建模)
    - [1.2.1 核心业务概念](#121-核心业务概念)
      - [1.2.1.1 设备聚合根](#1211-设备聚合根)
      - [1.2.1.2 传感器数据聚合根](#1212-传感器数据聚合根)
      - [1.2.1.3 规则聚合根](#1213-规则聚合根)
    - [1.2.2 值对象](#122-值对象)
  - [1.3 2. 数据建模](#13-2-数据建模)
    - [1.3.1 数据库设计](#131-数据库设计)
      - [1.3.1.1 设备相关表](#1311-设备相关表)
      - [1.3.1.2 传感器数据表](#1312-传感器数据表)
      - [1.3.1.3 规则和告警表](#1313-规则和告警表)
    - [1.3.2 时间序列数据存储](#132-时间序列数据存储)
  - [1.4 3. 流程建模](#14-3-流程建模)
    - [1.4.1 设备注册流程](#141-设备注册流程)
    - [1.4.2 数据处理流程](#142-数据处理流程)
    - [1.4.3 告警处理流程](#143-告警处理流程)
    - [1.4.4 流程实现](#144-流程实现)
  - [1.5 4. 规则引擎](#15-4-规则引擎)
    - [1.5.1 规则评估](#151-规则评估)
