# 1 1 1 1 1 1 1 游戏开发行业 - 业务建模详细指南

<!-- TOC START -->
- [1 1 1 1 1 1 1 游戏开发行业 - 业务建模详细指南](#1-1-1-1-1-1-1-游戏开发行业---业务建模详细指南)
  - [1.1 概述](#11-概述)
  - [1.2 1. 业务领域概念建模](#12-1-业务领域概念建模)
    - [1.2.1 核心业务概念](#121-核心业务概念)
      - [1.2.1.1 游戏世界聚合根](#1211-游戏世界聚合根)
      - [1.2.1.2 玩家聚合根](#1212-玩家聚合根)
      - [1.2.1.3 物品系统](#1213-物品系统)
    - [1.2.2 值对象](#122-值对象)
  - [1.3 2. 数据建模](#13-2-数据建模)
    - [1.3.1 数据库设计](#131-数据库设计)
      - [1.3.1.1 玩家相关表](#1311-玩家相关表)
      - [1.3.1.2 游戏世界表](#1312-游戏世界表)
      - [1.3.1.3 物品和技能表](#1313-物品和技能表)
    - [1.3.2 仓储实现](#132-仓储实现)
  - [1.4 3. 流程建模](#14-3-流程建模)
    - [1.4.1 玩家登录流程](#141-玩家登录流程)
    - [1.4.2 战斗流程](#142-战斗流程)
    - [1.4.3 交易流程](#143-交易流程)
    - [1.4.4 流程实现](#144-流程实现)
  - [1.5 4. 游戏规则引擎](#15-4-游戏规则引擎)
    - [1.5.1 规则定义](#151-规则定义)
