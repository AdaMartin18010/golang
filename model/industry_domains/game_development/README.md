...
- [1 1 1 1 1 1 1 游戏开发 (Game Development) - Rust架构指南](#1-1-1-1-1-1-1-游戏开发-game-development-rust架构指南)
  ...
  - [1.3 技术栈选型](#技术栈选型)
    - [1.3.1 核心框架](#核心框架)
- [2 2 2 2 2 2 2 游戏引擎](#2-2-2-2-2-2-2-游戏引擎)
- [3 3 3 3 3 3 3 图形渲染](#3-3-3-3-3-3-3-图形渲染)
- [4 4 4 4 4 4 4 音频](#4-4-4-4-4-4-4-音频)
- [5 5 5 5 5 5 5 物理引擎](#5-5-5-5-5-5-5-物理引擎)
- [6 6 6 6 6 6 6 网络](#6-6-6-6-6-6-6-网络)
- [7 7 7 7 7 7 7 序列化](#7-7-7-7-7-7-7-序列化)
    - [7 7 7 7 7 7 7 行业特定库](#7-7-7-7-7-7-7-行业特定库)
- [8 8 8 8 8 8 8 数学库](#8-8-8-8-8-8-8-数学库)
- [9 9 9 9 9 9 9 资源管理](#9-9-9-9-9-9-9-资源管理)
- [10 10 10 10 10 10 10 输入处理](#10-10-10-10-10-10-10-输入处理)
- [11 11 11 11 11 11 11 调试和性能](#11-11-11-11-11-11-11-调试和性能)
  - [11.1 架构模式](#架构模式)
    - [11.1.1 1. ECS架构 (Entity-Component-System)](#1-ecs架构-entity-component-system)
    - [11.1.2 2. 客户端-服务器架构](#2-客户端-服务器架构)
    - [11.1.3 3. 状态同步模式](#3-状态同步模式)
  - [11.2 业务领域建模](#业务领域建模)
    - [11.2.1 核心游戏概念](#核心游戏概念)
    - [11.2.2 游戏逻辑组件](#游戏逻辑组件)
  - [11.3 数据建模](#数据建模)
    - [11.3.1 游戏数据存储](#游戏数据存储)
    - [11.3.2 网络数据模型](#网络数据模型)
  - [11.4 流程建模](#流程建模)
    - [11.4.1 游戏主循环](#游戏主循环)
    - [11.4.2 多人游戏流程](#多人游戏流程)
  - [11.5 组件建模](#组件建模)
    - [11.5.1 渲染系统](#渲染系统)
    - [11.5.2 音频系统](#音频系统)
    - [11.5.3 物理系统](#物理系统)
  ...
  - [11.9 部署和发布](#部署和发布)
    - [11.9.1 构建配置](#构建配置)
- [12 12 12 12 12 12 12 Cargo.toml](#12-12-12-12-12-12-12-cargotoml)
- [13 13 13 13 13 13 13 开发依赖](#13-13-13-13-13-13-13-开发依赖)
    - [13 13 13 13 13 13 13 跨平台构建](#13-13-13-13-13-13-13-跨平台构建)
  - [13.1 总结](#总结)
<!-- TOC END -->
...
### 11.1.1 1. ECS架构 (Entity-Component-System)
