...
- [1 1 1 1 1 1 1 游戏开发 (Game Development) - Rust架构指南](#1-1-1-1-1-1-1-游戏开发-game-development---rust架构指南)
  ...
  - [11.1 架构模式](#111-架构模式)
    - [11.1.1 1. ECS架构 (Entity-Component-System)](#1111-1-ecs架构-entity-component-system)
    - [11.1.2 2. 客户端-服务器架构](#1112-2-客户端-服务器架构)
    - [11.1.3 3. 状态同步模式](#1113-3-状态同步模式)
  - [11.2 业务领域建模](#112-业务领域建模)
    - [11.2.1 核心游戏概念](#1121-核心游戏概念)
    - [11.2.2 游戏逻辑组件](#1122-游戏逻辑组件)
  - [11.3 数据建模](#113-数据建模)
    - [11.3.1 游戏数据存储](#1131-游戏数据存储)
    - [11.3.2 网络数据模型](#1132-网络数据模型)
  - [11.4 流程建模](#114-流程建模)
    - [11.4.1 游戏主循环](#1141-游戏主循环)
    - [11.4.2 多人游戏流程](#1142-多人游戏流程)
  - [11.5 组件建模](#115-组件建模)
    - [11.5.1 渲染系统](#1151-渲染系统)
    - [11.5.2 音频系统](#1152-音频系统)
    - [11.5.3 物理系统](#1153-物理系统)
  - [11.6 性能优化](#116-性能优化)
    - [11.6.1 内存管理](#1161-内存管理)
    - [11.6.2 渲染优化](#1162-渲染优化)
  - [11.7 网络优化](#117-网络优化)
    - [11.7.1 预测和回滚](#1171-预测和回滚)
  - [11.8 测试策略](#118-测试策略)
    - [11.8.1 单元测试](#1181-单元测试)
    - [11.8.2 性能测试](#1182-性能测试)
  - [11.9 部署和发布](#119-部署和发布)
    - [11.9.1 构建配置](#1191-构建配置)
