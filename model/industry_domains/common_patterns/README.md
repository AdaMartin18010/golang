...
<!-- TOC START -->
- [通用架构模式 - Rust最佳实践](#通用架构模式---rust最佳实践)
  - [1.1 概述](#11-概述)
  - [1.2 1. 微服务架构模式](#12-1-微服务架构模式)
    - [1.2.1 服务发现](#121-服务发现)
    - [1.2.2 负载均衡](#122-负载均衡)
  - [1.3 2. 事件驱动架构模式](#13-2-事件驱动架构模式)
    - [1.3.1 事件总线](#131-事件总线)
    - [1.3.2 事件溯源](#132-事件溯源)
  - [1.4 3. CQRS模式](#14-3-cqrs模式)
    - [1.4.1 命令处理](#141-命令处理)
    - [1.4.2 查询处理](#142-查询处理)
  - [1.5 4. 仓储模式](#15-4-仓储模式)
    - [1.5.1 通用仓储接口](#151-通用仓储接口)
    - [1.5.2 缓存仓储](#152-缓存仓储)
  - [1.6 5. 工厂模式](#16-5-工厂模式)
    - [1.6.1 抽象工厂](#161-抽象工厂)
    - [1.6.2 对象池](#162-对象池)
  - [1.7 6. 观察者模式](#17-6-观察者模式)
    - [1.7.1 事件观察者](#171-事件观察者)
  - [1.8 7. 策略模式](#18-7-策略模式)
    - [1.8.1 可插拔策略](#181-可插拔策略)
  - [1.9 8. 装饰器模式](#19-8-装饰器模式)
    - [1.9.1 功能装饰器](#191-功能装饰器)
  - [1.10 9. 适配器模式](#110-9-适配器模式)
    - [1.10.1 接口适配](#1101-接口适配)
  - [1.11 10. 模板方法模式](#111-10-模板方法模式)
    - [1.11.1 算法模板](#1111-算法模板)
  - [1.12 总结](#112-总结)
<!-- TOC END -->
