# 1 1 1 1 1 1 1 物流/智慧物流架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 物流/智慧物流架构（Golang国际主流实践）](#1-1-1-1-1-1-1-物流智慧物流架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 物流/智慧物流架构概述](#1-物流智慧物流架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
    - [1.2.2 发展历程与核心思想](#发展历程与核心思想)
    - [1.2.3 典型应用场景](#典型应用场景)
    - [1.2.4 与传统物流IT对比](#与传统物流it对比)
