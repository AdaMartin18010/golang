...
- [📝 文档格式修复详细方案](#文档格式修复详细方案)
  - [🎯 执行方案选择](#执行方案选择)
  - [📋 详细修复项目](#详细修复项目)
- [fix-metadata.ps1](#fix-metadataps1)
- [检测并替换旧格式](#检测并替换旧格式)
- [替换为新格式](#替换为新格式)
- [... 具体替换逻辑](#具体替换逻辑)
- [统一日期格式](#统一日期格式)
- [Go语言基础 - 概念定义体系](#go语言基础-概念定义体系)
- [概念定义体系](#概念定义体系)
- [概念定义体系](#概念定义体系)
- [fix-titles.ps1](#fix-titlesps1)
- [实际标题是: 1. 📖 Go Workspace概述](#实际标题是-1-go-workspace概述)
- [但实际应该是](#但实际应该是)
  - [命令语法](#命令语法)
- [语法](#语法)
- [示例](#示例)
...
- [执行替换](#执行替换)
- [fix-titles.ps1](#fix-titlesps1)
- [check-links.sh](#check-linkssh)
  - [📝 变更日志模板](#变更日志模板)
- [文档格式修复 - 2025-10-29](#文档格式修复-2025-10-29)
  - [修复内容](#修复内容)
  - [影响范围](#影响范围)
  - [测试验证](#测试验证)
  - [后续建议](#后续建议)
