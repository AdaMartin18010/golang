...
|------|---------|---------|---------|------|------|
| **greentea GC** | ❌ | ❌ | ✅ | 实验性 | [文档](../02-Go语言现代化/12-Go-1.23运行时优化/01-greentea-GC垃圾收集器.md) |
| **容器感知调度** | ❌ | ⚠️ 部分 | ✅ | 生产就绪 | [文档](../02-Go语言现代化/12-Go-1.23运行时优化/02-容器感知调度.md) |
| **Swiss Tables Map** | ❌ | ❌ | ✅ | 生产就绪 | [文档](../02-Go语言现代化/12-Go-1.23运行时优化/03-内存分配器优化.md) |
| **Arena 分配器** | ❌ | ⚠️ 实验 | ✅ | 生产就绪 | [文档](../02-Go语言现代化/12-Go-1.23运行时优化/03-内存分配器优化.md) |
| **weak.Pointer** | ❌ | ❌ | ✅ | 生产就绪 | [文档](../02-Go语言现代化/12-Go-1.23运行时优化/03-内存分配器优化.md) |
...
| 特性 | Go 1.23 | Go 1.24 | Go 1.23+ | 状态 | 文档 |
|------|---------|---------|---------|------|------|
| **go build -asan** | ⚠️ 实验 | ⚠️ 实验 | ✅ | 生产就绪 | [文档](../02-Go语言现代化/13-Go-1.23工具链增强/01-go-build-asan内存泄漏检测.md) |
| **go.mod ignore** | ❌ | ❌ | ✅ | 生产就绪 | [文档](../02-Go语言现代化/13-Go-1.23工具链增强/02-go-mod-ignore指令.md) |
| **go doc -http** | ❌ | ❌ | ✅ | 生产就绪 | [文档](../02-Go语言现代化/13-Go-1.23工具链增强/03-go-doc-http工具.md) |
| **go version -m -json** | ❌ | ❌ | ✅ | 生产就绪 | [文档](../02-Go语言现代化/13-Go-1.23工具链增强/04-go-version-m-json.md) |
...
| **HTTP/3 & QUIC** | ❌ | ⚠️ 实验 | ✅ | 生产就绪 | [文档](../02-Go语言现代化/14-Go-1.23并发和网络/03-HTTP3-和-QUIC支持.md) |
| **JSON v2** | ❌ | ❌ | ⚠️ | 实验性 | [文档](../02-Go语言现代化/14-Go-1.23并发和网络/04-JSON-v2库.md) |
...
- 📚 [Go 1.23+ 运行时优化](../02-Go语言现代化/12-Go-1.23运行时优化/README.md)
