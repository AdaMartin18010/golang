...
- [2. 主流开源项目设计模式分析](#2.-主流开源项目设计模式分析)
  - [1. [etcd](https://github.com/etcd-io/etcd) - 分布式键值存储](#1.-etcdhttpsgithubcometcd-ioetcd---分布式键值存储)
  - [2. [gRPC-Go](https://github.com/grpc/grpc-go) - RPC框架](#2.-grpc-gohttpsgithubcomgrpcgrpc-go---rpc框架)
  - [3. [Go kit](https://github.com/go-kit/kit) - 微服务工具包](#3.-go-kithttpsgithubcomgo-kitkit---微服务工具包)
- [3. 工程总结](#3.-工程总结)
- [4. 参考文献](#4.-参考文献)
