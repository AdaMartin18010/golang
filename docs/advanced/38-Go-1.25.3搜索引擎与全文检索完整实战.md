...
- [2. 1. 搜索引擎原理](#1-搜索引擎原理)
- [3. 2. 倒排索引](#2-倒排索引)
- [4. 3. Bleve本地搜索](#3-bleve本地搜索)
- [5. 4. Elasticsearch集成](#4-elasticsearch集成)
- [6. 5. 中文分词](#5-中文分词)
- [7. 6. 相关性排序](#6-相关性排序)
- [8. 7. 向量检索](#7-向量检索)
- [9. 8. 搜索建议](#8-搜索建议)
...
- [Go 1.25.3搜索引擎与全文检索完整实战](#go-1253搜索引擎与全文检索完整实战)
  - [目录](#目录)
  - [1. 搜索引擎原理](#1-搜索引擎原理)
...
> • [Bleve文档](http://blevesearch.com/)  
> • [信息检索导论](https://nlp.stanford.edu/IR-book/)  
> • [搜索引擎原理](https://www.amazon.com/Introduction-Information-Retrieval-Christopher-Manning/dp/0521865719)
