...
- [安装TinyGo (推荐)](#安装tinygo-推荐)
- [macOS](#macos)
- [Linux](#linux)
- [验证安装](#验证安装)
- [或使用标准Go (自带WASM支持)](#或使用标准go-自带wasm支持)
  - [2. TinyGo编译器](#2-tinygo编译器)
- [使用TinyGo编译](#使用tinygo编译)
- [使用标准Go编译](#使用标准go编译)
- [查看文件大小](#查看文件大小)
- [TinyGo: ~45KB](#tinygo-45kb)
- [Go:     ~2.8MB](#go-28mb)
- [获取wasm_exec.js (TinyGo)](#获取wasm_execjs-tinygo)
- [或使用标准Go的wasm_exec.js](#或使用标准go的wasm_execjs)
- [启动HTTP服务器](#启动http服务器)
- [访问 http://localhost:8080](#访问-httplocalhost8080)
  - [3. 浏览器集成](#3-浏览器集成)
  - [4. JavaScript互操作](#4-javascript互操作)
  - [5. DOM操作](#5-dom操作)
  - [6. WebAssembly System Interface](#6-webassembly-system-interface)
- [编译WASI目标](#编译wasi目标)
- [使用wasmtime运行](#使用wasmtime运行)
- [或使用wasmer](#或使用wasmer)
- [编译](#编译)
- [运行 (带参数)](#运行-带参数)
- [带环境变量](#带环境变量)
  - [7. 性能优化](#7-性能优化)
- [TinyGo优化选项](#tinygo优化选项)
- [进一步压缩](#进一步压缩)
- [启用Brotli压缩](#启用brotli压缩)
- [大小对比](#大小对比)
  - [8. 实际应用](#8-实际应用)
  - [9. 调试与测试](#9-调试与测试)
- [运行WASM测试 (需要Node.js)](#运行wasm测试-需要nodejs)
- [或使用TinyGo](#或使用tinygo)
  - [10. 完整项目示例](#10-完整项目示例)
  - [Code Example](#code-example)
- [Makefile](#makefile)
- [使用TinyGo编译 (推荐)](#使用tinygo编译-推荐)
- [使用标准Go编译](#使用标准go编译)
- [编译WASI CLI](#编译wasi-cli)
- [启动开发服务器](#启动开发服务器)
- [测试](#测试)
- [优化WASM](#优化wasm)
- [清理](#清理)
