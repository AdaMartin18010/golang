...
- [性能调优实战](#性能调优实战)
  - [1. 调优方法论](#1-调优方法论)
  - [2. 识别性能瓶颈](#2-识别性能瓶颈)
- [采集30秒CPU profile](#采集30秒cpu-profile)
- [查看火焰图](#查看火焰图)
- [查看top函数](#查看top函数)
- [采集堆快照](#采集堆快照)
- [分析内存分配](#分析内存分配)
  - [3. CPU优化实战](#3-cpu优化实战)
- [输出显示: strings.ToUpper 占用 35%](#输出显示-stringstoupper-占用-35)
- [time.Now().Format 占用 25%](#timenowformat-占用-25)
- [string concatenation 占用 20%](#string-concatenation-占用-20)
  - [4. 内存优化实战](#4-内存优化实战)
- [采集第一个快照](#采集第一个快照)
- [等待10分钟](#等待10分钟)
- [采集第二个快照](#采集第二个快照)
- [对比差异](#对比差异)
- [查看goroutine数量和堆栈](#查看goroutine数量和堆栈)
  - [5. I/O优化实战](#5-io优化实战)
  - [6. 并发优化实战](#6-并发优化实战)
  - [7. 数据库优化实战](#7-数据库优化实战)
  - [8. 网络优化实战](#8-网络优化实战)
