...
- [🔍 深入理解](#深入理解)
  - [变量作用域分析](#变量作用域分析)
    - [Go 1.21 行为](#go-1-21-行为)
    - [Go 1.22 行为](#go-1-22-行为)
  - [编译器实现](#编译器实现)
- [📊 性能影响](#性能影响)
  - [性能测试](#性能测试)
  - [内存影响](#内存影响)
...
- [🎯 最佳实践](#最佳实践)
  ...
  - [3. 新手友好](#3-新手友好)
- [❓ 常见问题](#常见问题)
  - [Q1: Go 1.22 的改变是否会破坏现有代码？](#q1-go-1-22-的改变是否会破坏现有代码)
  - [Q2: 如何在 Go 1.21 中获得 Go 1.22 的行为？](#q2-如何在-go-1-21-中获得-go-1-22-的行为)
