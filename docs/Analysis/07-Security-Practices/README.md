...
<!-- TOC START -->
- [7.1 安全实践分析框架](#71-安全实践分析框架)
  - [7.1.1 目录](#711-目录)
  - [7.1.2 1. 安全基础](#712-1-安全基础)
    - [7.1.2.1 安全原则](#7121-安全原则)
    - [7.1.2.2 安全威胁分类](#7122-安全威胁分类)
  - [7.1.3 2. 安全模型](#713-2-安全模型)
    - [7.1.3.1 Bell-LaPadula模型](#7131-bell-lapadula模型)
    - [7.1.3.2 Biba模型](#7132-biba模型)
  - [7.1.4 3. 威胁分析](#714-3-威胁分析)
    - [7.1.4.1 威胁建模](#7141-威胁建模)
    - [7.1.4.2 攻击树分析](#7142-攻击树分析)
  - [7.1.5 4. 防护策略](#715-4-防护策略)
    - [7.1.5.1 纵深防御](#7151-纵深防御)
    - [7.1.5.2 零信任模型](#7152-零信任模型)
  - [7.1.6 5. 加密技术](#716-5-加密技术)
    - [7.1.6.1 对称加密](#7161-对称加密)
    - [7.1.6.2 非对称加密](#7162-非对称加密)
  - [7.1.7 6. 身份认证](#717-6-身份认证)
    - [7.1.7.1 多因子认证](#7171-多因子认证)
    - [7.1.7.2 OAuth 2.0](#7172-oauth-20)
  - [7.1.8 7. 访问控制](#718-7-访问控制)
    - [7.1.8.1 RBAC模型](#7181-rbac模型)
    - [7.1.8.2 ABAC模型](#7182-abac模型)
  - [7.1.9 8. 安全监控](#719-8-安全监控)
    - [7.1.9.1 入侵检测](#7191-入侵检测)
    - [7.1.9.2 安全信息与事件管理](#7192-安全信息与事件管理)
  - [7.1.10 9. 最佳实践](#7110-9-最佳实践)
    - [7.1.10.1 安全编码](#71101-安全编码)
    - [7.1.10.2 安全配置](#71102-安全配置)
  - [7.1.11 10. 案例分析](#7111-10-案例分析)
    - [7.1.11.1 Web应用安全](#71111-web应用安全)
    - [7.1.11.2 API安全](#71112-api安全)
  - [7.1.12 参考资料](#7112-参考资料)
<!-- TOC END -->
