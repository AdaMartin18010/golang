# 1 1 1 1 1 1 1 Go 1.25 高级并发编程深度分析

<!-- TOC START -->
- [1 1 1 1 1 1 1 Go 1.25 高级并发编程深度分析](#1-1-1-1-1-1-1-go-125-高级并发编程深度分析)
  - [1.1 目录](#目录)
  - [1.2 GMP调度器深度分析](#gmp调度器深度分析)
    - [1.2.1 GMP模型架构](#gmp模型架构)
      - [1.2.1.1 核心组件](#核心组件)
      - [1.2.1.2 调度器状态机](#调度器状态机)
    - [1.2.2 调度算法深度分析](#调度算法深度分析)
      - [1.2.2.1 工作窃取算法](#工作窃取算法)
      - [1.2.2.2 抢占式调度](#抢占式调度)
    - [1.2.3 性能优化策略](#性能优化策略)
      - [1.2.3.1 缓存友好的调度](#缓存友好的调度)
      - [1.2.3.2 负载均衡优化](#负载均衡优化)
  - [1.3 Channel高级用法](#channel高级用法)
    - [1.3.1 Channel模式与技巧](#channel模式与技巧)
      - [1.3.1.1 管道模式](#管道模式)
      - [1.3.1.2 扇入扇出模式](#扇入扇出模式)
      - [1.3.1.3 超时和取消模式](#超时和取消模式)
    - [1.3.2 Channel性能优化](#channel性能优化)
      - [1.3.2.1 缓冲优化](#缓冲优化)
      - [1.3.2.2 批量处理优化](#批量处理优化)
  - [1.4 总结](#总结)
<!-- TOC END -->
...
- [Go 1.25 高级并发编程深度分析](#go-125-高级并发编程深度分析)
  - [目录](#目录)
  - [GMP调度器深度分析](#gmp调度器深度分析)
    - [1.1 GMP模型架构](#11-gmp模型架构)
      - [1.1.1 核心组件](#111-核心组件)
      - [1.1.2 调度器状态机](#112-调度器状态机)
    - [1.2 调度算法深度分析](#12-调度算法深度分析)
      - [1.2.1 工作窃取算法](#121-工作窃取算法)
      - [1.2.2 抢占式调度](#122-抢占式调度)
    - [1.3 性能优化策略](#13-性能优化策略)
      - [1.3.1 缓存友好的调度](#131-缓存友好的调度)
      - [1.3.2 负载均衡优化](#132-负载均衡优化)
  - [Channel高级用法](#channel高级用法)
    - [2.1 Channel模式与技巧](#21-channel模式与技巧)
      - [2.1.1 管道模式](#211-管道模式)
      - [2.1.2 扇入扇出模式](#212-扇入扇出模式)
      - [2.1.3 超时和取消模式](#213-超时和取消模式)
    - [2.2 Channel性能优化](#22-channel性能优化)
      - [2.2.1 缓冲优化](#221-缓冲优化)
      - [2.2.2 批量处理优化](#222-批量处理优化)
  - [总结](#总结)
