...
- [3.3.1 观察者模式 (Observer Pattern)](#331-观察者模式-observer-pattern)
  ...
  - [3.3.1.4 3. Go语言实现](#3314-3-go语言实现)
    - [3.3.1.4.1 基础观察者模式](#33141-基础观察者模式)
    - [3.3.1.4.2 事件驱动观察者模式](#33142-事件驱动观察者模式)
    - [3.3.1.4.3 股票价格观察者模式](#33143-股票价格观察者模式)
  - [3.3.1.5 4. 工程案例](#3315-4-工程案例)
    - [3.3.1.5.1 配置管理观察者模式](#33151-配置管理观察者模式)
    - [3.3.1.5.2 用户状态观察者模式](#33152-用户状态观察者模式)
