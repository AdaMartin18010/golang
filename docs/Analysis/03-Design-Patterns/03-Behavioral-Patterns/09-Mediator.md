...
- [3.3.1 中介者模式 (Mediator Pattern)](#331-中介者模式-mediator-pattern)
  ...
  - [3.3.1.3 2. 形式化定义](#3313-2-形式化定义)
    ...
    - [3.3.1.3.2 中介者代数](#33132-中介者代数)
    - [3.3.1.3.3 中介者公理](#33133-中介者公理)
  - [3.3.1.4 3. 结构分析](#3314-3-结构分析)
    - [3.3.1.4.1 UML类图](#33141-uml类图)
    - [3.3.1.4.2 时序图](#33142-时序图)
    - [3.3.1.4.3 中介者通信流图](#33143-中介者通信流图)
    - [3.3.1.4.4 中介者类型分析](#33144-中介者类型分析)
  - [3.3.1.5 4. Golang实现](#3315-4-golang实现)
    - [3.3.1.5.1 基本实现](#33151-基本实现)
    - [3.3.1.5.2 事件驱动中介者](#33152-事件驱动中介者)
    - [3.3.1.5.3 协调者中介者](#33153-协调者中介者)
    - [3.3.1.5.4 中介者与通道结合](#33154-中介者与通道结合)
  ...
  - [3.3.1.7 6. 应用场景](#3317-6-应用场景)
    - [3.3.1.7.1 图形用户界面](#33171-图形用户界面)
    - [3.3.1.7.2 聊天系统](#33172-聊天系统)
    - [3.3.1.7.3 交通控制系统](#33173-交通控制系统)
    - [3.3.1.7.4 前端框架](#33174-前端框架)
  ...
  - [3.3.1.9 8. 案例分析](#3319-8-案例分析)
    - [3.3.1.9.1 智能家居控制系统](#33191-智能家居控制系统)
    - [3.3.1.9.2 聊天服务器](#33192-聊天服务器)
    - [3.3.1.9.3 空中交通管制系统](#33193-空中交通管制系统)
<!-- TOC END -->
