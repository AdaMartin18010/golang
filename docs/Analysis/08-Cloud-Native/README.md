# 8.1 云原生分析（Cloud Native Analysis）

<!-- TOC START -->
- [8.1 云原生分析（Cloud Native Analysis）](#云原生分析（cloud-native-analysis）)
  - [8.1.1 目录](#目录)
  - [8.1.2 1. 云原生基础理论](#1-云原生基础理论)
    - [8.1.2.1 定义](#定义)
    - [8.1.2.2 核心原则](#核心原则)
    - [8.1.2.3 技术栈](#技术栈)
  - [8.1.3 2. 容器化与编排技术](#2-容器化与编排技术)
    - [8.1.3.1 容器化基础](#容器化基础)
    - [8.1.3.2 Kubernetes编排](#kubernetes编排)
- [8.2 典型的Kubernetes部署配置](#典型的kubernetes部署配置)
    - [8.2 Golang容器化实践](#golang容器化实践)
  - [8.2.1 3. 微服务与服务网格](#3-微服务与服务网格)
    - [8.2.1.1 微服务架构](#微服务架构)
    - [8.2.1.2 服务网格](#服务网格)
    - [8.2.1.3 Golang微服务实现](#golang微服务实现)
  - [8.2.2 4. Golang云原生实践](#4-golang云原生实践)
    - [8.2.2.1 健康检查](#健康检查)
    - [8.2.2.2 配置管理](#配置管理)
    - [8.2.2.3 日志和监控](#日志和监控)
  - [8.2.3 5. 多表征内容](#5-多表征内容)
    - [8.2.3.1 云原生架构图](#云原生架构图)
    - [8.2.3.2 性能模型](#性能模型)
    - [8.2.3.3 扩展性分析](#扩展性分析)
