...
<!-- TOC START -->
- [11.4.1 大数据领域分析](#大数据领域分析)
  - [11.4.1.1 目录](#目录)
  - [11.4.1.2 概述](#概述)
    - [11.4.1.2.1 核心特征](#核心特征)
  - [11.4.1.3 形式化定义](#形式化定义)
    - [11.4.1.3.1 大数据系统定义](#大数据系统定义)
    - [11.4.1.3.2 分布式计算模型](#分布式计算模型)
  - [11.4.1.4 数据处理架构](#数据处理架构)
    - [11.4.1.4.1 数据模型](#数据模型)
    - [11.4.1.4.2 数据处理引擎](#数据处理引擎)
  - [11.4.1.5 分布式计算](#分布式计算)
    - [11.4.1.5.1 MapReduce实现](#mapreduce实现)
  - [11.4.1.6 流处理](#流处理)
    - [11.4.1.6.1 流处理引擎](#流处理引擎)
  - [11.4.1.7 最佳实践](#最佳实践)
