...
<!-- TOC START -->
- [11.4.1 云基础设施领域分析](#云基础设施领域分析)
  - [11.4.1.1 目录](#目录)
  - [11.4.1.2 概述](#概述)
    - [11.4.1.2.1 核心特征](#核心特征)
  - [11.4.1.3 形式化定义](#形式化定义)
    - [11.4.1.3.1 云基础设施系统定义](#云基础设施系统定义)
    - [11.4.1.3.2 编排系统定义](#编排系统定义)
  - [11.4.1.4 云架构](#云架构)
    - [11.4.1.4.1 节点管理](#节点管理)
    - [11.4.1.4.2 调度器](#调度器)
  - [11.4.1.5 容器编排](#容器编排)
    - [11.4.1.5.1 服务定义](#服务定义)
    - [11.4.1.5.2 负载均衡](#负载均衡)
  - [11.4.1.6 服务网格](#服务网格)
    - [11.4.1.6.1 代理管理](#代理管理)
  - [11.4.1.7 最佳实践](#最佳实践)
