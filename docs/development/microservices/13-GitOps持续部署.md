...
- [1. 创建命名空间](#1-创建命名空间)
- [2. 安装ArgoCD](#2-安装argocd)
- [3. 暴露UI（LoadBalancer）](#3-暴露uiloadbalancer)
- [4. 获取初始密码](#4-获取初始密码)
- [5. 登录CLI](#5-登录cli)
...
- [1. 安装Sealed Secrets](#1-安装sealed-secrets)
- [2. 创建加密Secret](#2-创建加密secret)
- [3. 提交到Git](#3-提交到git)
  - [13.6 📊 监控与告警](#136-监控与告警)
- [ArgoCD指标](#argocd指标)
- [ArgoCD通知配置](#argocd通知配置)
  - [13.7 💻 实战案例](#137-实战案例)
