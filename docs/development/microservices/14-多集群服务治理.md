...
- [集群1配置](#集群1配置)
- [集群2配置](#集群2配置)
- [配置跨集群Secret](#配置跨集群secret)
- [安装Submariner Broker](#安装submariner-broker)
- [加入集群1](#加入集群1)
- [加入集群2](#加入集群2)
- [导出服务](#导出服务)
- [创建VPC Peering连接](#创建vpc-peering连接)
  - [14.3 🔍 服务发现与注册](#143-服务发现与注册)
- [Consul配置](#consul配置)
  - [14.4 🚦 流量管理](#144-流量管理)
  - [14.5 💾 数据同步与一致性](#145-数据同步与一致性)
- [创建Active-Active数据库](#创建active-active数据库)
  - [14.6 🛡️ 高可用与容灾](#146-️-高可用与容灾)
- [安装Velero](#安装velero)
- [创建定期备份](#创建定期备份)
- [跨集群恢复](#跨集群恢复)
- [模拟集群故障](#模拟集群故障)
- [验证流量自动切换到cluster2](#验证流量自动切换到cluster2)
- [监控流量分布](#监控流量分布)
  - [14.7 📊 监控与可观测性](#147-监控与可观测性)
- [全局Prometheus配置](#全局prometheus配置)
  - [14.8 💰 成本优化](#148-成本优化)
  - [14.9 🎯 最佳实践](#149-最佳实践)
