...
- [Go 1.26 微服务优化](#go-1253-微服务优化)
  - [📋 目录](#-目录)
  - [🚀 Go 1.26 微服务新特性概览](#-go-1253-微服务新特性概览)
    - [核心特性更新](#核心特性更新)
    - [性能提升数据](#性能提升数据)
    - [企业级应用场景](#企业级应用场景)
  - [📚 理论分析](#-理论分析)
    - [JSON v2在微服务中的应用](#json-v2在微服务中的应用)
      ...
      - [Go 1.26 JSON v2优化](#go-1253-json-v2优化)
...
type MessageQueue struct {
    mu      sync.RWMutex
    queues  map[string]Channel []byte
    logger  *slog.Logger
}
...
func NewMessageQueue() *MessageQueue {
    ...
    return &MessageQueue{
        queues: make(map[string]Channel []byte),
        logger: logger,
    }
}
...
func (mq *MessageQueue) CreateQueue(name string, size int) {
    ...
    mq.queues[name] = make(Channel []byte, size)
...
A: 使用Go 1.26的`MessageSigner`接口，ECDSA和Ed25519性能提升4-5倍，同时保证通信安全性。
