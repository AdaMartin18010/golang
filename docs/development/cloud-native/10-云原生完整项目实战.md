...
- [第一部分：应用程序代码](#第一部分应用程序代码)
  ...
  - [1.3 数据库层](#1.3-数据库层)
  - [1.4 服务层](#1.4-服务层)
  - [1.5 HTTP处理器](#1.5-http处理器)
  - [1.6 中间件](#1.6-中间件)
  - [1.7 配置管理](#1.7-配置管理)
- [第二部分：容器化配置](#第二部分容器化配置)
  - [2.1 Dockerfile](#2.1-dockerfile)
  - [2.2 .dockerignore](#2.2-.dockerignore)
  - [2.3 Docker Compose (本地开发)](#2.3-docker-compose-本地开发)
- [第三部分：Kubernetes部署](#第三部分kubernetes部署)
  - [3.1 命名空间](#3.1-命名空间)
  - [3.2 ConfigMap](#3.2-configmap)
  - [3.3 Secret](#3.3-secret)
  - [3.4 PostgreSQL部署](#3.4-postgresql部署)
  - [3.5 Redis部署](#3.5-redis部署)
  - [3.6 应用程序部署](#3.6-应用程序部署)
  - [3.7 Service](#3.7-service)
  - [3.8 Ingress](#3.8-ingress)
  - [3.9 HPA (水平自动扩展)](#3.9-hpa-水平自动扩展)
- [第四部分：CI/CD流水线](#第四部分cicd流水线)
  - [4.1 GitHub Actions](#4.1-github-actions)
  - [4.2 Makefile](#4.2-makefile)
- [第五部分：可观测性](#第五部分可观测性)
  - [5.1 Prometheus监控](#5.1-prometheus监控)
  - [5.2 Grafana仪表板](#5.2-grafana仪表板)
  - [5.3 Jaeger分布式追踪](#5.3-jaeger分布式追踪)
- [第六部分：Helm Chart](#第六部分helm-chart)
  - [6.1 Chart结构](#6.1-chart结构)
  - [6.2 Chart.yaml](#6.2-chart.yaml)
  - [6.3 values.yaml](#6.3-values.yaml)
  - [6.4 部署模板](#6.4-部署模板)
- [第七部分：部署指南](#第七部分部署指南)
  - [7.1 前置要求](#7.1-前置要求)
  - [7.2 本地开发](#7.2-本地开发)
  - [7.3 Kubernetes部署](#7.3-kubernetes部署)
  - [7.4 使用Helm部署](#7.4-使用helm部署)
  - [7.5 验证部署](#7.5-验证部署)
