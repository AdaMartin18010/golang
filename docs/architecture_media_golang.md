# 1 1 1 1 1 1 1 媒体/智慧媒体架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 媒体/智慧媒体架构（Golang国际主流实践）](#1-1-1-1-1-1-1-媒体智慧媒体架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 媒体/智慧媒体架构概述](#1-媒体智慧媒体架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
    - [1.2.2 发展历程与核心思想](#发展历程与核心思想)
    - [1.2.3 典型应用场景](#典型应用场景)
    - [1.2.4 与传统媒体IT对比](#与传统媒体it对比)
