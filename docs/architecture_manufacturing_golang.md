# 1 1 1 1 1 1 1 制造业/智能制造架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 制造业/智能制造架构（Golang国际主流实践）](#1-1-1-1-1-1-1-制造业智能制造架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 制造业/智能制造架构概述](#1-制造业智能制造架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
    - [1.2.2 发展历程与核心思想](#发展历程与核心思想)
    - [1.2.3 典型应用场景](#典型应用场景)
    - [1.2.4 与传统制造IT对比](#与传统制造it对比)
  ...
  - [1.7 6. 形式化建模与证明](#6-形式化建模与证明)
    - [1.7.1 产品-订单-生产建模](#产品-订单-生产建模)
      - [1.7.1.1 性质1：智能调度性](#性质1：智能调度性)
