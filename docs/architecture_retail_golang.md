# 1 1 1 1 1 1 1 零售/智慧零售架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 零售/智慧零售架构（Golang国际主流实践）](#1-1-1-1-1-1-1-零售智慧零售架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 零售/智慧零售架构概述](#1-零售智慧零售架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
    - [1.2.2 发展历程与核心思想](#发展历程与核心思想)
    - [1.2.3 典型应用场景](#典型应用场景)
    - [1.2.4 与传统零售IT对比](#与传统零售it对比)
  ...
  - [1.7 6. 形式化建模与证明](#6-形式化建模与证明)
    - [1.7.1 商品-订单-会员建模](#商品-订单-会员建模)
      - [1.7.1.1 性质1：智能推荐性](#性质1：智能推荐性)
