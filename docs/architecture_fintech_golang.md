# 1 1 1 1 1 1 1 金融科技/智慧金融架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 金融科技/智慧金融架构（Golang国际主流实践）](#1-1-1-1-1-1-1-金融科技智慧金融架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 金融科技/智慧金融架构概述](#1-金融科技智慧金融架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
    - [1.2.2 发展历程与核心思想](#发展历程与核心思想)
    - [1.2.3 典型应用场景](#典型应用场景)
    - [1.2.4 与传统金融IT对比](#与传统金融it对比)
  ...
  - [1.7 6. 形式化建模与证明](#6-形式化建模与证明)
    - [1.7.1 账户-支付-风控建模](#账户-支付-风控建模)
      - [1.7.1.1 性质1：智能风控性](#性质1：智能风控性)
