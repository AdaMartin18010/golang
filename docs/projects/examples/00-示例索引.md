...
- [📋 完整示例分类](#完整示例分类)
  ...
  - [📊 可观测性](#可观测性)
- [🚀 快速开始](#快速开始)
  - [1️⃣ 运行[1️⃣ 运行所有测试](#1-运行所有测试)️⃣ 推荐学[2️⃣ 推荐学习路径](#2-推荐学习路径)新手入门（1-2小时）](#新手入门1-2小时)
    - [进阶学习（3-5小时）](#进阶学习3-5小时)
    - [高级专题（5-10小时）](#高级专题5-10小时)
  - [3️⃣ 按场景使[3️⃣ 按场景使用](#3-按场景使用)景1: 学习并发编程](#场景1-学习并发编程)
    - [场景2: 学习Go 1.25新特性](#场景2-学习go-1-25新特性)
