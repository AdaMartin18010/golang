...
- [⭐ Featured Examples](#featured-examples)
  ...
  - [Modern[Modern Features](#modern-features)[1. New Features Deep Dive](#1.-new-features-deep-dive)
...
- [🚀 Quick Start](#quick-start)
  - [1️⃣ Run All T[1️⃣ Run All Tests](#1-run-all-tests)mmende[2️⃣ Recommended Learning Path](#2-recommended-learning-path)r (1-2 hours)](#beginner-1-2-hours)
    - [Intermediate (3-5 hours)](#intermediate-3-5-hours)
    - [Advanced (5-10 hours)](#advanced-5-10-hours)
  - [3️⃣ Use by Scen[3️⃣ Use by Scenario](#3-use-by-scenario) 1: Learning Concurrency](#scenario-1-learning-concurrency)
