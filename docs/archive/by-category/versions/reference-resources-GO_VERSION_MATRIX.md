...
- [Go 版本兼容性矩阵](#go-版本兼容性矩阵)
  - [版本支持说明](#版本支持说明)
  - [Go 1.26+ 新特性矩阵](#go-126-新特性矩阵)
  - [功能兼容性](#功能兼容性)
  - [迁移指南](#迁移指南)
- [下载 Go 1.26](#下载-go-123)
- [验证版本](#验证版本)
- [应显示: go version go1.23.0 ...](#应显示-go-version-go1230)
- [更新 go 版本](#更新-go-版本)
- [更新依赖](#更新依赖)
- [清理缓存](#清理缓存)
- [重新编译](#重新编译)
- [运行测试](#运行测试)
- [运行基准测试](#运行基准测试)
- [对比 Go 1.24](#对比-go-124)
- [预期: 5-20% 性能提升](#预期-5-20-性能提升)
  - [常见问题](#常见问题)
  - [版本支持策略](#版本支持策略)
  - [参考资料](#参考资料)
...
| 特性 | Go 1.23 | Go 1.24 | Go 1.26 | 状态 | 文档 |
|------|---------|---------|---------|------|------|
...
- 更仔细地测试 (跨越两个大版本)
- 查看 Go 1.26 和 1.25 的 Release Notes
- 关注破坏性变更 (如有)
...
- 📘 [Go 1.26 Release Notes](https://go.dev/doc/go1.24)
