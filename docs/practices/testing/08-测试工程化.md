...
- [Lint](#lint)
  - [3. 测试报告](#3-测试报告)
- [覆盖率报告](#覆盖率报告)
- [使用gotestsum生成更好的报告](#使用gotestsum生成更好的报告)
- [.github/workflows/test.yml](#githubworkflowstestyml)
- [安装sonar-scanner](#安装sonar-scanner)
- [运行分析](#运行分析)
  - [4. 质量门禁](#4-质量门禁)
- [脚本：check-coverage.sh](#脚本check-coveragesh)
- [.github/workflows/qa.yml](#githubworkflowsqayml)
- [修改代码](#修改代码)
  - [5. 最佳实践](#5-最佳实践)
- [本地开发：只运行单元测试](#本地开发只运行单元测试)
- [PR检查：单元测试 + 集成测试](#pr检查单元测试-集成测试)
- [发布前：所有测试](#发布前所有测试)
  - [🔗 相关资源](#相关资源)
