...
- [docker-compose.yml](#docker-composeyml)
  - [6. 部署策略](#6-部署策略)
- [k8s/blue-green-deployment.yaml](#k8sblue-green-deploymentyaml)
- [k8s/canary-deployment.yaml](#k8scanary-deploymentyaml)
  - [7. 最佳实践](#7-最佳实践)
