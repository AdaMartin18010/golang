...
- [1. 测试相关概念](#1-测试相关概念)
  - [1.1 测试金字塔 (Test Pyramid)](#1-1-测试金字塔-test-pyramid)
  - [1.2 表格驱动测试 (Table-Driven Tests)](#1-2-表格驱动测试-table-driven-tests)
  - [1.3 Mock (模拟对象)](#1-3-mock-模拟对象)
  - [1.4 测试覆盖率 (Test Coverage)](#1-4-测试覆盖率-test-coverage)
- [2. 代码质量概念](#2-代码质量概念)
  - [2.1 静态分析 (Static Analysis)](#2-1-静态分析-static-analysis)
  - [2.2 代码审查 (Code Review)](#2-2-代码审查-code-review)
- [3. CI/CD概念](#3-cicd概念)
  - [3.1 持续集成 (Continuous Integration)](#3-1-持续集成-continuous-integration)
  - [3.2 持续部署 (Continuous Deployment)](#3-2-持续部署-continuous-deployment)
- [4. 日志相关概念](#4-日志相关概念)
  - [4.1 结构化日志 (Structured Logging)](#4-1-结构化日志-structured-logging)
  - [4.2 日志级别 (Log Levels)](#4-2-日志级别-log-levels)
- [5. 错误处理概念](#5-错误处理概念)
  - [5.1 错误包装 (Error Wrapping)](#5-1-错误包装-error-wrapping)
  - [5.2 哨兵错误 (Sentinel Errors)](#5-2-哨兵错误-sentinel-errors)
- [6. 项目组织概念](#6-项目组织概念)
  - [6.1 标准项目布局](#6-1-标准项目布局)
  - [6.2 分层架构 (Layered Architecture)](#6-2-分层架构-layered-architecture)
- [🔗 相关文档](#相关文档)
