...
- [service-clusterip.yaml](#service-clusteripyaml)
- [service-nodeport.yaml](#service-nodeportyaml)
- [service-lb.yaml](#service-lbyaml)
...
- [从文件创建](#从文件创建)
  - [5. 健康检查](#5-健康检查)
  - [6. 最佳实践](#6-最佳实践)
- [complete-deployment.yaml](#complete-deploymentyaml)
- [优雅关闭](#优雅关闭)
- [安全上下文](#安全上下文)
- [环境变量](#环境变量)
- [资源限制](#资源限制)
...
- [开发环境](#开发环境)
- [生产环境](#生产环境)
- [创建Helm chart](#创建helm-chart)
- [目录结构](#目录结构)
- [安装](#安装)
- [升级](#升级)
- [回滚](#回滚)
- [卸载](#卸载)
- [values-dev.yaml](#values-devyaml)
- [values-prod.yaml](#values-prodyaml)
- [开发环境](#开发环境)
- [生产环境](#生产环境)
- [ServiceMonitor for Prometheus](#servicemonitor-for-prometheus)
- [使用fluentd收集日志](#使用fluentd收集日志)
  - [🎯 常用命令](#常用命令)
- [创建资源](#创建资源)
- [查看资源](#查看资源)
- [日志](#日志)
