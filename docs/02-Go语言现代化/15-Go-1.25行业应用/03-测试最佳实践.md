...
// Go 1.24: 15 ns/op
// Go 1.25: 10 ns/op (Swiss Tables: +50% faster)
```
...
### Q1: Go 1.25 的 testing/synctest 是否必须使用？
...
- 📚 [testing/synctest 包](../14-Go-1.25并发和网络/02-testing-synctest包.md)
