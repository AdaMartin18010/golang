...
- [第一部分：性能优化理论基础](#第一部分性能优化理论基础)
  ...
  - [1.3 性能优化流程](#13-性能优化流程)
- [第二部分：pprof工具原理深入](#第二部分pprof工具原理深入)
  - [2.1 pprof架构与实现](#21-pprof架构与实现)
  - [2.2 采样算法详解](#22-采样算法详解)
  - [2.3 Profile类型详解](#23-profile类型详解)
- [第三部分：pprof完整工具链](#第三部分pprof完整工具链)
  - [3.1 pprof命令行用法](#31-pprof命令行用法)
  - [3.2 火焰图生成与分析](#32-火焰图生成与分析)
  - [3.3 go tool trace时间线分析](#33-go-tool-trace时间线分析)
  - [3.4 benchstat性能对比](#34-benchstat性能对比)
- [第四部分：实战案例](#第四部分实战案例)
  - [4.1 案例1：QPS下降10倍问题排查](#41-案例1qps下降10倍问题排查)
  - [4.2 案例2：内存泄漏排查与修复](#42-案例2内存泄漏排查与修复)
  - [4.3 案例3：GC压力优化实战](#43-案例3gc压力优化实战)
- [第五部分：进阶主题](#第五部分进阶主题)
  - [5.1 逃逸分析与优化](#51-逃逸分析与优化)
  - [5.2 内存对齐与CPU缓存](#52-内存对齐与cpu缓存)
  - [5.3 零拷贝技术](#53-零拷贝技术)
  - [5.4 SIMD优化](#54-simd优化)
- [第六部分：最佳实践](#第六部分最佳实践)
  - [6.1 性能优化Checklist](#61-性能优化checklist)
  - [6.2 常见陷阱](#62-常见陷阱)
  - [6.3 性能预算](#63-性能预算)
  - [6.4 持续性能监控](#64-持续性能监控)
<!-- TOC END -->
