...
- [Effective Go](https://go.dev/doc/effective_go) - 标准库最佳实践
- [Go by Example](https://gobyexample.com/) - 标准库示例

### 相关章节

- [并发编程](../concurrency/) - sync, Context包详解
- [错误处理](../error-handling/) - errors包详解
- [测试](../testing/) - testing包详解

### 深入主题

- [HTTP编程](../../development/web/03-HTTP服务器.md) - net/http详解
- [HTTP深度指南](../../development/web/00-HTTP编程深度实战指南.md) - HTTP完整实战
- [Web开发](../../development/web/) - Web开发详解

### 实战案例

- [Web开发实战](../../development/web/) - HTTP服务完整示例
- [数据库编程](../../development/database/) - 数据库操作实战
- [微服务开发](../../development/microservices/) - 微服务架构实战
