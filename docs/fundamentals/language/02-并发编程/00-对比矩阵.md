...
- [3. 同步原语对比](#3.-同步原语对比)
  - [3.1 sync.Mutex vs sync.RWMutex](#31-sync.mutex-vs-sync.rwmutex)
  - [3.2 sync.WaitGroup vs Context](#32-sync.waitgroup-vs-context)
  - [3.3 sync.Once vs init函数](#33-sync.once-vs-init函数)
  - [3.4 atomic vs Mutex](#34-atomic-vs-mutex)
- [4. 控制机制对比](#4.-控制机制对比)
  - [4.1 Select vs Switch](#41-select-vs-switch)
  - [4.2 Context.WithCancel vs Context.WithTimeout](#42-context.withcancel-vs-context.withtimeout)
- [5. 并发模式对比](#5.-并发模式对比)
