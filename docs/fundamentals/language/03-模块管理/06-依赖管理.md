...
- [版本范围](#版本范围)
  - [3. 🔄 更新依赖](#3-更新依赖)
- [更新到最新版本](#更新到最新版本)
- [更新到最新次版本（推荐）](#更新到最新次版本推荐)
- [更新到特定版本](#更新到特定版本)
- [更新所有直接依赖](#更新所有直接依赖)
- [更新所有依赖（包括间接）](#更新所有依赖包括间接)
- [仅更新补丁版本（安全）](#仅更新补丁版本安全)
- [查看所有依赖的可用更新](#查看所有依赖的可用更新)
- [输出示例：](#输出示例)
- [github.com/gin-gonic/gin v1.9.1 [v1.10.0]](#githubcomgin-gonicgin-v191-v1100)
- [↑ 当前  ↑ 可用](#当前-可用)
  - [4. 🔧 依赖替换](#4-依赖替换)
- [项目结构](#项目结构)
- [在myproject中](#在myproject中)
- [创建工作区](#创建工作区)
- [go.work内容](#gowork内容)
  - [5. ⚠️ 依赖冲突](#5-️-依赖冲突)
- [查看依赖树](#查看依赖树)
...
- [输出示例：](#输出示例)
- [github.com/myproject](#githubcommyproject)
- [github.com/dep1](#githubcomdep1)
- [github.com/dep2](#githubcomdep2)
- [github.com/some/package](#githubcomsomepackage)
  - [6. 🧹 依赖清理](#6-依赖清理)
- [自动清理](#自动清理)
- [验证清理结果](#验证清理结果)
- [清理所有缓存](#清理所有缓存)
- [清理特定模块](#清理特定模块)
- [预下载依赖（用于CI/CD）](#预下载依赖用于cicd)
- [下载特定依赖](#下载特定依赖)
  - [7. 🎯 最佳实践](#7-最佳实践)
- [每次修改依赖后](#每次修改依赖后)
- [每月检查更新](#每月检查更新)
- [更新补丁版本](#更新补丁版本)
- [创建vendor目录](#创建vendor目录)
- [使用vendor构建](#使用vendor构建)
- [.github/workflows/go.yml](#githubworkflowsgoyml)
- [检查已知漏洞](#检查已知漏洞)
- [或使用](#或使用)
