...
- [第三部分: 泛型与约束](#第三部分-泛型与约束)
  - [3.1 泛型类型 (Go 1.18+)](#31-泛型类型-go-1.18)
...
- [第六部分: Go 1.25.3类型系统扩展](#第六部分-go-1.25.3类型系统扩展)
  - [6.1 泛型类型别名 (Go 1.25.3)](#61-泛型类型别名-go-1.25.3)
  - [6.2 循环变量作用域改进 (Go 1.25.3)](#62-循环变量作用域改进-go-1.25.3)
  - [6.3 range-over-func迭代器 (Go 1.25.3优化)](#63-range-over-func迭代器-go-1.25.3优化)
