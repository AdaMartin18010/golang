...
- [1. 📖 使用说明](#-使用说明)
- [2. 1️⃣ 语义模型快速参考](#1️-语义模型快速参考)
- [3. 2️⃣ CSP并发模型快速参考](#2️-csp并发模型快速参考)
- [4. 3️⃣ 类型系统快速参考](#3️-类型系统快速参考)
- [5. 4️⃣ 包管理模型快速参考](#4️-包管理模型快速参考)
- [6. 5️⃣ 运行时与内存模型快速参考](#5️-运行时与内存模型快速参考)
- [7. 6️⃣ Go 1.25.3新特性快速参考](#6️-go-1253新特性快速参考)
- [8. 7️⃣ 常用证明技巧](#7️-常用证明技巧)
- [9. 📊 重要定理速查](#-重要定理速查)
- [10. 🔧 实用工具速查](#-实用工具速查)
- [11. 📚 延伸阅读快速索引](#-延伸阅读快速索引)
- [12. 💡 使用建议](#-使用建议)
- [13. 🎯 关键概念速记卡](#-关键概念速记卡)
