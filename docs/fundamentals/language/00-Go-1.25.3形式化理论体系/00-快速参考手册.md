...
- [Go 1.25.3形式化理论快速参考手册](#go-1253形式化理论快速参考手册)
  - [📖 使用说明](#使用说明)
  - [1️⃣ 语义模型快速参考](#1️-语义模型快速参考)
- [CFG构造](#cfg构造)
  - [2️⃣ CSP并发模型快速参考](#2️-csp并发模型快速参考)
  - [3️⃣ 类型系统快速参考](#3️-类型系统快速参考)
  - [4️⃣ 包管理模型快速参考](#4️-包管理模型快速参考)
  - [5️⃣ 运行时与内存模型快速参考](#5️-运行时与内存模型快速参考)
  - [6️⃣ Go 1.25.3新特性快速参考](#6️-go-1253新特性快速参考)
  - [7️⃣ 常用证明技巧](#7️-常用证明技巧)
  - [📊 重要定理速查](#重要定理速查)
  - [🔧 实用工具速查](#实用工具速查)
  - [📚 延伸阅读快速索引](#延伸阅读快速索引)
  - [💡 使用建议](#使用建议)
