...
- [第一部分: 语法形式化](#第一部分-语法形式化)
  - [1.1 EBNF完整语法](#1.1-ebnf完整语法)
    - [程序结构](#程序结构)
    - [声明](#声明)
    - [类型](#类型)
    - [表达式](#表达式)
    - [语句](#语句)
  - [1.2 抽象语法树 (AST)](#1.2-抽象语法树-ast)
  - [1.3 具体语法到抽象语法的映射](#1.3-具体语法到抽象语法的映射)
- [第二部分: 操作语义](#第二部分-操作语义)
  - [2.1 小步操作语义 (Small-Step)](#2.1-小步操作语义-small-step)
    - [配置与转换](#配置与转换)
    - [表达式求值规则](#表达式求值规则)
    - [语句执行规则](#语句执行规则)
  - [2.2 大步操作语义 (Big-Step)](#2.2-大步操作语义-big-step)
  - [2.3 两种语义的等价性](#2.3-两种语义的等价性)
- [第三部分: 指称语义](#第三部分-指称语义)
  - [3.1 语义域](#3.1-语义域)
  - [3.2 表达式指称语义](#3.2-表达式指称语义)
  - [3.3 语句指称语义](#3.3-语句指称语义)
  - [3.4 函数指称语义](#3.4-函数指称语义)
- [第四部分: 控制流形式化](#第四部分-控制流形式化)
  - [4.1 控制流图 (CFG)](#4.1-控制流图-cfg)
  - [4.2 支配树 (Dominator Tree)](#4.2-支配树-dominator-tree)
  - [4.3 数据流分析](#4.3-数据流分析)
    - [活跃变量分析](#活跃变量分析)
    - [可达定义分析](#可达定义分析)
- [第五部分: Go特定语义](#第五部分-go特定语义)
  - [5.1 Goroutine创建语义](#5.1-goroutine创建语义)
  - [5.2 Channel操作语义](#5.2-channel操作语义)
  - [5.3 Defer语句语义](#5.3-defer语句语义)
  - [5.4 Panic/Recover语义](#5.4-panicrecover语义)
- [🎯 总结](#总结)
  - [核心贡献](#核心贡献)
  - [理论意义](#理论意义)
  - [实践价值](#实践价值)
