...
<!-- TOC START -->
- [物联网/智慧物联架构（Golang国际主流实践）](#物联网智慧物联架构golang国际主流实践)
  - [1. 目录](#1-目录)
  - [2. 物联网/智慧物联架构概述](#2-物联网智慧物联架构概述)
  ...
  - [7. 形式化建模与证明](#7-形式化建模与证明)
    - [7.1 设备-数据-规则建模](#71-设备-数据-规则建模)
      - [7.1.1 性质1：智能感知性](#711-性质1智能感知性)
      - [7.1.2 性质2：安全可信性](#712-性质2安全可信性)
    - [7.2 符号说明](#72-符号说明)
  - [8. 参考与外部链接](#8-参考与外部链接)
<!-- TOC END -->
