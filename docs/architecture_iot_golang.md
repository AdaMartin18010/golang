# 1 1 1 1 1 1 1 物联网/智慧物联架构（Golang国际主流实践）

<!-- TOC START -->
- [1 1 1 1 1 1 1 物联网/智慧物联架构（Golang国际主流实践）](#1-1-1-1-1-1-1-物联网智慧物联架构（golang国际主流实践）)
  - [1.1 目录](#目录)
  - [1.2 1. 物联网/智慧物联架构概述](#1-物联网智慧物联架构概述)
    - [1.2.1 国际标准定义](#国际标准定义)
  ...
  - [1.7 6. 形式化建模与证明](#6-形式化建模与证明)
    - [1.7.1 设备-数据-规则建模](#设备-数据-规则建模)
      - [1.7.1.1 性质1：智能感知性](#性质1：智能感知性)
      - [1.7.1.2 性质2：安全可信性](#性质2：安全可信性)
    - [1.7.2 符号说明](#符号说明)
